...
| ------------------------------------------------------- | ------------------ | --------------------------- |
| [plaintext_plugin.rgr](../plaintext_plugin.rgr)   | ranger-file        | File output                 |
| [reveal_plugin.rgr](../reveal_plugin.rgr)         | ranger-reveal      | Presentation slides         |
| [commonmark_plugin.rgr](../commonmark_plugin.rgr) | ranger-markdown    | Markdown generation         |
| [markdown_plugin.rgr](../markdown_plugin.rgr)     | -                  | Slide-focused markdown      |
| [maven_plugin.rgr](../maven_plugin.rgr)           | ranger-maven       | Maven pom.xml               |
| [makefile_plugin.rgr](../makefile_plugin.rgr)     | ranger-makefile    | C++ Makefile                |
| [ui_plugin.rgr](../ui_plugin.rgr)                 | ranger-material-ui | Material UI HTML            |
| [ui_plugin2.rgr](../ui_plugin2.rgr)               | -                  | UI variant                  |
| [plugin_apps.rgr](../plugin_apps.rgr)             | -                  | App-level processing        |
| [simplePlugin.rgr](../simplePlugin.rgr)           | -                  | CSS/HTML/GraphQL generation |
| [test_plugin.rgr](../test_plugin.rgr)             | -                  | Test/example plugin         |
