...
class RangerAppClassDesc  extends RangerAppParamDesc {
  ...
  findMethod (f_name) {
    ...
    for ( let i = 0; i < vNames.length; i++) {
      var name_1 = vNames[i];
      if ( name_1 == f_name ) {
        const list = (this.method_variants[name_1]);
        res = list.variants[0];
        return res;
      }
    };
...
TFactory.lambdaSignature = function(node) {
  ...
  s = ((s + " (") + (operatorsOf.map_2(argNode.children, ((item, index) => { 
...
class CodeNode  {
  ...
  isPrimitive () {
    return TTypes.isPrimitive(this.value_type);
  };
  isPrimitiveType () {
  ...
  inferDefExpressionTypeFromValue (node) {
    ...
    console.log(" > Infer value type " + nodeValue.value_type);
    console.log(" > Infer eval_tyåe type " + nodeValue.eval_type);
    if ( typeof(cn.expression_value) !== "undefined" ) {
      console.log("^ but has expression value");
      cn.value_type = 17;
      cn.parsed_type = 17;
      cn.has_vref_annotation = true;
      console.log("==> expression : " + cn.expression_value.getCode());
    }
...
class RangerAppWriterContext  {
  ...
  getAllOperators () {
    const root = this.getRoot();
    let res = [];
    operatorsOf_3.forEach_4(root.op_list, ((item, index) => { 
  ...
  initOpList () {
    ...
    if ( typeof(root.operators) !== "undefined" ) {
      ...
      if ( (foo.length) > 0 ) {
        operatorsOf_3.forEach_5(op.opHash, ((item, index) => { 
          const op_name = index;
  ...
  pushCode (source_code, wr) {
    ...
    if ( typeof(parser_1.rootNode) != "undefined" ) {
      ...
      console.log("--> did push new source code");
    }
  };
  ...
  writeContextVars (wr) {
    operatorsOf_3.forEach_6(this.localVariables, ((item, index) => { 
  ...
  createStaticMethod (withName, currC, nameNode, argsNode, fnBody, parser) {
    const s = withName;
  ...
  canUseTypeInference (nameNode) {
    ...
    if ( b_allow_ti ) {
      ...
      if ( nameNode.eval_type_name.length ) {
  ...
  createTraitInstanceClass (traitName, instanceName, initParams, flowParser) {
    let res;
    const ctx = this.fork();
    const wr = new CodeWriter();
    ...
    while (this.i < this.__len) {
      ...
      if ( this.i < this.__len ) {
        ...
        if ( (false == disable_ops_set) && (c == (58)) ) {
          ...
          while ((this.i < this.__len) && operatorsOfchar_7.isc95notc95limiter_8(c)) {
            this.i = 1 + this.i;
            c = s.charCodeAt(this.i );
            if ( c == (64) ) {
              had_type_ann = true;
...
class RangerServiceBuilder  {
  ...
  CreateServices (parser, ctx, orig_wr) {
    if ( ctx.hasCompilerFlag("client") || ctx.hasCompilerSetting("client") ) {
      ...
      operatorsOf_3.forEach_9(root.appServices, ((item, index) => { 
...
class RangerFlowParser  {
  ...
  WalkNode (node, ctx, wr) {
    ...
    if ( (node.children.length) > 0 ) {
      ...
      if ( (skip_if.indexOf(fc_1.vref)) >= 0 ) {
        return true;
      }
      let b_found = true;
      switch (fc_1.vref ) { 
    ...
    if ( (node.children.length) > 0 ) {
      ...
      if ( fc_2.expression && ((node.children.length) == 2) ) {
        const sec = node.getSecond();
        if ( (sec.vref.length) && ((sec.vref[0]) == ".") ) {
          this.WalkNode(fc_2, ctx, wr);
          if ( (fc_2.eval_type_name.length) && ctx.isDefinedClass(fc_2.eval_type_name) ) {
            const parts = (sec.vref.substring(1, (sec.vref.length) )).split(".");
            let method_name = parts[0];
            let classDesc = ctx.findClass(fc_2.eval_type_name);
            /** unused:  const objExpr = fc_2.copy()   **/ 
            let calledItem = CodeNode.fromList([CodeNode.vref1("property"), fc_2.copy(), CodeNode.vref1(method_name)]);
      ...
      if ( fc_2.expression && ((node.children.length) == 3) ) {
        const sec_1 = node.getSecond();
        const third = node.getThird();
        if ( (sec_1.vref.length) && ((sec_1.vref[0]) == ".") ) {
          this.WalkNode(fc_2, ctx, wr);
          const parts_1 = (sec_1.vref.substring(1, (sec_1.vref.length) )).split(".");
          const method_name_1 = parts_1[((parts_1.length) - 1)];
          let classDesc_1 = ctx.findClass(fc_2.eval_type_name);
          /** unused:  const objExpr_1 = fc_2.copy()   **/ 
          let calledItem_1 = fc_2.copy();
  ...
  CollectMethods (node, ctx, wr) {
    ...
    operatorsOf_3.forEach_10(this.extendedClasses, ((item, index) => { 
  ...
  CreateFunctionObject (orig_node, ctx, wr) {
    ...
    const m = operatorsOfCodeNode_11.rc46funcdesc_12(node, ctx);
    subCtx.is_function = true;
    subCtx.currentMethod = m;
    m.fnCtx = subCtx;
    if ( cn.hasFlag("weak") ) {
  ...
  WalkCollectMethods (node, ctx, wr) {
    ...
    if ( node.isFirstVref("PublicMethod") || node.isFirstVref("fn") ) {
      ...
      const fnObj = operatorsOf_11.rc46func_12(node, (currC_8.ctx));
  ...
  transformMethodToLambda (node, vFnDef, ctx, wr) {
    if ( vFnDef.isFunction() ) {
      const args = operatorsOf.map_13(vFnDef.params, ((item, index) => { 
      ...
      const staticLambda = CodeNode.fromList([fnArg, CodeNode.fromList(args), CodeNode.blockFromList([CodeNode.fromList([CodeNode.vref1("return"), CodeNode.fromList([subNode, CodeNode.fromList((args.map(((item, index) => { 
        return item.copy();
      }))))])])])]);
      ...
      if ( (callerArgCnt == fnArgCnt) || expanding_node ) {
        ...
        if ( codeDef.is_block_node && all_matched ) {
          ...
          if ( false == new_cl.hasStaticMethod(argsSig) ) {
            const sMethod = ctx.createStaticMethod(argsSig, new_cl, nameCopy, argsCopy, bodyCopy_1, this);
...
class RangerJava7ClassWriter  extends RangerGenericClassWriter {
  ...
  CreatePages (parser, ctx, orig_wr) {
    operatorsOf_3.forEach_9(ctx.appPages, ((item, index) => { 
...
class RangerCppClassWriter  extends RangerGenericClassWriter {
  ...
  CreateUnions (parser, ctx, wr) {
    const root = ctx.getRoot();
    operatorsOf_3.forEach_14(root.definedClasses, ((item, index) => { 
      if ( item.is_union ) {
...
class RangerGolangClassWriter  extends RangerGenericClassWriter {
  ...
  CustomOperator (node, ctx, wr) {
    ...
    if ( cmd == "try" ) {
      ...
      const ex2 = operatorsOfRangerAppWriterContext_15.createc95var_16(ctx, "did_return", "boolean");
      const ex3 = operatorsOf_15.createc95var_17(ctx, "ex_result", (currFn.nameNode));
  ...
  writeClass (node, ctx, orig_wr) {
    ...
    for ( let i_3 = 0; i_3 < cl.defined_variants.length; i_3++) {
      ...
      for ( let i_4 = 0; i_4 < mVs.variants.length; i_4++) {
        ...
        const subCtx_1 = variant.fnCtx;
        subCtx_1.is_function = true;
        operatorsOf_3.forEach_6(subCtx_1.localVariables, ((item, index) => { 
          if ( item.is_register ) {
...
class RangerActiveOperators  {
  ...
  initializeOpCache () {
    operatorsOf_3.forEach_5(this.opHash, ((item, index) => { 
      item.list.length = 0;
    }));
...
class RangerDocGenerator  {
  ...
  createClassDoc (node, ctx, orig_wr) {
    if ( ctx.hasCompilerSetting("classdoc") ) {
      ...
      operatorsOf_3.forEach_14(root.definedClasses, ((item, index) => { 
        ...
        const theClass = item;
        operatorsOf_3.forEach_18(item.method_variants, ((item, index) => { 
  ...
  createOperatorDoc (node, ctx, orig_wr) {
    if ( ctx.hasCompilerSetting("operatordoc") ) {
      ...
      statements = operatorsOf.groupBy_19(statements, ((item) => { 
        return item.name;
      }));
      ...
      const nList = operatorsOf.groupBy_19(operator_list, ((item) => { 
        let key = item.name;
...
class viewbuilder_Web  {
  ...
  CreateViews (ctx, wr) {
    ...
    wr.out("</head>", true);
    wr.out("<body>", true);
    operatorsOf_3.forEach_9(ctx.viewClassBody, ((item, index) => { 
  ...
  run (params) {
    ...
    if ( ( typeof(params.flags["compiler"] ) != "undefined" && params.flags.hasOwnProperty("compiler") ) ) {
      ...
      if ( (params.values.length) < 1 ) {
        console.log("Ranger compiler, version " + "2.1.33");
    ...
    operatorsOf_3.forEach_20(params.flags, ((item, index) => { 
      const n = index;
      appCtx.compilerFlags[n] = true;
    }));
    operatorsOf_3.forEach_10(params.params, ((item, index) => { 
      const v = item;
      comp_attrs[index] = v;
    }));
    operatorsOf_3.forEach_10(comp_attrs, ((item, index) => { 
      const n_1 = item;
    ...
    if ( appCtx.hasCompilerSetting("plugins") ) {
      ...
      const list = val.split(plugin_separator);
      list.forEach(((item, index) => { 
        try {
          const plugin = require( item );
    ...
    try {
      ...
      if ( appCtx.hasCompilerFlag("showtypes") ) {
        ...
        operatorsOf_3.forEach_21(appCtx.typeClasses, ((item, index) => { 
      ...
      if ( plugins_only ) {
        ...
        switch (appCtx.targetLangName ) { 
          case "java7" : 
            if ( ( typeof(comp_attrs["android_res_dir"] ) != "undefined" && comp_attrs.hasOwnProperty("android_res_dir") ) ) {
              ...
              operatorsOf_3.forEach_9(appCtx.viewClassBody, ((item, index) => { 
        ...
        const fileSystem2 = new CodeFileSystem();
        const file2 = fileSystem2.getFile(".", the_target);
        const write1 = file2.getWriter();
        for ( let i_8 = 0; i_8 < appCtx.definedClassList.length; i_8++) {
          ...
          if ( cl_2.is_operator_class ) {
            lcc.WalkNode(cl_2.classNode, appCtx, write1);
          }
        };
        for ( let i_9 = 0; i_9 < appCtx.definedClassList.length; i_9++) {
          var cName_3 = appCtx.definedClassList[i_9];
          const cl_3 = appCtx.definedClasses[cName_3];
          if ( cl_3.is_operator_class ) {
            lcc.WalkNode(cl_3.classNode, appCtx, wr);
          }
        };
        const import_list = wr.getImports();
        ...
        for ( let i_10 = 0; i_10 < import_list.length; i_10++) {
          var codeStr = import_list[i_10];
...
operatorsOf.map_13 = function(__self, cb) {
...
operatorsOf.groupBy_19 = function(__self, cb) {
  let res_2 = [];
  let mapper = {};
...
operatorsOf_3.forEach_4 = function(__self, cb) {
  const list = Object.keys(__self);
  for ( let i_1 = 0; i_1 < list.length; i_1++) {
    var kk = list[i_1];
    const value = (__self[kk]);
    cb(value, kk);
  };
};
operatorsOf_3.forEach_5 = function(__self, cb) {
  const list_1 = Object.keys(__self);
  for ( let i_2 = 0; i_2 < list_1.length; i_2++) {
    var kk_1 = list_1[i_2];
    const value_1 = (__self[kk_1]);
    cb(value_1, kk_1);
  };
};
operatorsOf_3.forEach_6 = function(__self, cb) {
  const list_2 = Object.keys(__self);
  for ( let i_3 = 0; i_3 < list_2.length; i_3++) {
    var kk_2 = list_2[i_3];
    const value_2 = (__self[kk_2]);
    cb(value_2, kk_2);
  };
};
operatorsOf_3.forEach_9 = function(__self, cb) {
  const list_3 = Object.keys(__self);
  for ( let i_4 = 0; i_4 < list_3.length; i_4++) {
    var kk_3 = list_3[i_4];
    const value_3 = (__self[kk_3]);
    cb(value_3, kk_3);
  };
};
operatorsOf_3.forEach_10 = function(__self, cb) {
  const list_4 = Object.keys(__self);
  for ( let i_5 = 0; i_5 < list_4.length; i_5++) {
    var kk_4 = list_4[i_5];
...
operatorsOf_3.forEach_18 = function(__self, cb) {
...
operatorsOf_3.forEach_20 = function(__self, cb) {
...
operatorsOf_3.forEach_21 = function(__self, cb) {
...
class operatorsOfchar_7  {
  constructor() {
  }
}
operatorsOfchar_7.isc95notc95limiter_8 = function(c) {
  return (((((c > 32) && (c != (59))) && (c != (41))) && (c != (40))) && (c != (125))) && (c != (44));
};
class operatorsOfCodeNode_11  {
  constructor() {
  }
}
operatorsOfCodeNode_11.rc46funcdesc_12 = function(node, ctx) {
  const m = new RangerAppFunctionDesc();
  const cn = node.getSecond();
  m.name = cn.vref;
...
class operatorsOf_11  {
  constructor() {
  }
}
operatorsOf_11.rc46func_12 = function(node, ctx) {
...
operatorsOfRangerAppWriterContext_15.createc95var_16 = function(__self, name, type_name) {
...
operatorsOf_15.createc95var_17 = function(__self, name, usingNode) {
