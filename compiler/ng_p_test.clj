(
    ...
    ( CreateClass RangerLispParser:void {
            ...
            sfn theMain@(main):void () {
                ...
                def read_code:string (readfile "." "testCode.clj")

                def the_code:SourceCode (new SourceCode( (unwrap read_code)))
                
                def p:RangerLispParser (new RangerLispParser(the_code))
                timer "Time for parsing the code:" {
                    p.parse()
                }
                def rn:CodeNode (unwrap p.rootNode)
                rn.walk()
                print("--- done --- ")
                    ...
                    (
                        ...
                        (if (< i len)
                            (
                                ...
                                (def op_c:int 0)
                                (if (  ( c >= 33 || c <= 62 || c == 124 ) && (>= (array_length curr_node.children) 0) ) 
                                    (
                                    ...
                                    (
                                        ...
                                        (if ( && (< i len) (> ep sp) )
                                            (
                                                ...
                                                (if curr_node.infix_operator {
                                                    pTarget = curr_node.infix_node
                                                    if( op_pred == 0 && pTarget.to_the_right) {
                                                        def rn@(lives):CodeNode pTarget.right_node
                                                            ...
                                                            (
                                                                ...
                                                                (if (== false curr_node.infix_operator)
                                                                    (
                                                                        ...
                                                                        (def if_node:CodeNode (new CodeNode((unwrap code) sp ep)))
                                                                ...
                                                                (push opTarget.children new_op_node)
