...
Mermaid answers to thirty-eight header keywords and this reads thirty-six of
...
charts — has a reader of its own further down this page. **Thirty-six of
Mermaid's thirty-eight header keywords are drawn**, and the other two —
`treeView-beta` and `eventmodeling` — are recognised and refused rather than
guessed at. The table is in
...
made of the same text. Currently **230/230 checks over 50 examples**, including
