...
Mermaid answers to thirty-eight header keywords and this reads thirty-seven of
...
charts — has a reader of its own further down this page. **Thirty-seven of
Mermaid's thirty-eight header keywords are drawn**, and the last one —
`eventmodeling` — is recognised and refused rather than guessed at. The table is in
...
made of the same text. Currently **232/232 checks over 51 examples**, including
