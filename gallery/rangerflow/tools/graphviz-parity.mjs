...
say("| `record` and HTML labels | Read as their text, not as the nested box language they are. `PLAN_GRAPHVIZ.md` phase 5. |");
say("| ports and compass points | Parsed into the model and dumped, but nothing aims an edge at them yet. |");
say();
say("## The corpus");
say();
