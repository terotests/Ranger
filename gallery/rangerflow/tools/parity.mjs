...
const CAPABILITIES = [
  ...
  ["Connecting", [
    ...
    ["Connect on click", "connectOnClick", "connectOnClick"],
  ]],
  ["Nodes and edges", [
    ["Custom node types", "nodeTypes", "edgeTypes"],
    ["Node resizing", "<NodeResizer />", "resizeNode"],
    ["Add a node from a palette", "(example: add node on edge drop)", "addNode"],
    ...
    ["Sub-flows / parenting", "node.parentId", "subFlowDrag"],
  ]],
