...
rm -f "$OUT/docx_web.js"
log=$(node dist/rgrc.js -es6 gallery/docx_viewer/web/docx_web.rgr -d="$OUT" -o=docx_web.js 2>&1)
...
node lib/evg/web/tools/minify.mjs --file "$OUT/docx_web.js" --keep DocxWeb || exit 1
