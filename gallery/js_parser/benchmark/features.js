...
const features = [
  // === ES6 Basics ===
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "ArrowFunctionExpression"),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "ArrowFunctionExpression"),
    },
  },
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "ClassDeclaration" && n.superClass),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "ClassDeclaration" && n.superClass),
    },
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "MethodDefinition" && n.static),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "MethodDefinition" && n.static),
    },
  },
    ...
    validate: {
      ...
      ranger: (ast) =>
        findNode(
          ast,
          (n) =>
            n.type === "PrivateIdentifier" || n.type === "PropertyDefinition"
        ),
    },
  },
  {
  ...
  // === Async/Generators ===
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "FunctionDeclaration" && n.async),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "FunctionDeclaration" && n.async),
    },
  },
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "FunctionDeclaration" && n.generator),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "FunctionDeclaration" && n.generator),
    },
  },
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "ForOfStatement" && n.await),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "ForOfStatement" && n.await),
    },
  },
  ...
  // === Modern Operators ===
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "ChainExpression" || n.optional === true
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "LogicalExpression" && n.operator === "??"
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "Literal" && n.raw && n.raw.includes("_")
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "Literal" && typeof n.bigint === "string"
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "ExportNamedDeclaration"),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "ExportNamedDeclaration"),
    },
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "ExportDefaultDeclaration"),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "ExportDefaultDeclaration"),
    },
  },
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "MetaProperty" && n.meta?.name === "import"
        ),
      ranger: (ast) =>
        findNode(
          ast,
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) =>
            n.type === "Decorator" || (n.decorators && n.decorators.length > 0)
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "TSTypeAnnotation" || n.typeAnnotation),
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "Literal" && n.regex && n.regex.flags.includes("u")
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "Literal" && n.regex && n.regex.flags.includes("d")
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  // === Other Features ===
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "Property" && n.shorthand),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "Property" && n.shorthand),
    },
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(ast, (n) => n.type === "Property" && n.computed),
      ranger: (ast) =>
        findNode(ast, (n) => n.type === "Property" && n.computed),
    },
  },
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "CallExpression" && n.callee?.name === "Symbol"
        ),
      ranger: (ast) =>
        findNode(
          ast,
  ...
  },
  {
    ...
    validate: {
      estree: (ast) =>
        findNode(
          ast,
          (n) => n.type === "MetaProperty" && n.meta?.name === "new"
        ),
      ranger: (ast) =>
        findNode(
          ast,
...
function runTests() {
  ...
  console.log(
    "║           JavaScript Parser Feature Comparison (Validated)             ║"
  );
  console.log(
    "╚════════════════════════════════════════════════════════════════════════╝\n"
  );
  ...
  const header = ["Parser", "Passed", "No AST Node", "Parse Error", "Score"]
    .map((s) => s.padEnd(13))
    .join("│");
  console.log(`║ ${header} ║`);
  console.log("╠" + "═".repeat(74) + "╣");
  ...
  const sortedParsers = parserKeys.sort(
    (a, b) => results[b].passed - results[a].passed
  );
  ...
  console.log(
    "  ○ = Parsed but did NOT produce expected AST node (false positive prevention)"
  );
