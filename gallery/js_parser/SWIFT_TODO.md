...
```bash
RANGER_LIB="./compiler/Lang.rgr" node dist/rgrc.js -l=swift6 ./gallery/js_parser/js_parser_main.rgr -d=./gallery/js_parser -o=js_parser.swift -nodecli
```
...
```bash
RANGER_LIB="./compiler/Lang.rgr" node dist/rgrc.js -l=swift3 ./gallery/js_parser/js_parser_main.rgr -d=./gallery/js_parser -o=js_parser.swift -nodecli
```
