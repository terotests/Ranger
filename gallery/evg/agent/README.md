...
```
$ npm run agent -- outline gallery/evg/agent/fixtures/card.evg.json --depth=1
...
```
$ npm run agent -- query gallery/evg/agent/fixtures/card.evg.json .card
{"matches":[
...
```
$ npm run agent -- measure gallery/evg/agent/fixtures/broken.evg.json --width=600 --height=300
