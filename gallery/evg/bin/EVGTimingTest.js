...
class TimingCheck  {
  ...
  eqStr (name, got, want) {
    const good = ((got.toString())) == want;
    this.ok(name, good);
  };
  near (name, got, want) {
    const good = (Math.abs((got - want))) < 0.0001;
    if ( good == false ) {
...
EVGTimingTest.check_linear = function(c) {
  const e = EVGEasing.parse("linear");
  c.ok("linear parses", e.ok);
  c.near("linear at 0", e.ease(0.0), 0.0);
  c.near("linear at 0.05", e.ease(0.05), 0.05);
  c.near("linear at 0.1", e.ease(0.1), 0.1);
  c.near("linear at 0.2", e.ease(0.2), 0.2);
  c.near("linear at 0.25", e.ease(0.25), 0.25);
  c.near("linear at 0.3", e.ease(0.3), 0.3);
  c.near("linear at 0.4", e.ease(0.4), 0.4);
  c.near("linear at 0.499", e.ease(0.499), 0.499);
  c.near("linear at 0.5", e.ease(0.5), 0.5);
  c.near("linear at 0.501", e.ease(0.501), 0.501);
  c.near("linear at 0.6", e.ease(0.6), 0.6);
  c.near("linear at 0.7", e.ease(0.7), 0.7);
  c.near("linear at 0.75", e.ease(0.75), 0.75);
  c.near("linear at 0.8", e.ease(0.8), 0.8);
  c.near("linear at 0.9", e.ease(0.9), 0.9);
  c.near("linear at 0.95", e.ease(0.95), 0.95);
  c.near("linear at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_ease = function(c) {
  const e = EVGEasing.parse("ease");
  c.ok("ease parses", e.ok);
  c.near("ease at 0", e.ease(0.0), 0.0);
  c.near("ease at 0.05", e.ease(0.05), 0.03295);
  c.near("ease at 0.1", e.ease(0.1), 0.0948);
  c.near("ease at 0.2", e.ease(0.2), 0.29524);
  c.near("ease at 0.25", e.ease(0.25), 0.40851);
  c.near("ease at 0.3", e.ease(0.3), 0.51332);
  c.near("ease at 0.4", e.ease(0.4), 0.68254);
  c.near("ease at 0.499", e.ease(0.499), 0.80141);
  c.near("ease at 0.5", e.ease(0.5), 0.8024);
  c.near("ease at 0.501", e.ease(0.501), 0.8034);
  c.near("ease at 0.6", e.ease(0.6), 0.88523);
  c.near("ease at 0.7", e.ease(0.7), 0.94076);
  c.near("ease at 0.75", e.ease(0.75), 0.96046);
  c.near("ease at 0.8", e.ease(0.8), 0.97562);
  c.near("ease at 0.9", e.ease(0.9), 0.99432);
  c.near("ease at 0.95", e.ease(0.95), 0.99862);
  c.near("ease at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_ease_in = function(c) {
  const e = EVGEasing.parse("ease-in");
  c.ok("ease-in parses", e.ok);
  c.near("ease-in at 0", e.ease(0.0), 0.0);
  c.near("ease-in at 0.05", e.ease(0.05), 0.00447);
  c.near("ease-in at 0.1", e.ease(0.1), 0.01703);
  c.near("ease-in at 0.2", e.ease(0.2), 0.06228);
  c.near("ease-in at 0.25", e.ease(0.25), 0.09346);
  c.near("ease-in at 0.3", e.ease(0.3), 0.12958);
  c.near("ease-in at 0.4", e.ease(0.4), 0.21486);
  c.near("ease-in at 0.499", e.ease(0.499), 0.31428);
  c.near("ease-in at 0.5", e.ease(0.5), 0.31536);
  c.near("ease-in at 0.501", e.ease(0.501), 0.31643);
  c.near("ease-in at 0.6", e.ease(0.6), 0.42912);
  c.near("ease-in at 0.7", e.ease(0.7), 0.55481);
  c.near("ease-in at 0.75", e.ease(0.75), 0.62186);
  c.near("ease-in at 0.8", e.ease(0.8), 0.69163);
  c.near("ease-in at 0.9", e.ease(0.9), 0.83943);
  c.near("ease-in at 0.95", e.ease(0.95), 0.91776);
  c.near("ease-in at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_ease_out = function(c) {
  const e = EVGEasing.parse("ease-out");
  c.ok("ease-out parses", e.ok);
  c.near("ease-out at 0", e.ease(0.0), 0.0);
  c.near("ease-out at 0.05", e.ease(0.05), 0.08224);
  c.near("ease-out at 0.1", e.ease(0.1), 0.16057);
  c.near("ease-out at 0.2", e.ease(0.2), 0.30837);
  c.near("ease-out at 0.25", e.ease(0.25), 0.37814);
  c.near("ease-out at 0.3", e.ease(0.3), 0.44519);
  c.near("ease-out at 0.4", e.ease(0.4), 0.57088);
  c.near("ease-out at 0.499", e.ease(0.499), 0.68357);
  c.near("ease-out at 0.5", e.ease(0.5), 0.68464);
  c.near("ease-out at 0.501", e.ease(0.501), 0.68572);
  c.near("ease-out at 0.6", e.ease(0.6), 0.78514);
  c.near("ease-out at 0.7", e.ease(0.7), 0.87042);
  c.near("ease-out at 0.75", e.ease(0.75), 0.90653);
  c.near("ease-out at 0.8", e.ease(0.8), 0.93772);
  c.near("ease-out at 0.9", e.ease(0.9), 0.98297);
  c.near("ease-out at 0.95", e.ease(0.95), 0.99552);
  c.near("ease-out at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_ease_in_out = function(c) {
  const e = EVGEasing.parse("ease-in-out");
  c.ok("ease-in-out parses", e.ok);
  c.near("ease-in-out at 0", e.ease(0.0), 0.0);
  c.near("ease-in-out at 0.05", e.ease(0.05), 0.00483);
  c.near("ease-in-out at 0.1", e.ease(0.1), 0.01972);
  c.near("ease-in-out at 0.2", e.ease(0.2), 0.08166);
  c.near("ease-in-out at 0.25", e.ease(0.25), 0.12916);
  c.near("ease-in-out at 0.3", e.ease(0.3), 0.1874);
  c.near("ease-in-out at 0.4", e.ease(0.4), 0.33188);
  c.near("ease-in-out at 0.499", e.ease(0.499), 0.49828);
  c.near("ease-in-out at 0.5", e.ease(0.5), 0.5);
  c.near("ease-in-out at 0.501", e.ease(0.501), 0.50172);
  c.near("ease-in-out at 0.6", e.ease(0.6), 0.66812);
  c.near("ease-in-out at 0.7", e.ease(0.7), 0.8126);
  c.near("ease-in-out at 0.75", e.ease(0.75), 0.87084);
  c.near("ease-in-out at 0.8", e.ease(0.8), 0.91834);
  c.near("ease-in-out at 0.9", e.ease(0.9), 0.98028);
  c.near("ease-in-out at 0.95", e.ease(0.95), 0.99517);
  c.near("ease-in-out at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_cubic_bezier_0_68___0_55__0_27__1_55_ = function(c) {
  const e = EVGEasing.parse("cubic-bezier(0.68, -0.55, 0.27, 1.55)");
  c.ok("cubic-bezier(0.68, -0.55, 0.27, 1.55) parses", e.ok);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0", e.ease(0.0), 0.0);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.05", e.ease(0.05), -0.03704);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.1", e.ease(0.1), -0.06627);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.2", e.ease(0.2), -0.0927);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.25", e.ease(0.25), -0.08294);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.3", e.ease(0.3), -0.0498);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.4", e.ease(0.4), 0.13936);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.499", e.ease(0.499), 0.59159);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.5", e.ease(0.5), 0.5966);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.501", e.ease(0.501), 0.60158);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.6", e.ease(0.6), 0.94307);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.7", e.ease(0.7), 1.06813);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.75", e.ease(0.75), 1.08882);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.8", e.ease(0.8), 1.09219);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.9", e.ease(0.9), 1.0627);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 0.95", e.ease(0.95), 1.0347);
  c.near("cubic-bezier(0.68, -0.55, 0.27, 1.55) at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_steps_4__end_ = function(c) {
  const e = EVGEasing.parse("steps(4, end)");
  c.ok("steps(4, end) parses", e.ok);
  c.near("steps(4, end) at 0", e.ease(0.0), 0.0);
  c.near("steps(4, end) at 0.05", e.ease(0.05), 0.0);
  c.near("steps(4, end) at 0.1", e.ease(0.1), 0.0);
  c.near("steps(4, end) at 0.2", e.ease(0.2), 0.0);
  c.near("steps(4, end) at 0.25", e.ease(0.25), 0.25);
  c.near("steps(4, end) at 0.3", e.ease(0.3), 0.25);
  c.near("steps(4, end) at 0.4", e.ease(0.4), 0.25);
  c.near("steps(4, end) at 0.499", e.ease(0.499), 0.25);
  c.near("steps(4, end) at 0.5", e.ease(0.5), 0.5);
  c.near("steps(4, end) at 0.501", e.ease(0.501), 0.5);
  c.near("steps(4, end) at 0.6", e.ease(0.6), 0.5);
  c.near("steps(4, end) at 0.7", e.ease(0.7), 0.5);
  c.near("steps(4, end) at 0.75", e.ease(0.75), 0.75);
  c.near("steps(4, end) at 0.8", e.ease(0.8), 0.75);
  c.near("steps(4, end) at 0.9", e.ease(0.9), 0.75);
  c.near("steps(4, end) at 0.95", e.ease(0.95), 0.75);
  c.near("steps(4, end) at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_steps_4__start_ = function(c) {
  const e = EVGEasing.parse("steps(4, start)");
  c.ok("steps(4, start) parses", e.ok);
  c.near("steps(4, start) at 0", e.ease(0.0), 0.25);
  c.near("steps(4, start) at 0.05", e.ease(0.05), 0.25);
  c.near("steps(4, start) at 0.1", e.ease(0.1), 0.25);
  c.near("steps(4, start) at 0.2", e.ease(0.2), 0.25);
  c.near("steps(4, start) at 0.25", e.ease(0.25), 0.5);
  c.near("steps(4, start) at 0.3", e.ease(0.3), 0.5);
  c.near("steps(4, start) at 0.4", e.ease(0.4), 0.5);
  c.near("steps(4, start) at 0.499", e.ease(0.499), 0.5);
  c.near("steps(4, start) at 0.5", e.ease(0.5), 0.75);
  c.near("steps(4, start) at 0.501", e.ease(0.501), 0.75);
  c.near("steps(4, start) at 0.6", e.ease(0.6), 0.75);
  c.near("steps(4, start) at 0.7", e.ease(0.7), 0.75);
  c.near("steps(4, start) at 0.75", e.ease(0.75), 1.0);
  c.near("steps(4, start) at 0.8", e.ease(0.8), 1.0);
  c.near("steps(4, start) at 0.9", e.ease(0.9), 1.0);
  c.near("steps(4, start) at 0.95", e.ease(0.95), 1.0);
  c.near("steps(4, start) at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_cubic_bezier_1__0__0__1_ = function(c) {
  const e = EVGEasing.parse("cubic-bezier(1, 0, 0, 1)");
  c.ok("cubic-bezier(1, 0, 0, 1) parses", e.ok);
  c.near("cubic-bezier(1, 0, 0, 1) at 0", e.ease(0.0), 0.0);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.05", e.ease(0.05), 0.00088);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.1", e.ease(0.1), 0.00376);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.2", e.ease(0.2), 0.01743);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.25", e.ease(0.25), 0.02972);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.3", e.ease(0.3), 0.0474);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.4", e.ease(0.4), 0.1114);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.499", e.ease(0.499), 0.40601);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.5", e.ease(0.5), 0.5);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.501", e.ease(0.501), 0.594);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.6", e.ease(0.6), 0.8886);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.7", e.ease(0.7), 0.95261);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.75", e.ease(0.75), 0.97027);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.8", e.ease(0.8), 0.98258);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.9", e.ease(0.9), 0.99624);
  c.near("cubic-bezier(1, 0, 0, 1) at 0.95", e.ease(0.95), 0.99912);
  c.near("cubic-bezier(1, 0, 0, 1) at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.check_cubic_bezier_0_999__0__0_001__1_ = function(c) {
  const e = EVGEasing.parse("cubic-bezier(0.999, 0, 0.001, 1)");
  c.ok("cubic-bezier(0.999, 0, 0.001, 1) parses", e.ok);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0", e.ease(0.0), 0.0);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.05", e.ease(0.05), 0.00088);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.1", e.ease(0.1), 0.00377);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.2", e.ease(0.2), 0.01746);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.25", e.ease(0.25), 0.02979);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.3", e.ease(0.3), 0.0475);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.4", e.ease(0.4), 0.11167);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.499", e.ease(0.499), 0.40889);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.5", e.ease(0.5), 0.5);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.501", e.ease(0.501), 0.59111);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.6", e.ease(0.6), 0.88833);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.7", e.ease(0.7), 0.9525);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.75", e.ease(0.75), 0.97021);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.8", e.ease(0.8), 0.98254);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.9", e.ease(0.9), 0.99623);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 0.95", e.ease(0.95), 0.99911);
  c.near("cubic-bezier(0.999, 0, 0.001, 1) at 1", e.ease(1.0), 1.0);
};
EVGTimingTest.checkTopLevelSplitting = function(c) {
  const parts = EVGEasing.splitTop("opacity 1s cubic-bezier(0, 0, 1, 1), color 2s", 44);
  c.ok("a comma inside a function does not split the list", (parts.length) == 2);
  const words = EVGEasing.splitWordsTop("opacity 200ms steps(4, end) 50ms");
  c.ok("a space inside a function does not split the words", (words.length) == 4);
  c.ok("and the function is one word", (words[2]) == "steps(4, end)");
...
EVGTimingTest.checkSolverEdges = function(c) {
  ...
  const flat = EVGEasing.parse("cubic-bezier(1, 0, 0, 1)");
...
EVGTimingTest.probe = function(spec, from) {
  const el = new EVGElement();
  el.transitionSpec = spec;
  el.backgroundColor = EVGColor.parse(from);
  return el;
};
EVGTimingTest.red = function(el) {
  if ( typeof(el.backgroundColor) != "undefined" ) {
    const c = el.backgroundColor;
    return Math.floor( (c.r + 0.5));
  }
  return 0 - 1;
};
EVGTimingTest.flightMs = function(tr, el) {
  const f = tr.flightFor(el, "background-color");
...
EVGTimingTest.flightDelay = function(tr, el) {
  const f = tr.flightFor(el, "background-color");
  if ( typeof(f) != "undefined" ) {
    const one = f;
    return one.delayMs;
...
EVGTimingTest.checkShorthand = function(c) {
  const a = EVGTransition.specFor("background-color 200ms linear 100ms", "background-color");
  ...
  const b = EVGTransition.specFor("ease-out 0.2s opacity", "opacity");
  ...
  const cc = EVGTransition.specFor("opacity 1s cubic-bezier(0.42, 0, 1, 1)", "opacity");
  ...
  const all = EVGTransition.specFor("all 200ms, opacity 0s", "color");
  c.near("all covers a property it does not name", all.durationMs, 200.0);
  const none = EVGTransition.specFor("all 200ms, opacity 0s", "opacity");
  c.ok("a later entry overrides an earlier one", none.found);
  c.near("so opacity is opted out", none.durationMs, 0.0);
  const missing = EVGTransition.specFor("color 200ms", "transform");
  ...
  const bad = EVGTransition.specFor("color 200ms spring(1,2)", "color");
  c.ok("an unparsable timing function is reported", bad.ok == false);
};
EVGTimingTest.checkDelay = function(c) {
  const tr = new EVGTransition();
  const el = EVGTimingTest.probe("background-color 200ms linear 100ms", "rgb(0,0,0)");
  tr.reconcile(el);
...
EVGTimingTest.reversedAfter = function(easing, dur, at) {
  const tr = new EVGTransition();
  const spec = (("background-color " + (((Math.floor( dur)).toString()))) + "ms ") + easing;
  const el = EVGTimingTest.probe(spec, "rgb(0,0,0)");
  tr.reconcile(el);
...
EVGTimingTest.checkReversal = function(c) {
  c.near("linear reversed at 100ms of 200ms", EVGTimingTest.reversedAfter("linear", 200.0, 100.0), 100.0);
...
EVGTimingTest.checkDoubleReversal = function(c) {
  const tr50 = new EVGTransition();
  const el50 = EVGTimingTest.probe("background-color 200ms linear", "rgb(0,0,0)");
  tr50.reconcile(el50);
  ...
  tr50.reconcile(el50);
  c.near("leg 2 of the 0.5 case", EVGTimingTest.flightMs(tr50, el50), 100.0);
  tr50.advance(el50, 50.0);
  c.ok("and its colour there is 64", EVGTimingTest.red(el50) == 64);
  el50.backgroundColor = EVGColor.parse("rgb(255,255,255)");
  tr50.reconcile(el50);
  c.near("leg 3 of the 0.5 case is LONGER than leg 2", EVGTimingTest.flightMs(tr50, el50), 150.0);
  const tr25 = new EVGTransition();
  const el25 = EVGTimingTest.probe("background-color 200ms linear", "rgb(0,0,0)");
  tr25.reconcile(el25);
  ...
  tr25.reconcile(el25);
  c.near("leg 2 of the 0.25 case", EVGTimingTest.flightMs(tr25, el25), 100.0);
  tr25.advance(el25, 25.0);
  c.ok("and its colour there is 96", EVGTimingTest.red(el25) == 96);
  el25.backgroundColor = EVGColor.parse("rgb(255,255,255)");
  tr25.reconcile(el25);
  c.near("leg 3 of the 0.25 case is LONGER than leg 2", EVGTimingTest.flightMs(tr25, el25), 125.0);
};
EVGTimingTest.checkDelayedReversal = function(c) {
  const tr = new EVGTransition();
  const el = EVGTimingTest.probe("background-color 200ms linear 100ms", "rgb(0,0,0)");
  tr.reconcile(el);
  el.backgroundColor = EVGColor.parse("rgb(255,255,255)");
  ...
  el.backgroundColor = EVGColor.parse("rgb(0,0,0)");
  tr.reconcile(el);
  c.near("the duration is shortened", EVGTimingTest.flightMs(tr, el), 100.0);
  c.near("the delay is NOT", EVGTimingTest.flightDelay(tr, el), 100.0);
...
EVGTimingTest.checkThirdValue = function(c) {
  const tr = new EVGTransition();
  const el = EVGTimingTest.probe("background-color 200ms linear", "rgb(0,0,0)");
  tr.reconcile(el);
  el.backgroundColor = EVGColor.parse("rgb(255,255,255)");
  tr.reconcile(el);
  tr.advance(el, 100.0);
...
EVGTimingTest.checkTransformParsing = function(c) {
  const el = new EVGElement();
  ...
  c.eqStr("a skew is refused, not approximated", EVGElement.transformProblem("skewX(10deg)") != "", "true");
  c.eqStr("so is a non-uniform scale", EVGElement.transformProblem("scale(2, 1)") != "", "true");
  c.eqStr("a uniform one written twice is fine", EVGElement.transformProblem("scale(2, 2)") == "", "true");
  c.eqStr("and the supported set is accepted", EVGElement.transformProblem("rotate(9deg) scale(1.1) translate(1px, 2px)") == "", "true");
};
EVGTimingTest.checkTransformOrigin = function(c) {
...
EVGTimingTest.checkTransformScale = function(c) {
  const page = new EVGElement();
  page.setAttribute("width", "200");
  page.setAttribute("height", "200");
  const kid = new EVGElement();
...
EVGTimingTest.checkTransformTransition = function(c) {
  const tr = new EVGTransition();
  const el = new EVGElement();
...
EVGTimingTest.checkTransparentFade = function(c) {
  const tr = new EVGTransition();
  const el = new EVGElement();
  el.transitionSpec = "background-color 200ms linear";
  el.backgroundColor = EVGColor.parse("transparent");
  tr.reconcile(el);
  el.backgroundColor = EVGColor.parse("rgb(244,241,254)");
  tr.reconcile(el);
  c.near("at 0ms the red is 0", EVGTimingTest.redOf(el), 0.0);
  c.near("at 0ms the alpha is 0", EVGTimingTest.alphaOf(el), 0.0);
  tr.advance(el, 50.0);
  c.near("at 50ms the red is 244", EVGTimingTest.redOf(el), 244.0);
  c.near("at 50ms the alpha is 0.25", EVGTimingTest.alphaOf(el), 0.25);
  tr.advance(el, 50.0);
  c.near("at 100ms the red is 244", EVGTimingTest.redOf(el), 244.0);
  c.near("at 100ms the alpha is 0.5", EVGTimingTest.alphaOf(el), 0.5);
  tr.advance(el, 50.0);
  c.near("at 150ms the red is 244", EVGTimingTest.redOf(el), 244.0);
  c.near("at 150ms the alpha is 0.75", EVGTimingTest.alphaOf(el), 0.75);
  tr.advance(el, 50.0);
  c.near("at 200ms the red is 244", EVGTimingTest.redOf(el), 244.0);
  c.near("at 200ms the alpha is 1", EVGTimingTest.alphaOf(el), 1.0);
};
EVGTimingTest.redOf = function(el) {
  if ( typeof(el.backgroundColor) != "undefined" ) {
    const col = el.backgroundColor;
    return col.r;
  }
  return 0.0 - 1.0;
};
EVGTimingTest.alphaOf = function(el) {
  if ( typeof(el.backgroundColor) != "undefined" ) {
    const col = el.backgroundColor;
    return col.a;
  }
...
function __js_main() {
  ...
  console.log("=== EVG timing functions vs the captured browser oracle ===");
