...
//
// Ylos 3 — viidakko-platformeri (jaetut tasot loadGame/pushGame-latauksella).
// Ylos 2 stays in games/ylos2/. LPC spritesheets, timantit = supervoima.
//
...
// Regenerate sprites: npm run engine:ylos3:assets
