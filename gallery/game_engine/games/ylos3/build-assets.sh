#!/usr/bin/env bash
# Bake LPC walk strips into games/ylos3/assets/ (committed PNGs for Pi deploy).
#
# From Ranger repo root:
#   bash gallery/game_engine/games/ylos3/build-assets.sh
#   npm run engine:ylos3:assets
