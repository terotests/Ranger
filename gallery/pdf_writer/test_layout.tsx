    ...
    <View width="100%" height="100%" padding="30px">
      ...
      <View marginTop="20px" flexDirection="row" width="100%" backgroundColor="#eeeeee">
        <View width="30%" backgroundColor="#ff6666">
          <Label fontSize="14px" color="#ffffff">Box 1 (30%)</Label>
        </View>
        <View width="30%" backgroundColor="#66ff66">
          <Label fontSize="14px" color="#000000">Box 2 (30%)</Label>
        </View>
        <View width="30%" backgroundColor="#6666ff">
          <Label fontSize="14px" color="#ffffff">Box 3 (30%)</Label>
        </View>
      </View>
      ...
      <View marginTop="10px" flexDirection="row" width="100%" backgroundColor="#cccccc">
        <View width="100px" backgroundColor="#aa66ff">
          <Label fontSize="14px" color="#ffffff">100px</Label>
        </View>
