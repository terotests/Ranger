      ...
      <Section pageWidth="595" pageHeight="842" margin="0">
        ...
        <Page>
          <View width="100%" height="100%" backgroundColor="#2c3e50" justifyContent="center" alignItems="center">
            <Label fontSize="48px" fontFamily="Noto Sans" color="white">Kesämuistot 2024</Label>
            <Label fontSize="24px" fontFamily="Noto Sans" color="white" marginTop="20px">Äidin ja Isän Matkakirja</Label>
          </View>
        </Page>
        ...
        <Page>
          <View width="100%" height="100%" padding="50px" backgroundColor="#f8f9fa">
            ...
            <Label fontSize="16px" color="#34495e" lineHeight="1.6" marginBottom="15px">
            ...
            <Label fontSize="20px" fontWeight="bold" color="#e74c3c" marginTop="30px">
              Erikoismerkit: Ä Ö Å ä ö å
            </Label>
            
            <Label fontSize="14px" color="#7f8c8d" marginTop="20px">
              € £ ¥ © ® ™ • — – « » " " ' '
            </Label>
          </View>
        </Page>

        {/* Sivu 5: Kuva kuvatekstillä */}
        <Page>
          <PhotoCaptionBelow
            src={testPhoto}
