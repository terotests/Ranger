...
class RasterTextTest  {
  ...
  run () {
    console.log("EVG Raster Text Test");
    console.log("====================");
    console.log("");
    console.log("Loading fonts using FontManager...");
    ...
    if ( fontLoaded == false ) {
      console.log("ERROR: Could not load Open Sans font!");
      console.log("Please ensure fonts are available in ./gallery/pdf_writer/assets/fonts/Open_Sans/");
      return;
    }
    ...
    if ( font.unitsPerEm == 0 ) {
      console.log("ERROR: No valid font loaded!");
      return;
    }
    font.printInfo();
    console.log("");
    console.log("Creating render buffer (600x400)...");
    const renderer = new EVGRasterRenderer();
    renderer.init(600, 400);
    (renderer).clear(250, 250, 250, 255);
    ...
    console.log("Rendering smaller text...");
    textRenderer.renderText(renderer.getBuffer(), "The quick brown fox jumps over the lazy dog.", 30.0, 90.0, 16.0, 51, 51, 51, 255);
    console.log("Rendering text with shadow...");
    textRenderer.renderTextWithShadow(renderer.getBuffer(), "Shadow Text", 30.0, 140.0, 48.0, 30, 30, 30, 255, 0, 0, 0, 100, 3.0, 4.0, 5);
    console.log("Rendering colored text...");
    ...
    console.log("Rendering large text with blur...");
    textRenderer.renderTextWithShadow(renderer.getBuffer(), "RASTER", 30.0, 290.0, 72.0, 255, 255, 255, 255, 0, 0, 0, 180, 0.0, 6.0, 8);
    console.log("");
    ...
    console.log("Done!");
    console.log("");
    console.log("Output: ./gallery/pdf_writer/output/raster_text_test.png");
    console.log("Output: ./gallery/pdf_writer/output/raster_text_test.jpg");
  };
}
/* static JavaSript main routine at the end of the JS file */
function __js_main() {
  const test = new RasterTextTest();
  test.run();
}
__js_main();
