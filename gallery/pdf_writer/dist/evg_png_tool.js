...
class RasterText  {
  ...
  renderGlyph (buf, outline, x, y, r, g, b, a) {
    ...
    console.log("    total edges after flatten: " + (((this.currentEdges.length).toString())));
  ...
  scanlineFillAA (buf, edges, r, g, b, a) {
    const numEdges = edges.length;
    if ( numEdges == 0 ) {
      console.log("    scanlineFillAA: no edges, returning early!");
      return;
    }
    let minY = 99999.0;
    let maxY = 0.0 - 99999.0;
    ...
    console.log(((((((((("    scanlineFillAA: " + ((numEdges.toString()))) + " edges, bbox=(") + ((minX.toString()))) + ",") + ((minY.toString()))) + ")-(") + ((maxX.toString()))) + ",") + ((maxY.toString()))) + ")");
    ...
    console.log((((((("    scanlineFillAA: clamped range X=" + ((startX.toString()))) + "-") + ((endX.toString()))) + " Y=") + ((startY.toString()))) + "-") + ((endY.toString())));
    const subStep = 0.25;
  ...
  renderText (buf, text, x, y, fontSize, r, g, b, a) {
    ...
    while (i < __len) {
      ...
      if ( i == 0 ) {
        console.log((((((("  First char: code=" + ((ch.toString()))) + " glyphIdx=") + ((glyphIdx.toString()))) + " numContours=") + (((outline.contours.length).toString()))) + " advanceWidth=") + ((outline.advanceWidth.toString())));
      }
...
class PNGEncoder  {
  ...
  encodeToBuffer (buf) {
    console.log("Encoding PNG to buffer");
