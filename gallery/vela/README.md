...
| | first run | now |
| --- | --- | --- |
| drawn exactly as the reference draws them | 11 | **94** |
| drawn, but not the same picture | 106 | 67 |
| refused, with a reason | 58 | 14 |
| crashed | 0 | 0 |
| skipped (no data, or the reference refused it too) | 13 | 13 |
| **of what it was asked to draw** | 6.3% exact, 66.9% drawn | **53.7% exact, 92.0% drawn** |

Every one of those eighty-three came from the report rather than from a guess,
...
The remaining sixty-seven are a long tail rather than a wall. Most come out within
