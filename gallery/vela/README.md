...
| | first run | now |
| --- | --- | --- |
| drawn exactly as the reference draws them | 11 | **125** |
| drawn, but not the same picture | 106 | 39 |
| refused, with a reason | 58 | 11 |
| crashed | 0 | 0 |
| skipped (no data, or the reference refused it too) | 13 | 13 |
| **of what it was asked to draw** | 6.3% exact, 66.9% drawn | **71.4% exact, 93.7% drawn** |
