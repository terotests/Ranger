...
| | first run | now |
| --- | --- | --- |
| drawn exactly as the reference draws them | 11 | **164** |
| drawn, but not the same picture | 106 | 6 |
| refused, with a reason | 58 | 5 |
| crashed | 0 | 0 |
| skipped (no data, or the reference refused it too) | 13 | 13 |
| **of what it was asked to draw** | 6.3% exact, 66.9% drawn | **93.7% exact, 97.1% drawn** |
...
The remaining eleven are a long tail rather than a wall. Most come out
