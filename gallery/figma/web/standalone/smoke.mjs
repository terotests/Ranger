...
// Nothing in this export is drawn wrong and nothing is left undrawn — the
// shadow under its two buttons reaches the painter now, so the list is read
// with no exceptions carved out of it.
