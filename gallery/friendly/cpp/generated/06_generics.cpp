...
class Stack_int { 
  public :
    ...
    int size();
     ...
     r_optional_primitive<int>  _optionalInt( const std::string& text );
};
class Stack_string { 
  public :
...
int  Stack_int::size() {
 ...
 r_optional_primitive<int>   Stack_int::_optionalInt( const std::string& text ) {
  return cpp_str_to_int(text);
}
...
std::string  Stack_string::peek() {
 ...
 r_optional_primitive<int>   Stack_string::_optionalInt( const std::string& text ) {
  return cpp_str_to_int(text);
}
