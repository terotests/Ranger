...
| **hover** a UML class or member | a VS Code-style card: signature, documentation from the source (JSDoc unwrapped — description and `@param` names, not raw stars), and a click hint. The row highlights and the pointer becomes a hand |
