...
| [`friendly`](friendly/README.md) | Target-idiom studies: write ordinary Ranger, compile it, and record whether the Rust / Go / Python / C++ / Swift / Kotlin / Dart looks like the language a native programmer would write |
