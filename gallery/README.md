...
| [`ui`](ui/README.md) | EVG controllers measured against Radix: a behaviour-parity harness that runs the same spec through Ranger's own controllers and real `@radix-ui` components, and diffs what a user can observe. The demos and the Radix-vs-Ranger playground live in [terotests/EVGUI](https://github.com/terotests/EVGUI) — [live](https://terotests.github.io/EVGUI/) |
