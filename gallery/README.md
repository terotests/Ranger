...
| [`erazer`](erazer/README.md) | Bitmap UI screenshot → nested EVG layout: panels, text, buttons, fields, tabs, menus, checkboxes, and icons vectorized as SVG. Paste or pick a screenshot in the tab; [live at /evg/erazer/](https://terotests.github.io/Ranger/evg/erazer/) |
