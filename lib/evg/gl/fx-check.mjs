...
console.log("-- the demo document, straight out of the engine");
{
  ...
  if (!fs.existsSync(demo)) {
    ...
    say(byId.glass && byId.glass.kind === "liquid-glass" && !byId.glass.on,
      "the pane is a backdrop effect with no trigger — it is a material, not a reaction",
      "liquid glass is not something that happens when you press it");
  }
}
