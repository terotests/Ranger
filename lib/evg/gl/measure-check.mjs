...
import { requireDom, findChromium } from "../../../gallery/ui/conformance/dom-adapter.mjs";
...
const PAGES = [
  ...
  },
  {
    ...
    built: "lib/evg/web/responsive/dist/index.html",
    build: "npm run evg:responsive:web",
    url: "/lib/evg/web/responsive/dist/index.html",
