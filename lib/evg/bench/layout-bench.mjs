...
//
//   node --expose-gc lib/evg/bench/layout-bench.mjs [--sizes 1000,10000,100000] [--json] [--no-browser]
//
...
const M = require(path.join(ROOT, "lib/evg/bin/EvgLayoutBench.cjs"));
...
const BASE_PATH = path.join(ROOT, "lib/evg/bin/EvgLayoutBenchBase.cjs");
