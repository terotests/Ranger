...
if (fs.existsSync(path.join(ROOT, "gallery/evgui/demo/bundle.js"))) {
  await shot({
    root: ROOT,
    url: "/gallery/evgui/demo/index.html?inspect=1&demo=dashboard",
  ...
  console.log("  (skipping the dashboard — run: clone terotests/EVGUI to gallery/evgui and run: node gallery/evgui/scripts/run.mjs ui:demo:build && node gallery/evgui/demo/build.mjs)");
}
