 ...
 *
 *   node lib/evg/web/responsive/build.mjs
 *   node lib/evg/web/responsive/build.mjs --out path/to/evg/responsive
 *
...
const log = execFileSync(
  ...
  [
    "bin/output.js",
    "-es6",
    "lib/evg/web/responsive/EvgResponsiveDemo.rgr",
...
const scoped =
  "// GENERATED from lib/evg/web/responsive/EvgResponsiveDemo.rgr — do not edit.\n" +
  "(function () {\n" +
  bundle +
...
fs.copyFileSync(path.join(ROOT, "lib/evg/html/evg-html.js"), path.join(OUT, "evg-html.js"));
fs.copyFileSync(path.join(ROOT, "lib/evg/gl/evg-measure.js"), path.join(OUT, "evg-measure.js"));
fs.copyFileSync(path.join(ROOT, "lib/evg/html/evg-dom.js"), path.join(OUT, "evg-dom.js"));
