 ...
 *
 *   node lib/evg/web/tracer/build.mjs
 *   node lib/evg/web/tracer/build.mjs --out path/to/evg/tracer
 *
...
const scoped =
  "// GENERATED from lib/evg/EvgBitmapTracer.rgr — do not edit.\n" +
  "(function () {\n" +
  bundle +
