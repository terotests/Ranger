...
Older `.clj`-named fixtures in this folder (`SimpleChessBoard`, `ChessBoard`,
and the `Test*` probes) remain as compile smoke tests for npm scripts
`gen:simple`, `gen:chess`, etc. They are not maintained as a language tutorial.
