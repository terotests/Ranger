    ...
    try {
      ...
      if ( currC.is_immutable ) {
        ...
        if ( vDef.value_type == 7 ) {
          ...
          parser.CheckTypeAnnotationOf(vDef, ctx, wr);
          parser.CheckVRefTypeAnnotationOf(tDef_1, ctx, wr);
        }
      }
      p.name = s;
...
CodeNodeLiteral.fromDictionary = function(dict) {
  ...
  try {
    ...
    if ( typeof(values) !== "undefined" ) {
      const arr = values;
      operatorsOfJSONArrayObject_23.forEach_24(arr, ((item, index) => { 
    ...
    if ( typeof(values_2) !== "undefined" ) {
      const arr_1 = values_2;
      operatorsOf_23.forEach_24(arr_1, ((item, index) => { 
        if( typeof(item) === 'string' ) /* union case for string */ {
          var oo_1 = item;
    ...
    if ( typeof(values_3) !== "undefined" ) {
      const arr_2 = values_3;
      operatorsOf_23.forEach_24(arr_2, ((item, index) => { 
    ...
    if ( typeof(values_4) !== "undefined" ) {
      const arr_3 = values_4;
      operatorsOf_23.forEach_24(arr_3, ((item, index) => { 
        if( item instanceof Object ) /* union case */ {
          var oo_3 = item;
    ...
    if ( typeof(values_5) !== "undefined" ) {
      const arr_4 = values_5;
      operatorsOf_23.forEach_24(arr_4, ((item, index) => { 
        if( item instanceof Object ) /* union case */ {
          var oo_4 = item;
...
class CodeNode  {
  ...
  inferDefExpressionTypeFromValue (node) {
    ...
    if ( typeof(cn.expression_value) !== "undefined" ) {
      cn.value_type = 17;
      cn.parsed_type = 17;
      cn.has_vref_annotation = true;
    }
    if ( nodeValue.eval_type == 17 ) {
      if ( typeof(nodeValue.expression_value) !== "undefined" ) {
  ...
  cleanNode () {
    ...
    cp.children.forEach(((item, index) => { 
      item.cleanNode();
    }));
  };
  cleanCopy () {
  ...
  buildTypeSignature () {
    ...
    if ( this.value_type == 17 ) {
      ...
      s = ((s + " (") + (operatorsOf_12.map_14(argNode.children, ((item, index) => { 
...
class RangerAppWriterContext  {
  ...
  addPluginOp (name) {
    ...
    root.pluginSpecificOperators[name] = true;
  };
  removePluginOp (name) {
    const root = this.getRoot();
  ...
  getAllOperators () {
    const root = this.getRoot();
    let res = [];
    operatorsOf.forEach_2(root.op_list, ((item, index) => { 
  ...
  initOpList () {
    const root = this.getRoot();
    if ( typeof(root.operators) !== "undefined" ) {
      const op = root.operators;
      op.initializeOpCache();
      const foo = op.getOperators("+");
      if ( (foo.length) > 0 ) {
        operatorsOf.forEach_3(op.opHash, ((item, index) => { 
          const op_name = index;
  ...
  pushAndCollectCode (source_code, wr) {
    const code = new SourceCode(source_code);
    code.filename = "dynamically_generated";
    const parser_1 = new RangerLispParser(code);
    parser_1.parse(this.hasCompilerFlag("no-op-transform"));
  ...
  getOperatorDef () {
    if ( typeof(this.operators) !== "undefined" ) {
  ...
  getOperators (name) {
    ...
    while (typeof(cc.parent) !== "undefined") {
      cc = cc.parent;
      if ( (cc.opNs.length) > 0 ) {
    ...
    if ( typeof(root.operators) !== "undefined" ) {
      ...
      for ( let i_2 = 0; i_2 < opNamespace.length; i_2++) {
        ...
        handled[ss] = true;
        const nsOps = op.getOperators(((ss + ".") + name));
        for ( let i_3 = 0; i_3 < nsOps.length; i_3++) {
          var ns_op = nsOps[i_3];
          listOfOps.push(ns_op);
        };
      };
      const plainOps = op.getOperators(name);
      ...
      let cc_2;
      cc_2 = this;
      while (typeof(cc_2) !== "undefined") {
        if ( typeof(cc_2.operatorFunction) !== "undefined" ) {
          const opFn = cc_2.operatorFunction;
          const suggestedOp = opFn(name);
          suggestedOp.children.forEach(((item, index) => { 
  ...
  createStaticMethod (withName, currC, nameNode, argsNode, fnBody, parser, wr) {
    const s = withName;
  ...
  createTraitInstanceClass (traitName, instanceName, initParams, flowParser, wr) {
    let res;
    const ctx = this.fork();
    ...
    if ( t_2.has_constructor ) {
      ...
      res = new_class;
      flowParser.walkAlso.push(new_class.node);
    }
    return res;
  };
  ...
  getCurrentClass () {
    ...
    if ( this.in_class && (typeof(non) !== "undefined") ) {
      return non;
    }
    if ( typeof(this.parent) !== "undefined" ) {
    ...
    while (this.i < this.__len) {
      ...
      if ( this.i < this.__len ) {
        ...
        if ( (false == disable_ops_set) && (c == (58)) ) {
          ...
          while ((this.i < this.__len) && operatorsOfchar_5.isc95notc95limiter_6(c)) {
            this.i = 1 + this.i;
            c = s.charCodeAt(this.i );
            if ( c == (64) ) {
              had_type_ann = true;
  ...
  matchArguments (args, callArgs, ctx, firstArgIndex) {
    ...
    for ( let i = 0; i < callArgs.children.length; i++) {
      ...
      if ( callArg.hasParamDesc ) {
        ...
        if ( typeof(pa.nameNode) !== "undefined" ) {
      ...
      if ( (arg.value_type != 7) && (arg.value_type != 6) ) {
        if ( typeof(callArg.paramDesc) !== "undefined" ) {
          if ( (typeof(callArg.paramDesc.nameNode) !== "undefined") && (typeof(callArg.paramDesc.nameNode.expression_value) !== "undefined") ) {
...
class RangerSerializeClass  {
  ...
  createJSONSerializerFn2 (cl, ctx, wr) {
    const use_exceptions = ctx.getTargetLang() != "swift3";
    let declaredVariable = {};
    wr.out(("extension " + cl.name) + " {", true);
    wr.indent(1);
...
class RangerServiceBuilder  {
  ...
  CreateServices (parser, ctx, orig_wr) {
    if ( ctx.hasCompilerFlag("client") || ctx.hasCompilerSetting("client") ) {
      ...
      operatorsOf.forEach_7(root.appServices, ((item, index) => { 
...
class RangerFlowParser  {
          ...
          if ( ((name.length) > 0) && ((name.charCodeAt(0 )) == (".".charCodeAt(0))) ) {
            ...
            if ( i > 0 ) {
              ...
              if ( is_chaining == false ) {
                ...
                is_chaining = true;
                if ( typeof(last_line.chainTarget) !== "undefined" ) {
  ...
  WalkNode (node, ctx, wr) {
    ...
    if ( (node.children.length) == 1 ) {
      const fc_1 = node.children[0];
      if ( ctx.isVarDefined(fc_1.vref) ) {
        fc_1.parent = node;
        if ( typeof(fc_1.evalCtx) !== "undefined" ) {
          this.WalkNode(fc_1, fc_1.evalCtx, wr);
        } else {
    ...
    if ( (node.children.length) > 0 ) {
      ...
      if ( fc_3.expression && ((node.children.length) == 2) ) {
        ...
        if ( ((sec.vref.length) > 0) && ((sec.vref[0]) == ".") ) {
          ...
          if ( ((fc_3.eval_type_name.length) > 0) && ctx.isDefinedClass(fc_3.eval_type_name) ) {
            ...
            let classDesc = ctx.findClass(fc_3.eval_type_name);
            /** unused:  const objExpr = fc_3.copy()   **/ 
            let calledItem = CodeNode.fromList([CodeNode.vref1("property"), fc_3.copy(), CodeNode.vref1(method_name)]);
            ...
            if ( typeof(m_1) !== "undefined" ) {
              node.getChildrenFrom(calledItem);
              node.flow_done = false;
              this.transformMethodToLambda(node, m_1, ctx, wr);
              return true;
            }
          }
        }
      ...
      if ( fc_3.expression && ((node.children.length) == 3) ) {
        ...
        if ( ((sec_1.vref.length) > 0) && ((sec_1.vref[0]) == ".") ) {
          ...
          let classDesc_1 = ctx.findClass(fc_3.eval_type_name);
          /** unused:  const objExpr_1 = fc_3.copy()   **/ 
          let calledItem_1 = fc_3.copy();
          parts_1.forEach(((item, index) => { 
    ...
    if ( node.expression ) {
      for ( let i = 0; i < node.children.length; i++) {
        var item = node.children[i];
        item.parent = node;
        if ( typeof(item.evalCtx) !== "undefined" ) {
          this.WalkNode(item, item.evalCtx, wr);
        } else {
          this.WalkNode(item, ctx, wr);
        }
        node.copyEvalResFrom(item);
        if ( (i == 0) && ((node.children.length) == 2) ) {
          if ( (item.eval_type == 28) && (typeof(item.paramDesc) !== "undefined") ) {
        ...
        if ( ((typeof(item.expression_value) !== "undefined") || (item.value_type == 17)) || (item.eval_type == 17) ) {
          if ( (i == 0) && ((node.children.length) == 2) ) {
            ...
            ctx.unsetInExpr();
            if ( typeof(item.expression_value) !== "undefined" ) {
    ...
    if ( (rootObjName == "this") || ctx.isVarDefined(rootObjName) ) {
      ...
      if ( false == class_or_this ) {
        ...
        if ( (node.vref == "fun") || (node.vref == "fn") ) {
          ...
          if ( typeof(node.parent.parent) !== "undefined" ) {
  ...
  EnterFn (node, ctx, wr, callback) {
    try {
      ...
      callback(node, ctx, wr, node.children[(idx + 1)], node.children[(idx + 2)], node.children[(idx + 3)], currClass);
    } catch(e) {
  ...
  cmdNew (node, ctx, wr) {
    ...
    if ( typeof(fnDescr) !== "undefined" ) {
      ...
      for ( let i_1 = 0; i_1 < fnDescr.params.length; i_1++) {
        ...
        if ( false == this.areEqualTypes((param.nameNode), argNode, ctx, wr) ) {
  ...
  matchLambdaArgs (n1, n2, ctx, wr) {
    ...
    argsExpr1.children.forEach(((item, index) => { 
      ...
      if ( all_matched && (item.value_type == 17) ) {
        if ( false == this.matchLambdaArgs((item.expression_value), (item2.expression_value), ctx, wr) ) {
          all_matched = false;
        }
      }
    }));
    ...
    rvExpr1.children.forEach(((item, index) => { 
      ...
      if ( all_matched && (item.value_type == 17) ) {
        if ( false == this.matchLambdaArgs((item.expression_value), (item2_1.expression_value), ctx, wr) ) {
          all_matched = false;
        }
      }
    }));
  ...
  testLambdaCallArgs (lambda_expression, callParams, ctx, wr) {
    ...
    lambdaArgs.children.forEach(((item, index) => { 
  ...
  cmdLocalCall (node, ctx, wr) {
    ...
    if ( chlen > 2 ) {
      ...
      newNode.add(sc.copy());
      innerNode = newNode;
      console.log("Chaining " + node.getCode());
      let chain_cnt = 0;
      let b_valid = true;
      while (i < (chlen - 1)) {
    ...
    if ( desc.hasMethod(fnNode.vref) ) {
      ...
      for ( let i_4 = 0; i_4 < fnDescr.params.length; i_4++) {
        ...
        if ( false == this.areEqualTypes((param_1.nameNode), argNode_1, ctx, wr) ) {
    ...
    if ( ctx.isVarDefined(fnNode.vref) ) {
      ...
      if ( d.nameNode.value_type == 17 ) {
        ...
        this.testLambdaCallArgs(d.nameNode.expression_value, callParams_1, ctx, wr);
        ...
        if ( node.eval_type == 17 ) {
          if ( typeof(lambdaDef.expression_value) !== "undefined" ) {
  ...
  cmdAssign (node, ctx, wr) {
    ...
    if ( target.hasParamDesc ) {
      if ( typeof(target.paramDesc.propertyClass) !== "undefined" ) {
    ...
    if ( chlen > 3 ) {
      let i = 3;
      const chainRoot = node.getThird();
      let innerNode = chainRoot;
      let chain_cnt = 0;
      if ( chainRoot.expression == false ) {
        const args = node.children[3];
        const newNode = node.newExpressionNode();
        /** unused:  const sc = node.getSecond()   **/ 
      ...
      while (i < (chlen - 1)) {
        const fc = node.children[i];
        const args_1 = node.children[(i + 1)];
        const name = fc.vref;
        if ( ((name.length) > 0) && ((name.charCodeAt(0 )) == (".".charCodeAt(0))) ) {
          const method_name = name.substring(1, (name.length) );
          const newNode_1 = node.newExpressionNode();
          ...
          newNode_1.add(innerNode.copy());
          newNode_1.add(node.newVRefNode(method_name));
          newNode_1.add(args_1.copy());
          innerNode = newNode_1;
          chain_cnt = chain_cnt + 1;
          fc.is_part_of_chain = true;
          args_1.is_part_of_chain = true;
        } else {
    ...
    this.WalkNode(n1_1, ctx, wr);
    ctx.setInExpr();
    this.WalkNode(n2_1, ctx, wr);
    ctx.unsetInExpr();
  ...
  EnterClass (node, ctx, wr) {
    ...
    cBody.children.forEach(((item, index) => { 
      try {
  ...
  walkFunctionBody (m, fnBody, ctx, subCtx, wr) {
  ...
  EnterMethod (node, ctx, wr) {
    this.EnterFn(node, ctx, wr, ((node, ctx, wr, nameNode, fnArgs, fnBody, desc) => { 
  ...
  cmdArray (node, ctx, wr) {
    ...
    for ( let i_1 = 0; i_1 < node.children.length; i_1++) {
      ...
      this.WalkNode(itemCopy_1, ctx, wr);
  ...
  CheckVRefTypeAnnotationOf (node, ctx, wr) {
      ...
      if ( false == ctx.isDefinedClass(node.vref) ) {
        ...
        if ( testC.is_trait ) {
          if ( testC.node.hasExpressionProperty("params") ) {
            ...
            const class_name = testC.name + tstr;
            const ann = tAnn;
  ...
  CheckTypeAnnotationOf (node, ctx, wr) {
    ...
    if ( ctx.isInMethod() ) {
      ...
      if ( (node.children.length) > 2 ) {
        ...
        if ( defaultArg.hasParamDesc ) {
          ...
          if ( typeof(paramDesc.propertyClass) !== "undefined" ) {
      ...
      if ( cn.has_type_annotation ) {
        ...
        if ( (ann_1.children.length) > 0 ) {
          const fc_2 = ann_1.children[0];
          ctx.log(node, "ann", (("value of first annotation " + fc_2.vref) + " and variable name ") + cn.vref);
        }
      }
      ...
      if ( (node.children.length) > 2 ) {
        if ( typeof(defaultArg) !== "undefined" ) {
          this.convertToUnion(cn.eval_type_name, defaultArg, ctx, wr);
          if ( typeof(defaultArg.evalTypeClass) !== "undefined" ) {
            cn.evalTypeClass = defaultArg.evalTypeClass;
          }
        }
        if ( cn.eval_type != defaultArg.eval_type ) {
          if ( ((cn.eval_type == 14) && (defaultArg.eval_type == 3)) || ((cn.eval_type == 3) && (defaultArg.eval_type == 14)) ) {
          } else {
  ...
  matchNode (node, ctx, wr) {
    ...
    const op_list = ctx.getOperators(fc.vref);
  ...
  mergeImports (node, ctx, wr) {
    if ( node.isFirstVref("Import") ) {
      ...
      if ( (source_code.length) == 0 ) {
        ...
        if ( (require("fs").existsSync(filePathIs + "/" + import_file )) == false ) {
        ...
        const c = (require('fs').readFileSync( filePathIs + '/' + import_file , 'utf8'));
        source_code = c;
      }
      const code = new SourceCode(source_code);
  ...
  CollectMethods (node, ctx, wr) {
    ...
    for ( let i = 0; i < this.classesWithTraits.length; i++) {
      ...
      if ( t.has_constructor ) {
        ...
        for ( let i_5 = 0; i_5 < traitClass.static_methods.length; i_5++) {
          ...
          this.WalkCollectMethods(ccopy_2, ctx, wr);
          origBody.children.push(ccopy_2);
        };
      }
    };
    for ( let i_6 = 0; i_6 < this.serializedClasses.length; i_6++) {
      var cl_1 = this.serializedClasses[i_6];
    ...
    for ( let i_7 = 0; i_7 < this.immutableClasses.length; i_7++) {
      ...
      this.WalkCollectMethods(rn_1, cl_2.ctx, wr);
  ...
  defineFunctionParam (method, arg, ctx, wr) {
  ...
  CreateFunctionObject (orig_node, ctx, wr) {
    const subCtx = ctx.fork();
    ...
    const m = operatorsOfCodeNode_9.rc46funcdesc_10(node, ctx);
    subCtx.is_function = true;
    subCtx.currentMethod = m;
    m.fnCtx = subCtx;
    if ( cn.hasFlag("weak") ) {
    ...
    this.CheckTypeAnnotationOf(m.nameNode, ctx, wr);
    for ( let ii = 0; ii < args.children.length; ii++) {
      var arg = args.children[ii];
      this.CheckTypeAnnotationOf(arg, subCtx, wr);
      const p2 = new RangerAppParamDesc();
  ...
  WalkCollectMethods (node, ctx, wr) {
    ...
    if ( node.isFirstVref("operator") ) {
      ...
      const b_is_void = nameNode.type_name == "void";
      const opLang = node.children[2];
      const opsList = node.children[3];
    ...
    if ( node.isFirstVref("def") || node.isFirstVref("let") ) {
      ...
      if ( currC_4.is_immutable ) {
        ...
        if ( vDef.value_type == 7 ) {
          ...
          vDef.type_annotation = tAnn_1;
          this.CheckTypeAnnotationOf(vDef, ctx, wr);
          this.CheckVRefTypeAnnotationOf(tDef_1, ctx, wr);
        }
      }
      p_1.name = s_3;
    ...
    if ( node.isFirstVref("static") ) {
      ...
      this.CheckTypeAnnotationOf(m_1.nameNode, ctx, wr);
      args_2.children.forEach(((item, index) => { 
        this.defineFunctionParam(m_1, item, ctx, wr);
      }));
    ...
    if ( node.isFirstVref("StaticMethod") || node.isFirstVref("sfn") ) {
      ...
      this.CheckTypeAnnotationOf(m_2.nameNode, ctx, wr);
      args_3.children.forEach(((item, index) => { 
        this.defineFunctionParam(m_2, item, ctx, wr);
      }));
    ...
    if ( node.isFirstVref("PublicMethod") || node.isFirstVref("fn") ) {
      ...
      const fnObj = operatorsOf_9.rc46func_11(node, (currC_8.ctx), wr);
    ...
    if ( find_more ) {
      for ( let i_12 = 0; i_12 < node.children.length; i_12++) {
        ...
        this.WalkCollectMethods(item_3, ctx, wr);
      };
    }
  ...
  convertToUnion (unionName, node, ctx, wr) {
    if ( ctx.isDefinedClass(unionName) ) {
      ...
      if ( c1.is_union ) {
        if ( (node.type_name != c1.name) && (node.eval_type_name != c1.name) ) {
          ...
          this.WalkNode(node, ctx, wr_1);
        }
      }
    }
  };
  transformMethodToLambda (node, vFnDef, ctx, wr) {
    if ( vFnDef.isFunction() ) {
      const args = operatorsOf_12.map_13(vFnDef.params, ((item, index) => { 
      ...
      const argsExpr = args.map(((item, index) => { 
        return item.copy();
      }));
  ...
  areEqualTypes (n1, n2, ctx, wr) {
    if ( n1.eval_type == 17 ) {
      let n1Expr = n1.expression_value;
      let n2Expr = n2.expression_value;
      if ( typeof(n1Expr) === "undefined" ) {
        if ( (n1.hasParamDesc && (typeof(n1.paramDesc.nameNode) !== "undefined")) && (typeof(n1.paramDesc.nameNode.expression_value) !== "undefined") ) {
          n1Expr = n1.paramDesc.nameNode.expression_value;
        }
      }
      if ( typeof(n2Expr) === "undefined" ) {
        if ( (n2.hasParamDesc && (typeof(n2.paramDesc.nameNode) !== "undefined")) && (typeof(n2.paramDesc.nameNode.expression_value) !== "undefined") ) {
          n2Expr = n2.paramDesc.nameNode.expression_value;
        }
      }
      if ( (typeof(n1Expr) !== "undefined") && (typeof(n2Expr) !== "undefined") ) {
        return this.matchLambdaArgs((n1Expr), (n2Expr), ctx, new CodeWriter());
      }
      if ( n2.eval_type == 28 ) {
        console.log(" FOUND METHOD " + n2.getCode());
      ...
      if ( typeof(vFnDef) !== "undefined" ) {
        this.transformMethodToLambda(n2, vFnDef, ctx, wr);
        return true;
      }
        ...
        if ( fc.vref == "templates" ) {
          ...
          for ( let i_1 = 0; i_1 < tplList.children.length; i_1++) {
            ...
            if ( tpl.hasExpressionProperty("flags") ) {
              ...
              let b_matched = false;
              flagList.children.forEach(((item, index) => { 
          ...
          if ( langName == "ranger" ) {
            ...
            let cnt = 1;
            opArgs.children.forEach(((item, index) => { 
  ...
  stdParamMatch (callArgs, inCtx, wr, require_all_match) {
    ...
    if ( in_chain ) {
      const fc = callArgs.getFirst();
      const sc = callArgs.getSecond();
      const thrd = callArgs.getThird();
      let i_1 = call_arg_cnt;
      /** unused:  const chainRoot = callArgs   **/ 
      let innerNode;
      const newNode = CodeNode.fromList([fc.copy(), sc.copy(), thrd.copy()]);
      innerNode = newNode;
      let chain_cnt = 0;
      const chlen = callArgs.children.length;
      while (i_1 < (chlen - 1)) {
        const fc_1 = callArgs.children[i_1];
        const args = callArgs.children[(i_1 + 1)];
        const name_1 = fc_1.vref;
        if ( ((name_1.length) > 0) && ((name_1.charCodeAt(0 )) == (".".charCodeAt(0))) ) {
          const method_name = name_1.substring(1, (name_1.length) );
          const newNode_1 = CodeNode.op3("call", [innerNode.copy(), CodeNode.vref1(method_name), args.copy()]);
          innerNode = newNode_1;
          chain_cnt = chain_cnt + 1;
        } else {
      ...
      if ( chain_cnt > 0 ) {
        callArgs.getChildrenFrom(innerNode);
    ...
    for ( let main_index = 0; main_index < op_list.length; main_index++) {
      ...
      if ( (callerArgCnt == fnArgCnt) || expanding_node ) {
        ...
        const langOper = this.findLanguageOper(details_list, ctx, ch);
        ...
        for ( let i_2 = 0; i_2 < args_1.children.length; i_2++) {
          var arg = args_1.children[i_2];
          if ( i_2 < arg_eval_start ) {
            continue;
          }
          arg_eval_start = i_2;
          if ( (callArgs.children.length) <= (i_2 + 1) ) {
            not_enough_args = true;
            break;
          }
          const callArg = callArgs.children[(i_2 + 1)];
          ...
          if ( arg.value_type == 17 ) {
            ...
            if ( arg.hasFlag("mutates") ) {
              if ( callArg.hasParamDesc ) {
                if ( typeof(callArg.paramDesc) != "undefined" && (typeof(callArg.paramDesc.propertyClass) !== "undefined") ) {
        ...
        const all_matched = match.matchArguments(args_1, callArgs, ctx, 1);
        if ( all_matched ) {
          if ( throws_exception ) {
            if ( false == ctx.isTryBlock() ) {
              const activeFn = ctx.getCurrentMethod();
              if ( (typeof(activeFn.nameNode) !== "undefined") && activeFn.nameNode.hasFlag("throws") ) {
              } else {
                ctx.addError(callArgs, ("The operator " + fc_2.vref) + " potentially throws an exception, try { } block is required");
              }
            }
          }
          for ( let i_3 = 0; i_3 < blocksToWalkLater.length; i_3++) {
            var b = blocksToWalkLater[i_3];
            const localFork = b.evalCtx.fork();
            this.WalkNode(b, localFork, wr);
          };
          for ( let i_4 = 0; i_4 < walk_later.length; i_4++) {
            var later_1 = walk_later[i_4];
            const ca_1 = later_1.callArg;
            const aa = later_1.arg;
            /** unused:  const newNode_2 = new CodeNode(ca_1.code, ca_1.sp, ca_1.ep)   **/ 
            if ( (ca_1.is_block_node && (ca_1.isFirstVref("fn") == false)) && (ca_1.isFirstVref("fun") == false) ) {
              const fnDef = aa.expression_value;
              const copyOf = fnDef.rebuildWithType(match, false);
              const ffc = copyOf.children[0];
              ffc.vref = "fun";
              const itemCopy = ca_1.rebuildWithType(match, false);
              copyOf.children.push(itemCopy);
              let cnt = ca_1.children.length;
              while (cnt > 0) {
                ca_1.children.pop();
                cnt = cnt - 1;
              };
              for ( let i_5 = 0; i_5 < copyOf.children.length; i_5++) {
                var ch_1 = copyOf.children[i_5];
                ca_1.children.push(ch_1);
              };
            }
            const sCtx_1 = ctx.fork();
            this.WalkNode(ca_1, sCtx_1, wr);
          };
        }
        if ( codeDef.is_block_node && all_matched ) {
          const pure_transform = ctx.hasCompilerFlag("pure");
          if ( is_pure && pure_transform ) {
            const argDefs = CodeNode.blockFromList((args_1.children.map(((item, index) => { 
              ...
              const first = prms[0];
              const ad = CodeNode.op3("def", [vName, first]);
              return ad;
            }))));
          ...
          if ( false == new_cl.hasStaticMethod(argsSig) ) {
            ...
            fCtx.setInMethod();
            for ( let i_6 = 0; i_6 < m.params.length; i_6++) {
              var v = m.params[i_6];
              fCtx.defineVariable(v.name, v);
              v.nameNode.eval_type = v.nameNode.typeNameAsType(fCtx);
              v.nameNode.eval_type_name = v.nameNode.type_name;
            };
            this.WalkNodeChildren(bodyCopy_1, fCtx, wr);
            fCtx.unsetInMethod();
            fCtx.in_static_method = false;
            fCtx.function_level_context = true;
            for ( let i_7 = 0; i_7 < fCtx.localVarNames.length; i_7++) {
              var n = fCtx.localVarNames[i_7];
        ...
        if ( all_matched ) {
          if ( is_static_fn ) {
            ...
            for ( let i_8 = 0; i_8 < callArgs.children.length; i_8++) {
              var ca_2 = callArgs.children[i_8];
              if ( ca_2.is_part_of_chain ) {
                continue;
              }
              if ( i_8 > 0 ) {
                const arg_2 = args_1.children[(i_8 - 1)];
                if ( arg_2.hasFlag("noeval") ) {
                  continue;
                }
                newArgs.children.push(ca_2);
              }
            };
          ...
          if ( nameNode.hasFlag("returns") ) {
            ...
            if ( (activeFn_1.nameNode.type_name != "void") || (activeFn_1.nameNode.value_type == 17) ) {
              if ( (callArgs.children.length) < 2 ) {
                ...
                if ( activeFn_1.nameNode.value_type == 17 ) {
                  validated_returnvalue = true;
                  const fnExpr = activeFn_1.nameNode.expression_value;
                  if ( typeof(fnExpr) === "undefined" ) {
                    ctx.addError(activeFn_1.nameNode, "returned anonymous function should have a method signature");
                  } else {
                    if ( (returnedValue.value_type != 17) && (returnedValue.eval_type != 17) ) {
                      ...
                      if ( returnedValue.hasParamDesc && (typeof(returnedValue.paramDesc.nameNode) !== "undefined") ) {
                        const rExpr = returnedValue.paramDesc.nameNode.expression_value;
                        this.matchLambdaArgs(fnExpr, rExpr, ctx, wr);
                      } else {
                        const rExpr_1 = returnedValue.expression_value;
                        this.matchLambdaArgs(fnExpr, rExpr_1, ctx, wr);
                      }
                    }
                  }
                }
                if ( validated_returnvalue == false ) {
                  if ( match.doesMatch((activeFn_1.nameNode), returnedValue, ctx) == false ) {
                    if ( activeFn_1.nameNode.ifNoTypeSetToEvalTypeOf(returnedValue) ) {
                    } else {
                      ...
                      ctx.addError(activeFn_1.nameNode, "^ regarding to");
                      if ( returnedValue.eval_type == 28 ) {
                        ctx.addError(activeFn_1.nameNode, "^ which was a method");
                      }
                      ctx.addError(activeFn_1.nameNode, "^ value type = " + returnedValue.eval_type);
                    }
                  }
                }
                const argNode = activeFn_1.nameNode;
                ...
                if ( typeof(pp_1) !== "undefined" ) {
                  pp_1.moveRefTo(callArgs, activeFn_1, ctx);
                }
              }
            }
          ...
          for ( let arg_index = 0; arg_index < args_1.children.length; arg_index++) {
            var arg_3 = args_1.children[arg_index];
            if ( arg_3.has_vref_annotation ) {
              const anns = arg_3.vref_annotation;
              for ( let i_9 = 0; i_9 < anns.children.length; i_9++) {
                var ann_1 = anns.children[i_9];
...
class RangerGenericClassWriter  {
  ...
  CreateUnions (parser, ctx, orig_wr) {
  };
  CreateServices (parser, ctx, orig_wr) {
  };
  CreatePages (parser, ctx, orig_wr) {
  };
  CreatePage (parser, node, ctx, orig_wr) {
...
class AndroidPageWriter  {
  ...
  CreatePage (parser, node, ctx, orig_wr) {
    ...
    if ( pageName != "notme" ) {
      fnBody.children.forEach(((item, index) => { 
    ...
    subCtx.in_static_method = false;
    subCtx.function_level_context = true;
    this.classWriter.WalkNode(preBody, subCtx, wr);
    wr.out("mainProcess = (", false);
    subCtx.setInExpr();
    this.classWriter.WalkNode(newBody, subCtx, wr);
    subCtx.unsetInExpr();
    wr.out(");", true);
    this.classWriter.WalkNode(mainBody, subCtx, wr);
...
class RangerJava7ClassWriter  extends RangerGenericClassWriter {
      ...
      switch (v_type ) { 
        case 17 : 
          ...
          if ( (( typeof(this.iface_created[iface_name] ) != "undefined" && this.iface_created.hasOwnProperty(iface_name) )) == false ) {
            ...
            utilWr.indent(-1);
            utilWr.out("}", true);
            utilWr.getImports().forEach(((item, index) => { 
      ...
      switch (v_type ) { 
        case 17 : 
          ...
          if ( (( typeof(this.iface_created[iface_name_1] ) != "undefined" && this.iface_created.hasOwnProperty(iface_name_1) )) == false ) {
            ...
            utilWr_1.indent(-1);
            utilWr_1.out("}", true);
            utilWr_1.getImports().forEach(((item, index) => { 
        ...
        default: 
          ...
          if ( ctx.isDefinedClass(t_name) ) {
            ...
            if ( cc_1.is_system ) {
              this.addSystemImport(cc_1, ctx, wr);
  ...
  CreateLambdaCall (node, ctx, wr) {
    ...
    let rv;
    let args;
    if ( typeof(fName.expression_value) !== "undefined" ) {
  ...
  CreateLambda (node, ctx, wr) {
    ...
    if ( (( typeof(this.iface_created[iface_name] ) != "undefined" && this.iface_created.hasOwnProperty(iface_name) )) == false ) {
      ...
      utilWr_1.indent(1);
      utilWr_1.out("public ", false);
      this.writeTypeDef(fnNode, ctx, utilWr_1);
      utilWr_1.out(" run(", false);
      for ( let i = 0; i < args.children.length; i++) {
        var arg = args.children[i];
        if ( i > 0 ) {
        ...
        utilWr_1.out(" final ", false);
        this.writeTypeDef(arg, lambdaCtx, utilWr_1);
        utilWr_1.out(" ", false);
  ...
  CreatePages (parser, ctx, orig_wr) {
    operatorsOf.forEach_7(ctx.appPages, ((item, index) => { 
...
class RangerSwift3ClassWriter  extends RangerGenericClassWriter {
  ...
  writeArgsDefWithLocals (fnDesc, localFnDesc, ctx, wr) {
  ...
  writeClass (node, ctx, wr) {
    ...
    for ( let i_7 = 0; i_7 < cl.static_methods.length; i_7++) {
      ...
      subCtx_1.is_function = true;
      this.WalkNode(variant_2.fnBody, subCtx_1, wr);
      wr.newline();
      wr.indent(-1);
      wr.out("}", true);
    };
    for ( let i_8 = 0; i_8 < cl.defined_variants.length; i_8++) {
      ...
      for ( let i_9 = 0; i_9 < mVs_1.variants.length; i_9++) {
        ...
        if ( ( typeof(parentFunction[variant_3.name] ) != "undefined" && parentFunction.hasOwnProperty(variant_3.name) ) ) {
          this.writeArgsDefWithLocals((parentFunction[variant_3.name]), variant_3, ctx, wr);
        } else {
        ...
        subCtx_2.is_function = true;
        this.WalkNode(variant_3.fnBody, subCtx_2, wr);
        wr.newline();
        wr.indent(-1);
        wr.out("}", true);
      };
    ...
    for ( let i_10 = 0; i_10 < cl.static_methods.length; i_10++) {
      ...
      if ( variant_4.nameNode.hasFlag("main") && (variant_4.nameNode.code.filename == ctx.getRootFile()) ) {
        ...
        this.WalkNode(variant_4.fnBody, subCtx_3, theEnd);
        theEnd.newline();
        theEnd.indent(-1);
        theEnd.out("}", true);
...
class RangerCppClassWriter  extends RangerGenericClassWriter {
  ...
  CreateUnions (parser, ctx, wr) {
    const root = ctx.getRoot();
    operatorsOf.forEach_15(root.definedClasses, ((item, index) => { 
      if ( item.is_union ) {
        ...
        wr.indent(1);
        let cnt = 0;
        item.is_union_of.forEach(((item, index) => { 
...
class RangerCSharpClassWriter  extends RangerGenericClassWriter {
  ...
  writeLambdaType (expression_value, ctx, wr) {
  ...
  writeTypeDef (node, ctx, wr) {
    ...
    switch (v_type ) { 
      case 17 : 
        this.writeLambdaType(node.expression_value, ctx, wr);
        break;
      case 13 : 
        wr.out("int", false);
        break;
...
class RangerScalaClassWriter  extends RangerGenericClassWriter {
  ...
  CreateLambda (node, ctx, wr) {
    ...
    for ( let i_2 = 0; i_2 < body.children.length; i_2++) {
      ...
      this.WalkNode(item_1, lambdaCtx, wr);
    };
    if ( fnDef.type_name != "void" ) {
  ...
  writeClass (node, ctx, orig_wr) {
    ...
    let b_had_app = false;
    let app_obj;
    cl.static_methods.forEach(((item, index) => { 
      if ( item.name != "main" ) {
    ...
    if ( b_had_app ) {
      ...
      subCtx_3.is_function = true;
      this.WalkNode(variant_3.fnBody, subCtx_3, theEnd);
      if ( b_scalafiddle ) {
...
class RangerGolangClassWriter  extends RangerGenericClassWriter {
  ...
  WriteVRef (node, ctx, wr) {
    ...
    if ( (node.nsp.length) > 0 ) {
      ...
      for ( let i = 0; i < node.nsp.length; i++) {
        ...
        if ( i == 0 ) {
          ...
          const cc = ctx.getCurrentClass();
          if ( ((part != this.thisName) && (typeof(cc) !== "undefined")) && (false == ctx.isInStatic()) ) {
            const currC = cc;
            const up = currC.findVariable(part);
            const lvDef = ctx.getVariableDef(part);
            if ( (typeof(up) !== "undefined") && lvDef.is_class_variable ) {
              /** unused:  const p3 = up   **/ 
              wr.out(this.thisName + ".", false);
            }
          }
    ...
    if ( node.hasParamDesc ) {
      ...
      if ( ((part_1 != this.thisName) && (typeof(cc_1) !== "undefined")) && (false == ctx.isInStatic()) ) {
        const currC_1 = cc_1;
        const up_1 = currC_1.findVariable(part_1);
        const lvDef_1 = ctx.getVariableDef(part_1);
        if ( (typeof(up_1) !== "undefined") && lvDef_1.is_class_variable ) {
    ...
    for ( let i_1 = 0; i_1 < node.ns.length; i_1++) {
      ...
      if ( i_1 == 0 ) {
        ...
        if ( ((part_2 != "this") && (typeof(cc_2) !== "undefined")) && (false == ctx.isInStatic()) ) {
          const currC_2 = cc_2;
          const up_2 = currC_2.findVariable(part_2);
          const lvDef_2 = ctx.getVariableDef(part_2);
          if ( (typeof(up_2) !== "undefined") && lvDef_2.is_class_variable ) {
  ...
  goExtractAssign (value, p, ctx, wr) {
    ...
    for ( let i = 0; i < left.ns.length; i++) {
      ...
      if ( i == 0 ) {
        ...
        const cc = ctx.getCurrentClass();
        if ( ((part != "this") && (typeof(cc) !== "undefined")) && (false == ctx.isInStatic()) ) {
          const currC = cc;
          const up = currC.findVariable(part);
          const lvDef = ctx.getVariableDef(part);
          if ( (typeof(up) !== "undefined") && lvDef.is_class_variable ) {
      ...
      if ( (node.children.length) > 2 ) {
        ...
        if ( value_6.expression && ((value_6.children.length) > 1) ) {
          ...
          if ( fc.vref == "array_extract" ) {
            this.goExtractAssign(value_6, p, ctx, wr);
            return;
          }
        }
        wr.out("= ", false);
  ...
  CustomOperator (node, ctx, wr) {
    ...
    if ( cmd == "try" ) {
      ...
      const ex2 = operatorsOfRangerAppWriterContext_16.createc95var_17(ctx, "did_return", "boolean");
      const ex3 = operatorsOf_16.createc95var_18(ctx, "ex_result", (currFn.nameNode));
      ...
      this.WalkNode(tryBlock, subCtx_1, wr);
      wr.out("return __ex_returned, __exReturn", true);
      wr.indent(-1);
      wr.out("})()", true);
      if ( currFn.nameNode.type_name != "void" ) {
        ...
        wr.out(".(", false);
        this.writeTypeDef(currFn.nameNode, ctx, wr);
        wr.out(")", true);
        wr.indent(-1);
        wr.out("}", true);
      } else {
...
class WebPageWriter  {
  ...
  CreatePage (parser, node, ctx, orig_wr) {
    ...
    subCtx.in_static_method = false;
    subCtx.function_level_context = true;
    this.classWriter.WalkNode(fnBody, subCtx, wr);
    wr.out("return view;", true);
    wr.indent(-1);
    wr.out("}", true);
  };
...
class RangerJavaScriptClassWriter  extends RangerGenericClassWriter {
  ...
  writeClass (node, ctx, orig_wr) {
    ...
    if ( this.wrote_header == false ) {
      ...
      if ( this.target_typescript ) {
        this.CreateTsUnions(this.compiler.parser, ctx, wr);
      }
    ...
    for ( let i_3 = 0; i_3 < cl.defined_variants.length; i_3++) {
      ...
      for ( let i_4 = 0; i_4 < mVs.variants.length; i_4++) {
        ...
        const subCtx_1 = variant.fnCtx;
        subCtx_1.is_function = true;
        operatorsOf.forEach_4(subCtx_1.localVariables, ((item, index) => { 
          if ( item.is_register ) {
    ...
    if ( this.target_typescript == false ) {
      for ( let i_6 = 0; i_6 < cl.static_methods.length; i_6++) {
        ...
        if ( variant_2.nameNode.hasFlag("main") ) {
          ...
          wr.out(((cl.name + ".") + variant_2.compiledName) + " = function(", false);
          this.writeArgsDef(variant_2, ctx, wr);
          wr.out(") {", true);
        }
        wr.indent(1);
    ...
    if ( ctx.hasCompilerFlag("nodemodule") == false ) {
      for ( let i_7 = 0; i_7 < cl.static_methods.length; i_7++) {
        ...
        if ( variant_3.nameNode.hasFlag("main") && (variant_3.nameNode.code.filename == ctx.getRootFile()) ) {
          ...
          theEnd_1.newline();
          theEnd_1.out("function __js_main() {", true);
          theEnd_1.indent(1);
          this.WalkNode(variant_3.fnBody, ctx, theEnd_1);
          theEnd_1.newline();
          theEnd_1.indent(-1);
          theEnd_1.out("}", true);
  ...
  writeNpmPackage (node, ctx, orig_wr) {
...
class RangerActiveOperators  {
  ...
  initializeOpCache () {
    operatorsOf.forEach_3(this.opHash, ((item, index) => { 
      item.list.length = 0;
    }));
...
class LiveCompiler  {
  ...
  CreateCallExpression (node, ctx, wr) {
    this.langWriter.CreateCallExpression(node, ctx, wr);
  };
  CreateLambda (node, ctx, wr) {
  ...
  installFile (filename, ctx, wr) {
    ...
    if ( require("fs").existsSync(((__dirname) + "/") + "/" + filename ) ) {
      const fileData = (require('fs').readFileSync( ((__dirname) + "/") + '/' + filename , 'utf8'));
  ...
  WalkNode (node, ctx, wr) {
    ...
    if ( node.isFirstVref("property") ) {
      this.langWriter.CreatePropertyGet(node, ctx, wr);
      return;
    }
    if ( node.is_plugin ) {
      return;
    ...
    if ( node.is_array_literal ) {
      this.langWriter.writeArrayLiteral(node, ctx, wr);
      return;
    }
    if ( ((node.value_type == 11) || (node.value_type == 7)) || (node.value_type == 6) ) {
      this.WriteVRef(node, ctx, wr);
    ...
    if ( (node.children.length) > 0 ) {
      ...
      if ( node.is_direct_method_call ) {
        this.langWriter.CreateMethodCall(node, ctx, wr);
        return;
      }
      if ( node.has_lambda ) {
      ...
      switch (cmdE.vref ) { 
        ...
        case "goset" : 
          ...
          if ( (node.children.length) > idx_9 ) {
            ...
            ctx.setInExpr();
            this.langWriter.WriteSetterVRef(arg_9, ctx, wr);
            ctx.unsetInExpr();
          }
          break;
        case "pe" : 
          ...
          if ( (node.children.length) >= idx_16 ) {
            ...
            while (i_2 < (node.children.length)) {
              if ( i_2 >= idx_16 ) {
                ...
                this.walkCommandList(cmdToRepeat_1, node, ctx, wr);
        ...
        case "rawtype" : 
          ...
          if ( (node.children.length) > idx_23 ) {
            ...
            if ( arg_21.hasParamDesc ) {
              this.langWriter.writeRawTypeDef(arg_21.paramDesc.nameNode, ctx, wr);
            } else {
              this.langWriter.writeRawTypeDef(arg_21, ctx, wr);
            }
          }
          break;
        case "macro" : 
          ...
          if ( (( typeof(p_write_1.compiledTags[p_str] ) != "undefined" && p_write_1.compiledTags.hasOwnProperty(p_str) )) == false ) {
            ...
            this.walkCommandList(cmdArg, node, mCtx, p_write_1);
          }
          break;
        case "install_file" : 
        ...
        case "typeof" : 
          ...
          if ( (node.children.length) >= idx_24 ) {
            ...
            if ( arg_22.hasParamDesc ) {
              this.writeTypeDef(arg_22.paramDesc.nameNode, ctx, wr);
            } else {
              this.writeTypeDef(arg_22, ctx, wr);
            }
          }
          break;
        case "imp" : 
...
class RangerDocGenerator  {
    ...
    switch (item.value_type ) { 
      ...
      case 17 : 
        ...
        try {
          ...
          this.writeTypeDef(rv, ctx, wr);
          wr.out(" (", false);
          args.children.forEach(((item, index) => { 
            if ( index > 0 ) {
              wr.out(", ", false);
            }
  ...
  createClassDoc (node, ctx, orig_wr) {
    if ( ctx.hasCompilerSetting("classdoc") ) {
      ...
      operatorsOf.forEach_15(root.definedClasses, ((item, index) => { 
        ...
        const theClass = item;
        operatorsOf.forEach_19(item.method_variants, ((item, index) => { 
          item.variants.forEach(((item, index) => { 
            ...
            if ( typeof(item.nameNode) != "undefined" ) {
              if ( item.nameNode.type_name != "void" ) {
                wr.out("`", false);
                this.writeTypeDef(item.nameNode, ctx, wr);
                wr.out("` ", false);
              }
            }
  ...
  writeTypeDoc (list, tester, ctx, wr) {
    const www = wr.fork();
    wr.out("", true);
    wr.out("", true);
    ...
    list.forEach(((item, index) => { 
      if ( tester(item) ) {
        ...
        this.writeOpDesc(item.node, ctx, wr);
        cnt = cnt + 1;
      }
    }));
  };
  createOperatorDoc (node, ctx, orig_wr) {
    if ( ctx.hasCompilerSetting("operatordoc") ) {
      const wr = orig_wr.getFileWriter(".", ctx.getCompilerSetting("operatordoc"));
      const allOps = ctx.getAllOperators();
      let statements = allOps.filter(((item, index) => { 
      ...
      const lang_statements = allOps.filter(((item, index) => { 
        if ( (item.name.indexOf("if_")) == 0 ) {
          return true;
        }
        return false;
      }));
      statements = operatorsOf_12.groupBy_20(statements, ((item) => { 
        return item.name;
      }));
      const operator_list = allOps.filter(((item, index) => { 
      ...
      const nList = operatorsOf_12.groupBy_20(operator_list, ((item) => { 
        let key = item.name;
      ...
      this.writeTypeDoc(statements, ((item) => { 
        return true;
      }), ctx, wr);
      wr.out("", true);
      wr.out("## Language switches", true);
      this.writeTypeDoc(lang_statements, ((item) => { 
        return true;
      }), ctx, wr);
      wr.out("", true);
      wr.out("## Operators without arguments", true);
      this.writeTypeDoc(nList, ((item) => { 
...
class viewbuilder_Web  {
  ...
  CreateViews (ctx, wr) {
    ...
    wr.out("</head>", true);
    wr.out("<body>", true);
    operatorsOf.forEach_7(ctx.viewClassBody, ((item, index) => { 
...
class CompilerInterface  {
  ...
  getEnvVar (name) {
    const r_lib = process.env[name];
    /** unused:  let res = []   **/ 
    if ( typeof(r_lib) !== "undefined" ) {
      return r_lib;
    }
    return "";
  };
  ...
  searchLib (paths, libname) {
    for ( let i = 0; i < paths.length; i++) {
      var path = paths[i];
      if ( require("fs").existsSync(path + "/" + libname ) ) {
        return path;
      }
    };
    return "";
  ...
  run (params) {
    ...
    const platform = params.getParam("p");
    ...
    let the_lang = "es6";
    let the_target_dir = (process.cwd()) + "/bin";
    ...
    const theFilePaths = this.possiblePaths(this.getEnvVar("RANGER_LIB"));
    const theFilePath = this.searchLib(theFilePaths, the_file);
    if ( (require("fs").existsSync(theFilePath + "/" + the_file )) == false ) {
    ...
    if ( (require("fs").existsSync(langFilePath + "/" + the_lang_file )) == false ) {
    ...
    const c = (require('fs').readFileSync( theFilePath + '/' + the_file , 'utf8'));
    const code = new SourceCode(c);
    ...
    if ( typeof(outDir_2) !== "undefined" ) {
      the_target = outDir_2;
    }
    comp_attrs["o"] = the_target;
    const outDir_3 = params.getParam("d");
    if ( typeof(outDir_3) !== "undefined" ) {
    ...
    operatorsOf.forEach_21(params.flags, ((item, index) => { 
      const n = index;
      appCtx.compilerFlags[n] = true;
    }));
    operatorsOf.forEach_8(params.params, ((item, index) => { 
      const v = item;
      comp_attrs[index] = v;
    }));
    operatorsOf.forEach_8(comp_attrs, ((item, index) => { 
      const n_1 = item;
    ...
    console.time("Compile time in seconds ");
    try {
      flowParser.mergeImports(node, appCtx, wr);
      const lang_str = (require('fs').readFileSync( langFilePath + '/' + the_lang_file , 'utf8'));
      const lang_code = new SourceCode(lang_str);
      ...
      const ppList = appCtx.findPluginsFor("generate_ast");
      ppList.forEach(((item, index) => { 
        try {
          const plugin_1 = require( item );
          ( (new plugin_1.Plugin () )["generate_ast"] )( root, appCtx , wr );
        } catch(e) {
        }
      }));
      ...
      const ppList_1 = appCtx.findPluginsFor("pre_flow");
      ppList_1.forEach(((item, index) => { 
        try {
          const plugin_2 = require( item );
          ( (new plugin_2.Plugin () )["pre_flow"] )( root, appCtx , wr );
        } catch(e) {
        }
      }));
      appCtx.initOpList();
      ...
      if ( appCtx.hasCompilerFlag("showtypes") ) {
        console.log("--> checking if any node has typeClass");
        let cnt_1 = 0;
        let totalCnt = 0;
        /** unused:  const typeCnt = 0   **/ 
        node.forTree(((item, i) => { 
          totalCnt = totalCnt + 1;
          if ( typeof(item.evalTypeClass) !== "undefined" ) {
            if ( cnt_1 < 10 ) {
              console.log(((" -- type class " + item.evalTypeClass.name) + " at ") + item.getCode());
            }
            cnt_1 = cnt_1 + 1;
          }
        }));
        console.log((("TOTAL number of typed nodes : " + cnt_1) + " / ") + totalCnt);
        operatorsOf.forEach_22(appCtx.typeClasses, ((item, index) => { 
          console.log(" typeClass : " + index);
          if ( typeof(item.keyType) !== "undefined" ) {
            console.log("^ key type " + item.keyType.name);
          }
          if ( typeof(item.arrayType) !== "undefined" ) {
            console.log("^ array type " + item.arrayType.name);
          }
        }));
      }
      ...
      const ppList_2 = appCtx.findPluginsFor("preprocess");
      ppList_2.forEach(((item, index) => { 
        try {
          const plugin_3 = require( item );
          ( (new plugin_3.Plugin () )["preprocess"] )( root, appCtx , wr );
        } catch(e) {
        }
      }));
      if ( plugins_only ) {
        console.log("3. Plugins only enabled, ignoring the source code generation");
      } else {
        ...
        switch (appCtx.targetLangName ) { 
          case "java7" : 
            if ( ( typeof(comp_attrs["android_res_dir"] ) != "undefined" && comp_attrs.hasOwnProperty("android_res_dir") ) ) {
              ...
              operatorsOf.forEach_7(appCtx.viewClassBody, ((item, index) => { 
                builder.writeClass(item, appCtx, wr_2);
              }));
        ...
        for ( let i_4 = 0; i_4 < appCtx.definedClassList.length; i_4++) {
          ...
          lcc.WalkNode(cl.classNode, appCtx, wr);
        };
        if ( typeof(staticMethods) !== "undefined" ) {
          lcc.WalkNode(staticMethods.classNode, appCtx, wr);
        }
        ...
        const ppList_3 = appCtx.findPluginsFor("apps");
        ppList_3.forEach(((item, index) => { 
          try {
            const plugin_4 = require( item );
            ( (new plugin_4.Plugin () )["apps"] )( root, appCtx , wr );
          } catch(e) {
          }
        }));
        if ( ( typeof(params.flags["services"] ) != "undefined" && params.flags.hasOwnProperty("services") ) ) {
          lcc.langWriter.CreateServices(flowParser, appCtx, wr);
        }
        if ( ( typeof(params.flags["pages"] ) != "undefined" && params.flags.hasOwnProperty("pages") ) ) {
          lcc.langWriter.CreatePages(flowParser, appCtx, wr);
        }
        ...
        if ( appCtx.targetLangName == "es6" ) {
          if ( ( typeof(lcc.langWriter.compFlags["ReactNative"] ) != "undefined" && lcc.langWriter.compFlags.hasOwnProperty("ReactNative") ) ) {
        ...
        if ( appCtx.hasCompilerSetting("classdoc") ) {
          ...
          gen.createClassDoc(root, appCtx, wr);
        }
        if ( appCtx.hasCompilerSetting("operatordoc") ) {
          const gen_1 = new RangerDocGenerator();
          gen_1.createOperatorDoc(root, appCtx, wr);
        }
      }
      const ppList_4 = appCtx.findPluginsFor("postprocess");
      ppList_4.forEach(((item, index) => { 
        try {
          const plugin_5 = require( item );
          ( (new plugin_5.Plugin () )["postprocess"] )( root, appCtx , wr );
        } catch(e) {
        }
      }));
    ...
    console.timeEnd("Compile time in seconds ");
  };
}
...
operatorsOf.forEach_3 = function(__self, cb) {
  const list_1 = Object.keys(__self);
  for ( let i_1 = 0; i_1 < list_1.length; i_1++) {
    var kk_1 = list_1[i_1];
    const value_1 = (__self[kk_1]);
    cb(value_1, kk_1);
  };
};
operatorsOf.forEach_4 = function(__self, cb) {
  const list_2 = Object.keys(__self);
  for ( let i_2 = 0; i_2 < list_2.length; i_2++) {
    var kk_2 = list_2[i_2];
    const value_2 = (__self[kk_2]);
    cb(value_2, kk_2);
  };
};
operatorsOf.forEach_7 = function(__self, cb) {
  const list_3 = Object.keys(__self);
  for ( let i_3 = 0; i_3 < list_3.length; i_3++) {
    var kk_3 = list_3[i_3];
    const value_3 = (__self[kk_3]);
    cb(value_3, kk_3);
  };
};
operatorsOf.forEach_8 = function(__self, cb) {
  const list_4 = Object.keys(__self);
  for ( let i_4 = 0; i_4 < list_4.length; i_4++) {
    var kk_4 = list_4[i_4];
...
operatorsOf.forEach_15 = function(__self, cb) {
  ...
  for ( let i_7 = 0; i_7 < list_5.length; i_7++) {
    var kk_5 = list_5[i_7];
    const value_5 = (__self[kk_5]);
    cb(value_5, kk_5);
  };
};
operatorsOf.forEach_19 = function(__self, cb) {
  const list_6 = Object.keys(__self);
  for ( let i_8 = 0; i_8 < list_6.length; i_8++) {
    var kk_6 = list_6[i_8];
    const value_6 = (__self[kk_6]);
    cb(value_6, kk_6);
  };
};
operatorsOf.forEach_21 = function(__self, cb) {
  const list_7 = Object.keys(__self);
  for ( let i_10 = 0; i_10 < list_7.length; i_10++) {
    var kk_7 = list_7[i_10];
    const value_7 = (__self[kk_7]);
    cb(value_7, kk_7);
  };
};
operatorsOf.forEach_22 = function(__self, cb) {
  const list_8 = Object.keys(__self);
  for ( let i_11 = 0; i_11 < list_8.length; i_11++) {
    var kk_8 = list_8[i_11];
    const value_8 = (__self[kk_8]);
    cb(value_8, kk_8);
  };
};
class operatorsOfchar_5  {
  constructor() {
  }
}
operatorsOfchar_5.isc95notc95limiter_6 = function(c) {
  return (((((c > 32) && (c != (59))) && (c != (41))) && (c != (40))) && (c != (125))) && (c != (44));
};
class operatorsOfCodeNode_9  {
  constructor() {
  }
}
operatorsOfCodeNode_9.rc46funcdesc_10 = function(node, ctx) {
  const m = new RangerAppFunctionDesc();
  const cn = node.getSecond();
  m.name = cn.vref;
...
operatorsOf_9.rc46func_11 = function(node, ctx, wr) {
...
operatorsOf_12.map_13 = function(__self, cb) {
...
operatorsOf_12.map_14 = function(__self, cb) {
  /** unused:  const len_1 = __self.length   **/ 
  let res_1 = [];
  for ( let i_6 = 0; i_6 < __self.length; i_6++) {
    var it_1 = __self[i_6];
    res_1.push(cb(it_1, i_6));
  };
  return res_1;
};
operatorsOf_12.groupBy_20 = function(__self, cb) {
  let res_2 = [];
  let mapper = {};
...
class operatorsOfRangerAppWriterContext_16  {
  constructor() {
  }
}
operatorsOfRangerAppWriterContext_16.createc95var_17 = function(__self, name, type_name) {
  ...
  p.is_optional = false;
  __self.defineVariable(p.name, p);
  return p;
};
...
operatorsOf_16.createc95var_18 = function(__self, name, usingNode) {
  /** unused:  const fieldNode_1 = CodeNode.vref1(name)   **/ 
  const p_1 = new RangerAppParamDesc();
  p_1.name = name;
  p_1.value_type = usingNode.value_type;
  p_1.node = usingNode;
  p_1.nameNode = usingNode;
  p_1.is_optional = false;
  __self.defineVariable(p_1.name, p_1);
  return p_1;
};
class operatorsOfJSONArrayObject_23  {
  constructor() {
  }
}
operatorsOfJSONArrayObject_23.forEach_24 = function(__self, cb) {
  let cnt = __self.length;
  let i_12 = 0;
  while (cnt > 0) {
    const value_9 = __self[i_12];
    cb(value_9, i_12);
    cnt = cnt - 1;
    i_12 = i_12 + 1;
  };
...
operatorsOf_23.forEach_24 = function(__self, cb) {
  let cnt_1 = __self.length;
  let i_13 = 0;
  while (cnt_1 > 0) {
    const value_10 = __self[i_13];
    cb(value_10, i_13);
    cnt_1 = cnt_1 - 1;
    i_13 = i_13 + 1;
  };
