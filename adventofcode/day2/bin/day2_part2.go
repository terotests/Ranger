...
type day_two_part_two struct { 
}

func CreateNew_day_two_part_two() *day_two_part_two {
  me := new(day_two_part_two)
  return me;
}
func main() {
...
func operatorsOf_static_forEach_3(__self []int64, cb func(int64, int64) ()) () {
  var i_1 int64 = 0;  
