# WASM pluginit ja makrot ó visio

Kyll‰, itse asiassa **pluginit ja makrot ovat paljon kiinnostavampi k‰yttˆkohde WASM:lle kuin pelkk‰ "viel‰ yksi target"**.
...
Jos olisin rakentamassa Rangeria eteenp‰in, pit‰isin jopa mahdollisena ett‰ **ensimm‰inen WASM-k‰yttˆkohde ei olisi koodigenerointi vaan k‰‰nt‰j‰n laajennukset**:
...
* [PLAN_WASM_BACKEND.md](./PLAN_WASM_BACKEND.md) ‚Äî WASM/WAT-pipelinen nykytila
* [PLUGINS_REVIEW.md](./PLUGINS_REVIEW.md) ó nykyinen JavaScript-pohjainen plugin-arkkitehtuuri
* [ai/ADDING_NEW_LANGUAGE.md](./ai/ADDING_NEW_LANGUAGE.md) ó backend-integraatio
* [compiler/ng_LowIR.rgr](./compiler/ng_LowIR.rgr) ó Low IR (mahdollinen plugin-rajapinta Phase 3:ssa)
