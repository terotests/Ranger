...
- The [not covered page](/Ranger/docs/reference/not-covered/) names the library
  ...
  That page also names class libraries such as `IsoDateLib.rgr` and
  `Shell.rgr`, which declare no operators.
...
The compiler resolves some method names in another place. A class can define
...
The list is the names that programs have hit. It is not a complete list of
reserved names.
