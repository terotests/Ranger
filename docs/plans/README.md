...
| Area | Files |
| --- | --- |
| Language | `PLAN_LANGUAGE_IMPROVEMENTS.md`, `SPEC_SEMANTICS.md`, `PLAN_OPERATORS.md`, `PLAN_METHOD_CHAINING.md`, `PLAN_TREE_LITERALS.md`, `PLAN_GENERICS.md`, `PLAN_STRING_INDEXING.md` |
