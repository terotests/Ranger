  ...
  return [
    ...
    ...(jsFallback.length > 0
      ? [
          ...
          "output file, and the compilation reports success. The operators below",
          "write JavaScript for the target next to them.",
          "",
          "This is a scan of the template text for a construct that only JavaScript",
          "accepts, such as `Math.` or `parseFloat(`. It finds the common ones and",
          "not each one, so the numbers are a lower limit.",
          "",
