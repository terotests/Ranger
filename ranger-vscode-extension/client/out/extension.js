...
function activate(context) {
    ...
    client = new node_1.LanguageClient("rangerLanguageServer", "Ranger Language Server", serverOptions, clientOptions);
    // Start the client. This will also launch the server
    client.start();
    // Log activation message
    vscode_1.window.showInformationMessage("Ranger Language Support activated!");
