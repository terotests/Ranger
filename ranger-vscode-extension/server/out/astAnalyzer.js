...
class ASTAnalyzer {
    ...
    getDefinedClasses() {
        ...
        const classNames = this.context.definedClassList || Object.keys(this.context.definedClasses);
     ...
     */
    getLocalVariablesAtOffset(offset) {
        const variables = [];
     ...
     */
    getExpressionBeforePosition(offset) {
     ...
     */
    getDocumentationForSymbol(symbolName) {
        // Check classes
        const classes = this.getDefinedClasses();
