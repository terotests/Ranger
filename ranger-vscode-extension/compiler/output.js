  ...
  try {
    ...
    if (typeof values !== "undefined" && values != null) {
      ...
      await operatorsOf.forEach_12(obj_keys, (item, index) => {
        const v =
          typeof theObjflags[item] === "undefined"
            ? undefined
            : theObjflags[item];
    ...
    const values_1 =
      dict["params"] instanceof Object ? dict["params"] : undefined;
    if (typeof values_1 !== "undefined" && values_1 != null) {
      ...
      await operatorsOf.forEach_12(obj_keys_1, (item, index) => {
        const v_1 =
          typeof theObjparams[item] != "string"
            ? undefined
            : theObjparams[item];
...
InputFSFolder.fromDictionary = async function (dict) {
  ...
  try {
    ...
    const v_2 =
      typeof dict["is_folder"] === "undefined" ? undefined : dict["is_folder"];
    if (typeof v_2 !== "undefined" && v_2 != null) {
      obj.is_folder = v_2;
    }
    const v_3 =
      typeof dict["base64bin"] === "undefined" ? undefined : dict["base64bin"];
    if (typeof v_3 !== "undefined" && v_3 != null) {
      obj.base64bin = v_3;
    }
    const values =
      dict["folders"] instanceof Array ? dict["folders"] : undefined;
    if (typeof values !== "undefined" && values != null) {
      const arr = values;
      await operatorsOf_57.forEach_58(arr, async (item, index) => {
        if (item instanceof Object) {
          /* union case */ var oo = item;
...
InputEnv.fromDictionary = async function (dict) {
  ...
  try {
    const v =
      typeof dict["use_real"] === "undefined" ? undefined : dict["use_real"];
    if (typeof v !== "undefined" && v != null) {
      obj.use_real = v;
    }
    const theValue =
      dict["filesystem"] instanceof Object ? dict["filesystem"] : undefined;
    if (typeof theValue !== "undefined" && theValue != null) {
      const newObj = await InputFSFolder.fromDictionary(theValue);
      obj.filesystem = newObj;
    }
    const values =
      dict["envVars"] instanceof Object ? dict["envVars"] : undefined;
    if (typeof values !== "undefined" && values != null) {
      const theObjenvVars = values;
      const obj_keys = Object.keys(theObjenvVars);
      await operatorsOf.forEach_12(obj_keys, (item, index) => {
        const v_1 =
          typeof theObjenvVars[item] != "string"
            ? undefined
            : theObjenvVars[item];
        if (typeof v_1 !== "undefined" && v_1 != null) {
    ...
    const theValue_1 =
      dict["commandLine"] instanceof Object ? dict["commandLine"] : undefined;
  ...
  addEvent(name, e) {
    if (
      (typeof this.events[name] != "undefined" &&
        this.events.hasOwnProperty(name)) == false
    ) {
...
class RangerAppParamDesc {
  ...
  isAllocatedType() {
    if (typeof this.nameNode !== "undefined" && this.nameNode != null) {
      if (this.nameNode.eval_type != 0) {
        ...
        if (
          this.nameNode.eval_type == 15 ||
          this.nameNode.eval_type == 14 ||
          this.nameNode.eval_type == 4 ||
          this.nameNode.eval_type == 2 ||
          this.nameNode.eval_type == 5 ||
          this.nameNode.eval_type == 3
        ) {
          return false;
        }
  ...
  moveRefTo(nodeToMove, target, ctx) {
    const b_disable_errors = ctx.hasCompilerFlag("refcnt") == false;
        ...
        if (my_s == 0) {
          if (tmp_var == false) {
            if (false == b_disable_errors) {
              ctx.addError(
                nodeToMove,
                "Can not move a weak reference to a strong target."
              );
          ...
          if (false == b_disable_errors) {
            ctx.addError(
              nodeToMove,
              "Can not move immutable reference to a strong target, evald type " +
                this.nameNode.eval_type_name
            );
          }
        }
      }
        ...
        if (my_lifetime < other_lifetime && this.return_cnt == 0) {
          if (this.nameNode.hasFlag("returnvalue") == false) {
            if (false == b_disable_errors) {
              ctx.addError(
                nodeToMove,
                "Can not create a weak reference if target has longer lifetime than original, current lifetime == " +
                  my_lifetime
              );
            }
          }
...
class RangerAppClassDesc extends RangerAppParamDesc {
  ...
  isNormalClass() {
    const special =
      this.is_operator_class ||
      this.is_trait ||
      this.is_system ||
      this.is_generic_instance ||
  ...
  hasOwnMethod(m_name) {
    if (
      typeof this.defined_methods[m_name] != "undefined" &&
      this.defined_methods.hasOwnProperty(m_name)
    ) {
      return true;
    }
    return false;
  ...
  hasStaticMethod(m_name) {
    return (
      typeof this.defined_static_methods[m_name] != "undefined" &&
      this.defined_static_methods.hasOwnProperty(m_name)
    );
  }
...
class CodeNodeLiteral {
  ...
  toDictionary() {
    ...
    try {
      ...
      if (
        typeof this.expression_value !== "undefined" &&
        this.expression_value != null
      ) {
...
CodeNodeLiteral.fromDictionary = async function (dict) {
  ...
  try {
    const v =
      typeof dict["expression"] === "undefined"
        ? undefined
        : dict["expression"];
    if (typeof v !== "undefined" && v != null) {
      obj.expression = v;
    ...
    const v_2 =
      typeof dict["is_block_node"] === "undefined"
        ? undefined
        : dict["is_block_node"];
    if (typeof v_2 !== "undefined" && v_2 != null) {
    ...
    const v_3 =
      typeof dict["type_name"] != "string" ? undefined : dict["type_name"];
    if (typeof v_3 !== "undefined" && v_3 != null) {
      obj.type_name = v_3;
    }
    const v_4 =
      typeof dict["key_type"] != "string" ? undefined : dict["key_type"];
    if (typeof v_4 !== "undefined" && v_4 != null) {
      obj.key_type = v_4;
    }
    const v_5 =
      typeof dict["array_type"] != "string" ? undefined : dict["array_type"];
    ...
    const v_6 =
      typeof dict["has_vref_annotation"] === "undefined"
        ? undefined
        : dict["has_vref_annotation"];
    if (typeof v_6 !== "undefined" && v_6 != null) {
      obj.has_vref_annotation = v_6;
    }
    const theValue =
      dict["vref_annotation"] instanceof Object
        ? dict["vref_annotation"]
        : undefined;
    if (typeof theValue !== "undefined" && theValue != null) {
    ...
    const v_7 =
      typeof dict["has_type_annotation"] === "undefined"
        ? undefined
        : dict["has_type_annotation"];
    if (typeof v_7 !== "undefined" && v_7 != null) {
      obj.has_type_annotation = v_7;
    }
    const theValue_1 =
      dict["type_annotation"] instanceof Object
    ...
    const v_8 = isNaN(parseFloat(dict["double_value"]))
      ? undefined
      : parseFloat(dict["double_value"]);
    if (typeof v_8 !== "undefined" && v_8 != null) {
      obj.double_value = v_8;
    }
    const v_9 =
      typeof dict["string_value"] != "string"
        ? undefined
        : dict["string_value"];
    if (typeof v_9 !== "undefined" && v_9 != null) {
      obj.string_value = v_9;
    }
    const v_10 = isNaN(parseInt(dict["int_value"]))
      ? undefined
      : parseInt(dict["int_value"]);
    if (typeof v_10 !== "undefined" && v_10 != null) {
      obj.int_value = v_10;
    }
    const v_11 =
      typeof dict["boolean_value"] === "undefined"
        ? undefined
        : dict["boolean_value"];
    ...
    const theValue_2 =
      dict["expression_value"] instanceof Object
        ? dict["expression_value"]
        : undefined;
    ...
    const values_2 =
      dict["prop_keys"] instanceof Array ? dict["prop_keys"] : undefined;
    if (typeof values_2 !== "undefined" && values_2 != null) {
      const arr_1 = values_2;
      await operatorsOf_57.forEach_58(arr_1, (item, index) => {
        if (typeof item === "string") {
          /* union case for string */ var oo_1 = item;
          obj.prop_keys.push(oo_1);
        }
      });
    }
    const values_3 =
      dict["comments"] instanceof Array ? dict["comments"] : undefined;
    if (typeof values_3 !== "undefined" && values_3 != null) {
      const arr_2 = values_3;
      await operatorsOf_57.forEach_58(arr_2, async (item, index) => {
        if (item instanceof Object) {
          /* union case */ var oo_2 = item;
...
class CodeNode {
  ...
  writeCode(wr) {
    switch (this.value_type) {
      ...
      case 4:
        wr.out(
          String.fromCharCode(34) + this.string_value + String.fromCharCode(34),
          false
        );
        break;
      case 3:
  ...
  inferDefExpressionTypeFromValue(node) {
    ...
    if (
      typeof cn.expression_value !== "undefined" &&
      cn.expression_value != null
    ) {
      cn.value_type = 17;
      cn.parsed_type = 17;
    ...
    if (nodeValue.eval_type == 17) {
      if (
        typeof nodeValue.expression_value !== "undefined" &&
        nodeValue.expression_value != null
      ) {
  ...
  cloneWithType(match, changeVref) {
    const newNode = new CodeNode(this.code, this.sp, this.ep);
    if (
      typeof match.nodes[this.vref] != "undefined" &&
      match.nodes.hasOwnProperty(this.vref)
    ) {
    ...
    newNode.register_expressions = operatorsOf.clone_46(
      this.register_expressions
    );
    ...
    switch (this.value_type) {
      ...
      case 17:
        if (
          ...
          newNode.expression_value = this.expression_value.cloneWithType(
            match,
            changeVref
          );
        }
    ...
    switch (this.value_type) {
      ...
      case 17:
        if (
          ...
          newNode.expression_value = this.expression_value.rebuildWithType(
            match,
            changeVref
          );
        }
  ...
  buildTypeSignature() {
    ...
    if (this.value_type == 17) {
      ...
      s =
        ...
        " (" +
        operatorsOf
          .map_47(argNode.children, (item, index) => {
  ...
  copyEvalResFrom(node) {
    ...
    if (
      typeof node.evalTypeClass !== "undefined" &&
      node.evalTypeClass != null
    ) {
    ...
    if (
      typeof node.operator_node !== "undefined" &&
      node.operator_node != null
    ) {
  ...
  ifNoTypeSetToVoid() {
    if (
      this.type_name.length == 0 &&
      this.key_type.length == 0 &&
      this.array_type.length == 0
    ) {
      this.type_name = "void";
    }
  }
...
class RangerAppWriterContext {
  ...
  addOpFn(name, code) {
    if (
      false ==
      (typeof this.opFnsList[name] != "undefined" &&
        this.opFnsList.hasOwnProperty(name))
    ) {
  ...
  isPluginOp(node) {
    if (node.children.length > 0) {
      ...
      if (fc.ns.length > 0) {
        ...
        const root = this.getRoot();
        if (
          typeof root.pluginSpecificOperators[firstNS] != "undefined" &&
          root.pluginSpecificOperators.hasOwnProperty(firstNS)
        ) {
  ...
  addTypeClass(name) {
    ...
    if (
      false ==
      (typeof root.typeClasses[name] != "undefined" &&
        root.typeClasses.hasOwnProperty(name))
    ) {
  ...
  addTypedNode(name, op) {
    const root = this.getRoot();
    if (
      typeof root.typedNodes[name] != "undefined" &&
      root.typedNodes.hasOwnProperty(name)
    ) {
  ...
  addPluginNode(name, op) {
    const root = this.getRoot();
    if (
      typeof root.pluginNodes[name] != "undefined" &&
      root.pluginNodes.hasOwnProperty(name)
    ) {
  ...
  addOperator(op) {
    ...
    if (op.name.length > 0) {
      if (
        typeof root.op_list[op.name] != "undefined" &&
        root.op_list.hasOwnProperty(op.name)
      ) {
  ...
  getViewClass(s_name) {
    let res;
    if (
      typeof this.viewClassBody[s_name] != "undefined" &&
      this.viewClassBody.hasOwnProperty(s_name)
    ) {
  ...
  async writeContextVars(wr) {
    await operatorsOf_13.forEach_20(
      this.localVariables,
      async (item, index) => {
  ...
  async getOperators(name) {
    ...
    if (typeof root.operators !== "undefined" && root.operators != null) {
      ...
      while (typeof cc_2 !== "undefined" && cc_2 != null) {
        if (
          typeof cc_2.operatorFunction !== "undefined" &&
          cc_2.operatorFunction != null
        ) {
  ...
  isLocalToCapture(name) {
    if (
      typeof this.localVariables[name] != "undefined" &&
      this.localVariables.hasOwnProperty(name)
    ) {
      return true;
    }
    if (this.is_capturing) {
  ...
  transformWord(input_word) {
    ...
    if (
      typeof this.refTransform[input_word] != "undefined" &&
      this.refTransform.hasOwnProperty(input_word)
    ) {
  ...
  initReservedWords() {
    if (
      typeof this.reservedWords !== "undefined" &&
  ...
  transformTypeName(typeName) {
    ...
    if (this.isDefinedClass(typeName)) {
      ...
      if (cl.is_system) {
        return cl.systemNames[
          operatorsOfRangerAppWriterContext_21.getTargetLang_22(this)
        ];
      }
    }
    return typeName;
  ...
  hadValidType(node) {
    ...
    if (node.value_type == 6) {
      if (this.isDefinedType(node.array_type)) {
        ...
        this.addError(
          node,
          "Unknown type for array values: " + node.array_type
        );
        return false;
      }
    }
    if (node.value_type == 7) {
      if (
        this.isDefinedType(node.array_type) &&
        this.isPrimitiveType(node.key_type)
      ) {
        return true;
      } else {
        if (this.isDefinedType(node.array_type) == false) {
          this.addError(
            node,
            "Unknown type for map values: " + node.array_type
          );
        }
    ...
    if (this.isDefinedType(node.type_name)) {
      ...
      if (node.value_type == 17) {
        ...
        this.addError(
          node,
          "Unknown type: " + node.type_name + " type ID : " + node.value_type
        );
      }
    }
    return false;
  ...
  async findOperatorsWithName(name) {
    let res = [];
    await operatorsOf.forEach_15(
      this.getStdCommands().children,
      (item, index) => {
  ...
  createSignature(origClass, classSig) {
    if (
      typeof this.classSignatures[classSig] != "undefined" &&
      this.classSignatures.hasOwnProperty(classSig)
    ) {
    ...
    while (
      typeof this.classToSignature[sigName] != "undefined" &&
      this.classToSignature.hasOwnProperty(sigName)
    ) {
      ii = ii + 1;
  ...
  async createTraitInstanceClass(
    traitName,
    instanceName,
    initParams,
    flowParser,
    ...
    if (t_2.extends_classes.length > 0) {
      ctx.addError(
        ...
        "Can not join trait " +
          name +
          " because it is inherited. Currently on base classes can be used as traits."
      );
      return res;
    }
    if (t_2.has_constructor) {
      ctx.addError(
        traitClassDef,
        "Can not join trait " + name + " because it has a constructor function"
      );
    } else {
  ...
  hasTemplateNode(name) {
    const root = this.getRoot();
    return (
      typeof root.templateClassNodes[name] != "undefined" &&
      root.templateClassNodes.hasOwnProperty(name)
    );
  }
  ...
  isEnumDefined(n) {
    if (
      typeof this.definedEnums[n] != "undefined" &&
      this.definedEnums.hasOwnProperty(n)
    ) {
      return true;
    }
    if (typeof this.parent === "undefined") {
  ...
  getFlag(name) {
    if (
      typeof this.contextFlags[name] != "undefined" &&
      this.contextFlags.hasOwnProperty(name)
    ) {
  ...
  hasSetting(name) {
    if (
      ...
      this.settings.hasOwnProperty(name)
    ) {
      return true;
    }
    if (typeof this.parent !== "undefined" && this.parent != null) {
  ...
  hasCompilerFlag(s_name) {
    if (
      typeof this.compilerFlags[s_name] != "undefined" &&
      this.compilerFlags.hasOwnProperty(s_name)
    ) {
  ...
  getCompilerSetting(s_name) {
    if (
      typeof this.compilerSettings[s_name] != "undefined" &&
      this.compilerSettings.hasOwnProperty(s_name)
    ) {
  ...
  getFnVarCnt(name) {
    ...
    let ii = 0;
    if (
      typeof fnCtx.defCounts[name] != "undefined" &&
      fnCtx.defCounts.hasOwnProperty(name)
    ) {
  ...
  defineVariable(name, desc) {
    ...
    if (
      false == (desc.varType == 8 || desc.varType == 4 || desc.varType == 10)
    ) {
  ...
  isDefinedClass(name) {
    if (
      typeof this.definedClasses[name] != "undefined" &&
      this.definedClasses.hasOwnProperty(name)
    ) {
      return true;
    } else {
      if (typeof this.parent !== "undefined" && this.parent != null) {
  ...
  addClass(name, desc) {
    const root = this.getRoot();
    if (
      typeof root.definedClasses[name] != "undefined" &&
      root.definedClasses.hasOwnProperty(name)
    ) {
    } else {
  ...
  getCurrentMethod() {
    if (
      typeof this.currentMethod !== "undefined" &&
  ...
  hasCurrentClass() {
    if (
      this.in_class &&
      typeof this.currentClass !== "undefined" &&
  ...
  addImport(import_name) {
    if (
      ...
      (typeof this.import_list[import_name] != "undefined" &&
        this.import_list.hasOwnProperty(import_name))
    ) {
...
class CodeWriter {
  ...
  getImports() {
    let p = this;
    while (
      typeof p.ownerFile === "undefined" &&
      typeof p.parent !== "undefined" &&
      p.parent != null
    ) {
      p = p.parent;
    }
  ...
  getTag(name) {
    if (
      typeof this.tags[name] != "undefined" &&
      this.tags.hasOwnProperty(name)
    ) {
  ...
  line_end(str) {
    if (this.currentLine.length > 0) {
      if (
        str.charCodeAt(0) !=
        this.currentLine.charCodeAt(this.currentLine.length - 1)
      ) {
        this.out(str, false);
      }
    }
    ...
    while (this.i < this.__len) {
      ...
      if (this.i < this.__len) {
        ...
        if (false == disable_ops_set && c == 58) {
          ...
          while (
            this.i < this.__len &&
            operatorsOfchar_23.isc95notc95limiter_24(c)
          ) {
            this.i = 1 + this.i;
            c = s.charCodeAt(this.i);
            if (c == 64) {
          ...
          if (this.i < this.__len && ep > sp) {
            ...
            const op_pred = this.getOperatorPred(
              new_vref_node.vref,
              disable_ops_set
            );
            ...
            if (
              (op_pred > 0 && this.curr_node.infix_operator) ||
              (op_pred > 0 && this.curr_node.children.length >= 2)
            ) {
              if (op_pred == 3 && 2 == this.curr_node.children.length) {
                ...
                if (to_right) {
                  ...
                  const last_value = ifNode.children
                    .splice(until_index - 1, 1)
                    .pop();
...
class RangerArgMatch {
  ...
  matchArguments(args, callArgs, ctx, firstArgIndex) {
    ...
    for (let i = 0; i < callArgs.children.length; i++) {
      ...
      if (arg.value_type != 7 && arg.value_type != 6) {
        if (
          typeof callArg.paramDesc !== "undefined" &&
          callArg.paramDesc != null
        ) {
          if (
            typeof callArg.paramDesc.nameNode !== "undefined" &&
            callArg.paramDesc.nameNode != null &&
            typeof callArg.paramDesc.nameNode.expression_value !==
              "undefined" &&
            callArg.paramDesc.nameNode.expression_value != null
          ) {
            this.matched[arg.type_name] = "";
            this.matchedLambdas[arg.type_name] =
              callArg.paramDesc.nameNode.expression_value;
            continue;
          }
        }
      ...
      if (arg.value_type == 6) {
        if (
          false == this.add_atype(arg.array_type, callArg.eval_array_type, ctx)
        ) {
          all_matched = false;
        }
      }
      ...
      if (this.doesMatch(arg, callArg, ctx)) {
        ...
        missed_args.push(
          "matching arg " + arg.vref + " faileg against " + callArg.vref
        );
      }
      if (false == did_match) {
        all_matched = false;
  ...
  add(tplKeyword, typeName, ctx) {
    ...
    if (
      typeof this.matched[tplKeyword] != "undefined" &&
      this.matched.hasOwnProperty(tplKeyword)
    ) {
  ...
  doesDefsMatch(arg, node, ctx) {
    ...
    if (arg.value_type == 6 && node.eval_type == 6) {
      const same_arrays = this.areEqualTypes(
        arg.array_type,
        node.array_type,
        ctx
      );
    ...
    if (arg.value_type == 7 && node.eval_type == 7) {
      const same_arrays_1 = this.areEqualTypes(
        arg.array_type,
        node.array_type,
        ctx
      );
  ...
  doesMatch(arg, node, ctx) {
    ...
    if (arg.value_type == 7 && node.eval_type == 7) {
      ...
      const same_keys = this.areEqualTypes(
        arg.key_type,
        node.eval_key_type,
        ctx
      );
  ...
  areEqualTypes(type1, type2, ctx) {
    let t_name = type1;
    if (
      typeof this.matched[type1] != "undefined" &&
      this.matched.hasOwnProperty(type1)
    ) {
    ...
    if (ctx.isDefinedClass(t_name) && ctx.isDefinedClass(type2)) {
      ...
      if (typeof trait1 !== "undefined" && trait1 != null) {
        ...
        if (
          typeof c1.trait_params[type2] != "undefined" &&
          c1.trait_params.hasOwnProperty(type2)
        ) {
      ...
      if (typeof trait1_1 !== "undefined" && trait1_1 != null) {
        ...
        if (
          typeof c2.trait_params[t_name] != "undefined" &&
          c2.trait_params.hasOwnProperty(t_name)
        ) {
  ...
  getTypeName(n) {
    let t_name = n;
    if (
      typeof this.matched[t_name] != "undefined" &&
      this.matched.hasOwnProperty(t_name)
    ) {
  ...
  setRvBasedOn(arg, node) {
    ...
    if (arg.value_type != 7 && arg.value_type != 6) {
      if (
        typeof this.matchedLambdas[arg.type_name] != "undefined" &&
        this.matchedLambdas.hasOwnProperty(arg.type_name)
      ) {
...
class DictNode {
  ...
  EncodeString(orig_str) {
    ...
    while (ii < cb_len) {
      ...
      switch (cc) {
        case 8:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(98);
          break;
        case 9:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(116);
          break;
        case 10:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(110);
          break;
        case 12:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(102);
          break;
        case 13:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(114);
          break;
        case 34:
          encoded_str = encoded_str + String.fromCharCode(92) + '"';
          break;
        case 92:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(92);
          break;
        case 47:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(47);
          break;
        default:
  ...
  getString(key) {
    let res;
    if (
      typeof this.objects[key] != "undefined" &&
      this.objects.hasOwnProperty(key)
    ) {
    ...
    if (this.is_property) {
      ...
      if (this.value_type == 3) {
        return (
          ...
          ":" +
          '"' +
          this.EncodeString(this.string_value) +
          '"'
        );
      }
    } else {
...
class RangerSerializeClass {
  ...
  createWRWriter(pvar, nn, ctx, wr) {
    ...
    if (nn.value_type == 6) {
      if (this.isSerializedClass(nn.array_type, ctx)) {
        wr.out(
          'def values:DictNode (obj_keys.addArray("' +
            pvar.compiledName +
            '"))',
          true
        );
        wr.out(
          "for this." + pvar.compiledName + " item:" + nn.array_type + " i {",
          true
        );
        wr.indent(1);
    ...
    if (nn.value_type == 7) {
      if (this.isSerializedClass(nn.array_type, ctx)) {
        wr.out(
          'def values:DictNode (obj_keys.addObject("' +
            pvar.compiledName +
            '"))',
          true
        );
        ...
        wr.indent(1);
        wr.out(
          "def item:DictNode (unwrap (get this." +
            pvar.compiledName +
            " keyname))",
          true
        );
      ...
      if (nn.key_type == "string") {
        ...
        if (nn.array_type == "string") {
          wr.out(
            "values.addString(keyname (unwrap (get this." +
              pvar.compiledName +
              " keyname)))",
            true
          );
        ...
        if (nn.array_type == "int") {
          wr.out(
            "values.addInt(keyname (unwrap (get this." +
              pvar.compiledName +
              " keyname)))",
            true
          );
        ...
        if (nn.array_type == "boolean") {
          wr.out(
            "values.addBoolean(keyname (unwrap (get this." +
              pvar.compiledName +
              " keyname)))",
            true
          );
        ...
        if (nn.array_type == "double") {
          wr.out(
            "values.addDouble(keyname (unwrap (get this." +
              pvar.compiledName +
              " keyname)))",
            true
          );
  ...
  createJSONSerializerFn(cl, ctx, wr) {
    ...
    wr.indent(1);
    wr.out(
      "fn unserializeFromDict@(strong):" + cl.name + " (dict:DictNode) {",
      true
    );
    wr.indent(1);
    ...
    for (let i_2 = 0; i_2 < cl.variables.length; i_2++) {
      ...
      if (
        typeof declaredVariable[pvar_1.name] != "undefined" &&
        declaredVariable.hasOwnProperty(pvar_1.name)
      ) {
        continue;
      }
  ...
  createWRWriter2(pvar, nn, ctx, wr) {
    ...
    if (nn.value_type == 7) {
      if (this.isSerializedClass(nn.array_type, ctx)) {
        ...
        wr.indent(1);
        wr.out(
          "def item (unwrap (get this." + pvar.compiledName + " keyname))",
          true
        );
        if (ctx.isDefinedClass(nn.array_type)) {
          wr.out("def obj@(lives):JSONDataObject (item.toDictionary())", true);
    ...
    if (nn.hasFlag("optional")) {
      ...
      if (ctx.isDefinedClass(nn.type_name) == false) {
        wr.out(
          'set res  "' + pvar.name + '" (this.' + pvar.compiledName + ") ",
          true
        );
      } else {
        wr.out(
  ...
  createWRReader2(pvar, nn, ctx, wr) {
    if (nn.value_type == 6) {
      if (this.isSerializedClass(nn.array_type, ctx)) {
        wr.out(
          'def values:JSONArrayObject (getArray dict "' + pvar.name + '")',
          true
        );
    ...
    if (nn.value_type == 7) {
      if (this.isSerializedClass(nn.array_type, ctx)) {
        ...
        if (ctx.isDefinedClass(nn.array_type)) {
          wr.out(
            "def theValue (getObject theObj" + pvar.name + " item ) ",
            true
          );
          ...
          wr.out(
            "def newObj@(lives) (" +
              nn.array_type +
              ".fromDictionary((unwrap theValue)))",
            true
          );
  ...
  createJSONSerializerFn2(cl, ctx, wr) {
    ...
    wr.indent(1);
    wr.out(
      "static fn fromDictionary@(strong):" +
        cl.name +
        " (dict:JSONDataObject) {",
      true
    );
    ...
    for (let i = 0; i < cl.variables.length; i++) {
      ...
      if (
        typeof declaredVariable[pvar.name] != "undefined" &&
        declaredVariable.hasOwnProperty(pvar.name)
      ) {
        continue;
      }
      const nn = pvar.nameNode;
    ...
    for (let i_3 = 0; i_3 < cl.variables.length; i_3++) {
      ...
      if (
        typeof declaredVariable[pvar_2.name] != "undefined" &&
        declaredVariable.hasOwnProperty(pvar_2.name)
      ) {
        continue;
      }
    ...
    for (let i_2 = 0; i_2 < cl.variables.length; i_2++) {
      ...
      if (true) {
        ...
        for (let ii_1 = 0; ii_1 < cl.variables.length; ii_1++) {
          ...
          if (ivar_1 == pvar_1) {
            wr.out(
              "res." + pvar_1.compiledName + " = new_value_of_" + pvar_1.name,
              true
            );
          }
        }
...
class RangerFlowParser {
          ...
          if (name.length > 0 && name.charCodeAt(0) == ".".charCodeAt(0)) {
            ...
            if (i > 0) {
              ...
              if (is_chaining == false) {
                ...
                is_chaining = true;
                if (
                  typeof last_line.chainTarget !== "undefined" &&
                  last_line.chainTarget != null
                ) {
  ...
  async WalkNode(node, ctx, wr) {
    ...
    if (node.register_name.length > 0) {
      if (ctx.isVarDefined(node.register_name)) {
        ...
        if (
          typeof regInfo.nameNode !== "undefined" &&
          regInfo.nameNode != null
        ) {
    ...
    if (node.value_type == 19) {
      ...
      if (fc.value_type == 19) {
        ...
        const opTpl = CodeNode.fromList([
          CodeNode.vref1("defn"),
          CodeNode.vref1("tmp_create"),
        ...
        walk_xml = async (xmlNode, regName) => {
          ...
          if (rootClassDef.is_system) {
            opBody.children.push(
              CodeNode.fromList([
                CodeNode.vref1("def"),
                CodeNode.vref1(regName),
                CodeNode.fromList([
                  CodeNode.vref1("create"),
                  CodeNode.vref1(xmlNode.vref),
                ]),
              ])
            );
              ...
              if (item.string_value.length > 0) {
                opBody.children.push(
                  CodeNode.fromList([
                    ...
                    CodeNode.vref1(regName),
                    CodeNode.vref1(item.vref),
                    CodeNode.newStr(item.string_value),
                  ])
                );
              }
            });
                ...
                if (item.value_type != 19) {
                  if (item.expression) {
                    ...
                    if (ctx.hasClass(itemCopy.eval_array_type)) {
                      ...
                      opBody.children.push(
                        CodeNode.fromList([
                          CodeNode.vref1("forEach"),
                          theNode.copy(),
                          CodeNode.blockFromList([
                            CodeNode.fromList([
                              CodeNode.vref1("def"),
                              t,
                              CodeNode.vref1("item"),
            ...
            await operatorsOf.forEach_15(xmlNode.attrs, (item, index) => {
              if (item.children.length > 0) {
                ...
                opBody.children.push(
                  CodeNode.fromList([
                    CodeNode.vref1("="),
                    CodeNode.vref1(regName + "." + item.vref),
                    fc_2.copy(),
                  ])
                );
                return;
              ...
              if (item.parsed_type == 3) {
                opBody.children.push(
                  CodeNode.fromList([
                    CodeNode.vref1("="),
                    CodeNode.vref1(regName + "." + item.vref),
                    CodeNode.newInt(item.int_value),
                  ])
                );
              }
            });
                ...
                if (item.value_type != 19) {
                  if (item.expression) {
                    ...
                    if (ctx.hasClass(itemCopy_1.eval_array_type)) {
                      ...
                      operatorsOf.forEach_11(
                        rootClassDef.variables,
                        (item, index) => {
                          if (
                            match.areEqualATypes(
                              item.nameNode.array_type,
                              itemCopy_1.eval_array_type,
                              ctx
                            )
                          ) {
                            ...
                            opBody.children.push(
                              CodeNode.fromList([
                                ...
                                CodeNode.blockFromList([
                                  ...
                                  CodeNode.fromList([
                                    CodeNode.vref1("push"),
                                    CodeNode.vref1(regName + "." + item.name),
                                    CodeNode.vref1("tmp"),
                                  ]),
                                ]),
                              ])
                      ...
                      console.log(
                        "could not find class" + itemCopy_1.eval_array_type
                      );
                    }
                  }
                }
        ...
        opBody.children.push(
          CodeNode.fromList([CodeNode.vref1("ret"), CodeNode.vref1("r1")])
        );
    ...
    if (node.children.length > 0) {
      ...
      switch (fc_5.vref) {
        case "page":
          ...
          break;
        case "def":
          await operatorsOfRangerFlowParser_26.EnterVarDef_27(
            this,
            node,
            ctx,
            wr
          ...
          try {
            ...
            node.appGUID =
              ...
              require("crypto")
                .createHash("sha256")
                .update(
                  rvClassDef.node.getCode() + paramClassDef_4.node.getCode()
                )
                .digest("hex");
          } catch (e) {
    ...
    if (node.children.length > 0) {
      ...
      if (fc_6.expression && node.children.length == 2) {
        ...
        if (sec.vref.length > 0 && sec.vref[0] == ".") {
          ...
          if (
            fc_6.eval_type_name.length > 0 &&
            ctx.isDefinedClass(fc_6.eval_type_name)
          ) {
            ...
            let calledItem = CodeNode.fromList([
              CodeNode.vref1("property"),
              fc_6.copy(),
              CodeNode.vref1(method_name),
            ]);
        ...
        if (sec_1.vref.length > 0 && sec_1.vref[0] == ".") {
          ...
          await operatorsOf.forEach_12(parts_1, (item, index) => {
            if (index < parts_1.length - 1) {
              try {
                calledItem_1 = CodeNode.fromList([
                  CodeNode.vref1("property"),
                  calledItem_1.copy(),
                  CodeNode.vref1(item),
                ]);
          ...
          const calledItem_2 = CodeNode.fromList([
            CodeNode.vref1("call"),
            calledItem_1,
            CodeNode.vref1(method_name_1),
            third.copy(),
          ]);
    ...
    if (node.expression) {
      for (let i = 0; i < node.children.length; i++) {
        ...
        if (i == 0 && node.children.length == 2) {
          if (
            item.eval_type == 28 &&
            typeof item.paramDesc !== "undefined" &&
            item.paramDesc != null
          ) {
        ...
        if (
          (typeof item.expression_value !== "undefined" &&
            item.expression_value != null) ||
          item.value_type == 17 ||
          item.eval_type == 17
        ) {
          if (i == 0 && node.children.length == 2) {
  ...
  getVoidNameSignature() {
    const s = "void";
    if (
      typeof this.isDefinedSignature[s] != "undefined" &&
      this.isDefinedSignature.hasOwnProperty(s)
    ) {
  ...
  getArgsSignature(node) {
    ...
    if (
      typeof this.isDefinedArgSignature[exp_s] != "undefined" &&
      this.isDefinedArgSignature.hasOwnProperty(exp_s)
    ) {
  ...
  async WriteVRef(node, ctx, wr) {
    ...
    if (ctx.isEnumDefined(rootObjName)) {
      ...
      const e = ee;
      if (
        typeof e.values[enumName] != "undefined" &&
        e.values.hasOwnProperty(enumName)
      ) {
        node.eval_type = 13;
    ...
    if (rootObjName == "this" || ctx.isVarDefined(rootObjName)) {
      ...
      if (false == class_or_this) {
        ...
        if (
          ...
          node.vref == "fun" ||
          node.vref == "fn" ||
          node.hasFlag("keyword")
        ) {
        } else {
          ctx.addError(
            node,
            "WriteVREF -> Undefined variable " +
              node.vref +
              " in class " +
              desc.name +
              " node : " +
  ...
  async EnterFn(node, ctx, wr, callback) {
    try {
      ...
      if (typeof currClass === "undefined") {
        ctx.addError(
          node,
          "Current class was not defined when entering method"
        );
        return;
      }
      await callback(
  ...
  async cmdNew(node, ctx, wr) {
    ...
    if (typeof fnDescr !== "undefined" && fnDescr != null) {
      ...
      for (let i_1 = 0; i_1 < fnDescr.params.length; i_1++) {
        ...
        if (params.children.length <= i_1) {
          ...
          ctx.addError(
            param.nameNode,
            "To fix the previous error: Check original function declaration"
          );
        }
        const argNode = params.children[i_1];
        if (
          false == (await this.areEqualTypes(param.nameNode, argNode, ctx, wr))
        ) {
          ctx.addError(
            argNode,
            "ERROR, invalid argument type for " + currC.name + " constructor "
          );
        }
        ...
        if (pNode.hasFlag("optional")) {
          if (false == argNode.hasFlag("optional")) {
            ctx.addError(
              node,
              "new parameter optionality does not match, expected optional parameter" +
                argNode.getCode()
            );
          }
        }
        if (argNode.hasFlag("optional")) {
          if (false == pNode.hasFlag("optional")) {
            ctx.addError(
              node,
              "new parameter optionality does not match, expected non-optional, optional given" +
                argNode.getCode()
            );
          }
        }
    ...
    if (expects_error) {
      ...
      if (cnt_now == err_cnt) {
        ctx.addParserError(
          node,
          "LANGUAGE_PARSER_ERROR: expected generated error, err counts : " +
            err_cnt +
            " : " +
            cnt_now
        );
      ...
      if (cnt_now_1 > err_cnt) {
        ctx.addParserError(
          node,
          "LANGUAGE_PARSER_ERROR: did not expect generated error, err counts : " +
            err_cnt +
            " : " +
            cnt_now_1
        );
  ...
  async SolveAsyncFuncs(node, ctx, wr) {
    const root = ctx.getRoot();
    await operatorsOf_13.forEach_14(
      root.definedClasses,
      async (item, index) => {
        await operatorsOf.forEach_29(
          item.static_methods,
          async (item, index) => {
            ...
            if (typeof item.nameNode !== "undefined" && item.nameNode != null) {
              if (item.nameNode.hasFlag("async")) {
                ...
                if (
                  typeof item.insideFn !== "undefined" &&
                  item.insideFn != null
                ) {
            ...
            await operatorsOf.forEach_29(
              ...
              async (item, index) => {
                if (
                  typeof item.nameNode !== "undefined" &&
                  item.nameNode != null
                ) {
                  if (item.nameNode.hasFlag("async")) {
                    await operatorsOf.forEach_29(
        ...
        await operatorsOf_13.forEach_30(
          ...
          async (item, index) => {
            await operatorsOf.forEach_29(item.variants, (item, index) => {
              if (item.isCalledBy.length == 0) {
                if (
                  typeof item.container_class !== "undefined" &&
                  item.container_class != null
                ) {
    ...
    const add_dce_fn = async (theFn) => {
      ...
      set_called = async (f) => {
        ...
        operatorsOf.forEach_31(f.isUsingClasses, (item, index) => {
          ...
          if (
            typeof item.constructor_fn !== "undefined" &&
            item.constructor_fn != null
          ) {
        ...
        if (
          typeof f.container_class !== "undefined" &&
          f.container_class != null
        ) {
          if (
            typeof f.container_class.constructor_fn !== "undefined" &&
            f.container_class.constructor_fn != null
          ) {
    ...
    if (ctx.hasCompilerFlag("dead4main")) {
      ...
      await operatorsOf_13.forEach_14(root.definedClasses, (item, index) => {
        ...
        for (let i = 0; i < cl.static_methods.length; i++) {
          ...
          if (
            variant.nameNode.hasFlag("main") &&
            variant.nameNode.code.filename == ctx.getRootFile()
          ) {
            mainFn = variant;
    ...
    if (use_dce) {
      ...
      await operatorsOf_13.forEach_14(
        ...
        async (item, index) => {
          ...
          item.static_methods = operatorsOf.filter_32(
            item.static_methods,
            (item, index) => {
              ...
              if (item.is_called_from_main == false) {
                if (verbose) {
                  console.log(
                    "removing as dead " + item.name + " from " + cc_1.name
                  );
                }
              }
          ...
          await operatorsOf_13.forEach_30(
            item.method_variants,
            (item, index) => {
              item.variants = operatorsOf.filter_32(
                item.variants,
                (item, index) => {
                  ...
                  if (item.is_called_from_main == false) {
                    if (verbose) {
                      console.log(
                        "removing as dead " + item.name + " from " + cc_2.name
                      );
                    }
                  }
                  return item.is_called_from_main;
        ...
        if (m.nameNode.hasFlag("throws")) {
          if (false == ctx.isTryBlock()) {
            ctx.addError(
              ...
              "The method " +
                m.name +
                " potentially throws an exception, try { } block is required"
            );
          }
        }
        if (nn.value_type == 17) {
  ...
  async matchLambdaArgs(n1, n2, ctx, wr) {
    ...
    if (chLen1 < 2) {
      ctx.addError(
        n1,
        "Invalid Lambda definition, missing args or return value"
      );
      ctx.addError(
        n2,
        "^ Invalid Lambda definition, missing args or return value"
    ...
    await operatorsOf.forEach_15(argsExpr1.children, async (item, index) => {
      ...
      if (all_matched && item.value_type == 17) {
        if (
          false ==
          (await this.matchLambdaArgs(
            item.expression_value,
            item2.expression_value,
            ctx,
            wr
          ))
        ) {
  ...
  async testLambdaCallArgs(lambda_expression, callParams, ctx, wr) {
    ...
    if (callParams.children.length != lambdaArgs.children.length) {
      ctx.addError(
        callParams,
        "Invalid parameter count for the lambda expression "
      );
    ...
    await operatorsOf.forEach_15(lambdaArgs.children, (item, index) => {
      ...
      if (item2.eval_type_name != item.type_name) {
        if (item.type_name != "Any") {
          ctx.addError(
            item2,
            "Argument of wrong type given for the lambda parameter " + index
          );
          all_matched = false;
        }
      }
  ...
  async cmdLocalCall(node, ctx, wr) {
    ...
    if (fnNode.ns.length > 1) {
      ...
      if (rootName != "this" && vDef2.init_cnt == 0 && vDef2.set_cnt == 0) {
        if (
          vDef2.is_class_variable == false &&
          ctx.isDefinedClass(rootName) == false
        ) {
      ...
      if (typeof vFnDef !== "undefined" && vFnDef != null) {
        ...
        const nodeList = this.transformParams(
          callParams.children,
          vFnDef.params,
          subCtx
        );
        ...
        for (let i_1 = 0; i_1 < nodeList.length; i_1++) {
          ...
          if (was_lambda) {
            ...
            if (
              typeof arg.lambdaFnDesc !== "undefined" &&
              arg.lambdaFnDesc != null
            ) {
            ...
            await arg.forTree((item, i) => {
              if (
                typeof item.lambdaFnDesc !== "undefined" &&
                item.lambdaFnDesc != null
              ) {
        ...
        if (cp_len > vFnDef.params.length) {
          ...
          ctx.addError(
            vFnDef.nameNode,
            "NOTE: To fix the previous error: Check original function declaration which was"
          );
        }
        for (let i_2 = 0; i_2 < vFnDef.params.length; i_2++) {
          ...
          if (
            false ==
            (await this.areEqualTypes(param.nameNode, argNode, ctx, wr))
          ) {
            ctx.addError(
              argNode,
              "ERROR, invalid argument type for method " + vFnDef.name
            );
          }
          const pNode = param.nameNode;
          if (pNode.hasFlag("optional")) {
            if (false == argNode.hasFlag("optional")) {
              ctx.addError(
                node,
                "function parameter optionality does not match, consider making parameter optional " +
                  argNode.getCode()
              );
            }
          }
          if (argNode.hasFlag("optional")) {
            if (false == pNode.hasFlag("optional")) {
              ctx.addError(
                node,
                "function parameter optionality does not match, consider unwrapping " +
                  argNode.getCode()
              );
            }
          }
    ...
    if (desc.hasMethod(fnNode.vref)) {
      ...
      for (let i_4 = 0; i_4 < fnDescr.params.length; i_4++) {
        ...
        if (
          false ==
          (await this.areEqualTypes(param_1.nameNode, argNode_1, ctx, wr))
        ) {
          ctx.addError(
            argNode_1,
    ...
    if (ctx.isVarDefined(fnNode.vref)) {
      ...
      if (d.nameNode.hasFlag("optional")) {
        ctx.addError(
          node,
          "Can not call optional lambda function, unwrap the function first!"
        );
      }
      if (d.nameNode.value_type == 17) {
        ...
        await this.testLambdaCallArgs(
          d.nameNode.expression_value,
          callParams_1,
          ctx,
          wr
        );
        ...
        if (node.eval_type == 17) {
          if (
            typeof lambdaDef.expression_value !== "undefined" &&
            lambdaDef.expression_value != null
          ) {
    ...
    ctx.addError(
      node,
      "ERROR, could not find class " + desc.name + " method " + fnNode.vref
    );
  ...
  async cmdAssign(node, ctx, wr) {
    ...
    if (target.hasParamDesc) {
      if (
        typeof target.paramDesc.propertyClass !== "undefined" &&
        target.paramDesc.propertyClass != null
      ) {
  ...
  async EnterClass(node, ctx, wr) {
    ...
    for (let i_1 = 0; i_1 < cBody.children.length; i_1++) {
      ...
      if (
        fNode.isFirstVref("fn") ||
        fNode.isFirstVref("constructor") ||
        fNode.isFirstVref("Constructor")
      ) {
    ...
    for (let i_3 = 0; i_3 < cBody.children.length; i_3++) {
      ...
      if (
        fNode_2.isFirstVref("sfn") ||
        fNode_2.isFirstVref("StaticMethod") ||
        fNode_2.isFirstVref("static")
      ) {
  ...
  async walkFunctionBody(m, fnBody, ctx, subCtx, wr) {
    ...
    if (fnBody.didReturnAtIndex == -1) {
      ...
      if (
        m.nameNode.type_name == "void" ||
        (m.nameNode.type_name.length > 0 == false &&
          m.nameNode.array_type.length > 0 == false)
      ) {
        if (false == ctx.getFlag("in_task")) {
          ...
          if (rvNode.children.length > 1) {
            ctx.addError(
              m.nameNode,
              "No return value type defined for a function which returns value"
            );
            ctx.addError(
              rvNode,
              "Returning value from a function without set return value"
            );
          }
        }
      }
  ...
  async EnterMethod(node, ctx, wr) {
    await this.EnterFn(
      ...
      ctx,
      wr,
      async (node, ctx, wr, nameNode, fnArgs, fnBody, desc) => {
  ...
  async DefineArrowOpFn(node, ctx, wr) {
    ...
    const opNode = CodeNode.fromList([
      CodeNode.vref1("defn"),
      CodeNode.vref1(myName),
      argsNode,
      fBody,
    ]);
    const setArg = (idx) => {
  ...
  async testCompile(opFn, node, ctx, wr) {
    ...
    if (false == node.register_name.length > 0) {
      await opBody.forTree(async (item, i) => {
        if (
          typeof regToArg[item.vref] != "undefined" &&
          regToArg.hasOwnProperty(item.vref)
        ) {
          if (
            typeof opParamSet[item.vref] != "undefined" &&
            opParamSet.hasOwnProperty(item.vref)
          ) {
            if (
              false ==
              (typeof regParams[item.vref] != "undefined" &&
                regParams.hasOwnProperty(item.vref))
            ) {
              ...
              if (realArg.register_name.length > 0) {
                ...
                const regExpr = CodeNode.fromList([
                  CodeNode.vref1("def"),
                  CodeNode.vref1(regName),
                  argCopy,
                ]);
  ...
  async TransformOpFn(opFnList, origNode, ctx, wr) {
    ...
    let least_errs = [];
    const depth = operatorsOfstring_33.transactionc95depth_34(
      "TransformOpFn",
      ctx
    );
    if (depth > 20) {
    ...
    const myT = operatorsOf_33.startc95transaction_35(
      "TransformOpFn",
      fc.vref,
      ctx
    );
    ...
    if (
      typeof this.match_types[codeStrHash] != "undefined" &&
      this.match_types.hasOwnProperty(codeStrHash)
    ) {
    ...
    await operatorsOf.forEach_15(opFnList, async (item, index) => {
            ...
            if (
              ...
              if (
                ...
                if (realArg.register_name.length > 0) {
                  ...
                  const regArg = regExpr.children[1];
                  const realRegName =
                    regExpr.children[1].paramDesc.compiledName;
                  regArg.paramDesc.set_cnt = 1;
                  regArg.paramDesc.ref_cnt = 1;
                  if (use_delta) {
      ...
      if (errCnt == rootCtx.compilerErrors.length) {
        ...
        if (opBody_1.is_block_node) {
          ...
          if (
            lastLine.isFirstVref("ret") ||
            lastLine.eval_array_type.length > 0 ||
            (lastLine.eval_type_name.length > 0 &&
              lastLine.eval_type_name != "void")
          ) {
            ...
            if (argVal.eval_type == 17) {
              if (
                typeof argVal.expression_value !== "undefined" &&
                argVal.expression_value != null
              ) {
            ...
            const regExpr_1 = CodeNode.fromList([
              CodeNode.vref1("def"),
              nameNode,
            ]);
            ...
            lastLine.getChildrenFrom(
              CodeNode.fromList([
                CodeNode.vref1("="),
                CodeNode.vref1(regName_1),
                argCopy_1,
              ])
            );
  ...
  async EnterLambdaMethod(node, ctx, wr) {
    ...
    if (false == args.expression) {
      ctx.addError(
        node,
        "Invalid anonymous function: second param should be an expression"
      );
    }
    ctx.incLambdaCnt();
    ...
    node.lambdaFnDesc = m;
    if (ctx.isCapturing()) {
      await operatorsOf.forEach_12(
        node.lambda_ctx.captured_variables,
        (item, index) => {
      ...
      if (false == ctx.isDefinedClass(node.vref)) {
        ...
        if (testC.is_trait) {
          if (testC.node.hasExpressionProperty("params")) {
            ...
            const ann = tAnn;
            await ctx.createTraitInstanceClass(
              testC.name,
              my_class_name,
              ann,
              this,
  ...
  async mergeImports(node, ctx, wr) {
    ...
    if (node.isFirstVref("Import")) {
      ...
      if (
        typeof ctx.already_imported[import_file] != "undefined" &&
        ctx.already_imported.hasOwnProperty(import_file)
      ) {
        return;
      }
      let source_code = "";
      ...
      if (ppList.length > 0) {
        try {
          await operatorsOf.forEach_12(ppList, (item, index) => {
            ...
            if (typeof ss === "string") {
              /* union case for string */ var str = ss;
      ...
      if (source_code.length == 0) {
        ...
        if (
          operatorsOf_8.filec95exists_9(env, filePathIs, import_file) == false
        ) {
  ...
  async CollectMethods(node, ctx, wr) {
    ...
    for (let i = 0; i < this.classesWithTraits.length; i++) {
      ...
      if (t.has_constructor) {
        ctx.addError(
          ...
          "Can not join class " +
            name +
            " because it has a constructor function"
        );
      } else {
        const origBody = cl.node.children[2];
        const match = new RangerArgMatch();
    ...
    const cClassList = this.serializedClasses.slice().sort((left, right) => {
      ...
      operatorsOf.forEach_11(left.variables, (item, index) => {
        if (
          item.nameNode.type_name == right.name ||
          item.nameNode.array_type == right.name
        ) {
          left_had = true;
        }
      });
      operatorsOf.forEach_11(right.variables, (item, index) => {
        if (
          item.nameNode.type_name == left.name ||
          item.nameNode.array_type == left.name
        ) {
          right_had = true;
        }
      });
    ...
    for (let i_8 = 0; i_8 < ctx.definedClassList.length; i_8++) {
      ...
      await operatorsOf_13.forEach_30(
        ...
        async (item, index) => {
          await operatorsOf.forEach_29(item.variants, (item, index) => {
            if (
              typeof varNames[item.name] != "undefined" &&
              varNames.hasOwnProperty(item.name)
            ) {
              ctx.addError(
                item.nameNode,
                "Class has defined method and variable of the same name."
              );
            }
          });
        }
    ...
    for (let i_11 = 0; i_11 < allTypes.length; i_11++) {
      ...
      if (
        typeof did_push[typeName_1] != "undefined" &&
        did_push.hasOwnProperty(typeName_1)
      ) {
        continue;
      }
  ...
  async WalkCollectMethods(node, ctx, wr) {
    ...
    if (node.isFirstVref("operator")) {
      ...
      for (let i = 0; i < opsList.children.length; i++) {
        ...
        if (fc_1.vref == "fn") {
          ...
          const opThisNode = nameNode.rebuildWithType(
            new RangerArgMatch(),
            false
          );
          ...
          const opCodeNode = opCode.rebuildWithType(
            new RangerArgMatch(),
            false
          );
    ...
    if (node.isFirstVref("systemclass")) {
      ...
      if (ctx.isDefinedClass(nameNode_4.vref)) {
        ...
        if (cl_1.is_system_union == false) {
          ctx.addError(
            node,
            "Class already defined and it was not a systemunion."
          );
        }
        cl_1.is_system = true;
      ...
      for (let i_6 = 0; i_6 < instances_5.children.length; i_6++) {
        ...
        if (langClassName_1.string_value.length > 0) {
          new_class_4.systemNames[langName_1.vref] =
            langClassName_1.string_value;
        }
      }
    ...
    if (node.isFirstVref("CreateClass") || node.isFirstVref("class")) {
      ...
      classNameNode_1.evalTypeClass = TFactory.new_class_signature(
        classNameNode_1,
        ctx,
        wr
      );
      ...
      if (notOkNames.indexOf(s_1) >= 0) {
        ctx.addError(
          classNameNode_1,
          "Unfortunately this class name not allowed: " + s_1
        );
      }
      switch (s_1) {
        case "_":
      ...
      if (third.vref == "extends") {
        if (node.chlen() >= 4) {
          ...
          if (extClass.vref.length > 0) {
            ...
            ctx.addError(
              node,
              "Invalid classname given for the extends keyword"
            );
          }
        }
      }
    ...
    if (node.isFirstVref("PublicMethod") || node.isFirstVref("fn")) {
      ...
      if (currC_8.hasOwnMethod(fnObj.name) && false == cn.hasFlag("override")) {
        ctx.addError(
          node,
          "Error: method of same name declared earlier. Overriding function declarations is not currently allowed!"
        );
        return;
      }
      if (cn.hasFlag("main")) {
        ctx.addError(
          node,
          "Error: dynamic method declared as @(main). Use static 'sfn' instead of 'fn'."
        );
        return;
      }
  ...
  findFunctionDesc(obj, ctx, wr) {
    ...
    if (obj.vref != this.getThisName()) {
        ...
        for (let i = 0; i < obj.ns.length; i++) {
          ...
          if (i == 0) {
            if (strname == this.getThisName()) {
              ...
              if (
                typeof classRefDesc === "undefined" ||
                typeof classRefDesc.nameNode === "undefined"
              ) {
                ctx.addError(
                  obj,
                  "Error, no description for called object: " + strname
                );
                break;
              }
            ...
            if (i < cnt - 1) {
              ...
              if (typeof varDesc === "undefined") {
                ctx.addError(
                  obj,
                  "Error, no description for refenced obj: " + strname
                );
              }
      ...
      if (typeof varFnDesc !== "undefined" && varFnDesc != null) {
        if (
          typeof varFnDesc.nameNode !== "undefined" &&
          varFnDesc.nameNode != null
        ) {
        } else {
          ctx.addError(
            obj,
            "Error, no description for called function: " + obj.vref
          );
        }
      }
      return varFnDesc;
              ...
              if (classRefDesc.nameNode.hasFlag("optional")) {
                if (ctx.hasCompilerFlag("strict")) {
                  if (false == ctx.isTryBlock()) {
                    ctx.addError(
                      obj,
                      "Optional automatically unwrapped outside try block"
                    );
                  }
                }
              }
  ...
  async transformMethodToLambda(node, vFnDef, ctx, wr) {
    if (vFnDef.isFunction()) {
      ...
      if (
        (vFnDef.nameNode.type_name.length > 0 &&
          vFnDef.nameNode.type_name != "void") ||
        vFnDef.nameNode.array_type.length > 0
      ) {
        const staticLambda = CodeNode.fromList([
          fnArg,
          CodeNode.fromList(args),
          CodeNode.blockFromList([
            CodeNode.fromList([
              CodeNode.vref1("return"),
              CodeNode.fromList([subNode, CodeNode.fromList(argsExpr)]),
            ]),
          ]),
        ]);
        node.getChildrenFrom(staticLambda);
      } else {
        const staticLambda_1 = CodeNode.fromList([
          fnArg,
          CodeNode.fromList(args),
          CodeNode.blockFromList([
            CodeNode.fromList([subNode, CodeNode.fromList(argsExpr)]),
  ...
  async areEqualTypes(n1, n2, ctx, wr) {
    if (n1.eval_type == 17) {
      ...
      if (typeof n1Expr === "undefined") {
        if (
          n1.hasParamDesc &&
          typeof n1.paramDesc.nameNode !== "undefined" &&
          n1.paramDesc.nameNode != null &&
          typeof n1.paramDesc.nameNode.expression_value !== "undefined" &&
          n1.paramDesc.nameNode.expression_value != null
        ) {
      ...
      if (typeof n2Expr === "undefined") {
        if (
          n2.hasParamDesc &&
          typeof n2.paramDesc.nameNode !== "undefined" &&
          n2.paramDesc.nameNode != null &&
          typeof n2.paramDesc.nameNode.expression_value !== "undefined" &&
          n2.paramDesc.nameNode.expression_value != null
        ) {
          n2Expr = n2.paramDesc.nameNode.expression_value;
        }
      }
      if (
        typeof n1Expr !== "undefined" &&
        n1Expr != null &&
        typeof n2Expr !== "undefined" &&
        n2Expr != null
      ) {
        return await this.matchLambdaArgs(
          n1Expr,
          n2Expr,
          ctx,
          new CodeWriter()
      ...
      if (typeof n1Expr !== "undefined" && n1Expr != null) {
        ...
        if (opList.length > 0) {
          ...
          if (fc.type_name != "void") {
            newExpr.children.push(
              CodeNode.fromList([CodeNode.vref1("return"), newCall])
            );
          } else {
    ...
    if (
      n1.eval_type != 0 &&
      n2.eval_type != 0 &&
      n1.eval_type_name.length > 0 &&
      n2.eval_type_name.length > 0
    ) {
      if (n1.eval_type_name == n2.eval_type_name) {
      } else {
        let b_ok = false;
        if (
          ctx.isEnumDefined(n1.eval_type_name) &&
          n2.eval_type_name == "int"
        ) {
          b_ok = true;
        }
        if (
          ctx.isEnumDefined(n2.eval_type_name) &&
      ...
      if (det.children.length > 0) {
        ...
        if (fc.vref == "templates") {
          ...
          for (let i_1 = 0; i_1 < tplList.children.length; i_1++) {
            ...
            const is_ts = ctx.hasCompilerFlag("typescript");
            if (
              is_ts &&
              (tplName.vref == "typescript" || tplName.vref == "ts")
            ) {
              rv = tpl;
              return rv;
            }
          ...
          if (langName == "ranger") {
            ...
            const rangerTpl = CodeNode.fromList([
              CodeNode.newStr("(" + opNameNode.vref + " "),
            ]);
            let cnt = 1;
            await operatorsOf.forEach_15(opArgs.children, (item, index) => {
              if (item.type_name == "block") {
                rangerTpl.children.push(
                  CodeNode.fromList([
                    CodeNode.vref1("block"),
                    CodeNode.newInt(cnt),
                  ])
                );
              } else {
                rangerTpl.children.push(
                  CodeNode.fromList([CodeNode.vref1("e"), CodeNode.newInt(cnt)])
                );
              }
              cnt = cnt + 1;
            });
  ...
  async buildMacro(langOper, args, ctx) {
    ...
    if (ctx.hasCompilerFlag("show-macros")) {
      console.log(
        "Building macro " + macroNode.vref + " : " + cmdList.getCode()
      );
    ...
    if (args.register_expressions.length > 0) {
      node.register_expressions = operatorsOf.clone_46(
        args.register_expressions
      );
    }
  ...
  async stdParamMatch(callArgs, inCtx, wr, require_all_match) {
    ...
    for (let main_index = 0; main_index < op_list.length; main_index++) {
      ...
      if (callerArgCnt == fnArgCnt || expanding_node) {
          ...
          if (arg.value_type == 17) {
            ...
            if (arg.hasFlag("mutates")) {
              if (callArg.hasParamDesc) {
                if (
                  typeof callArg.paramDesc != "undefined" &&
                  typeof callArg.paramDesc.propertyClass !== "undefined" &&
                  callArg.paramDesc.propertyClass != null
                ) {
                  if (
                    callArg.paramDesc.propertyClass.nameNode.hasFlag(
                      "immutable"
                    )
                  ) {
        ...
        if (all_matched) {
          ...
          let is_last = false;
          if (
            typeof callArgs.parent !== "undefined" &&
            callArgs.parent != null
          ) {
            is_last =
              callArgs.parent.children.length ==
              1 + callArgs.parent.children.indexOf(callArgs);
          }
          if (
            fc.vref == "if" &&
            ctx.hasCompilerFlag("voidexpr") &&
            (expr_level > 0 || is_last)
          ) {
            ...
            const regExpr = CodeNode.fromList([
              CodeNode.vref1("def"),
              CodeNode.vref2(regName, lastRow.eval_type_name),
            ]);
            ...
            if (lastRow.register_name.length > 0) {
              const newLastRow = CodeNode.fromList([
                CodeNode.vref1("="),
                CodeNode.vref1(regName),
            ...
            if (callArgs.children.length == 4) {
              ...
              const lastRow_1 =
                elseBlock.children[elseBlock.children.length - 1];
              if (lastRow_1.register_name.length > 0) {
                const newLastRow_1 = CodeNode.fromList([
                  CodeNode.vref1("="),
                  CodeNode.vref1(regName),
                  CodeNode.vref1(lastRow_1.register_name),
                ]);
            ...
            await operatorsOf.forEach_15(args.children, async (item, index) => {
              ...
              if (opArg.hasFlag("loopcondition")) {
                ...
                if (typeof loopBlock === "undefined") {
                  ctx.addError(
                    args,
                    "Invalid operator: Loop condition without block "
                  );
                  return;
                }
                ...
                await this.WalkNode(regExpr_1, ctx, wr);
                const realRegName_1 =
                  regExpr_1.children[1].paramDesc.compiledName;
                ...
                await operatorsOf.forEach_15(
                  ...
                  async (item, index) => {
                    if (item.is_block_node) {
                      ...
                      const eval_expr = CodeNode.fromList([
                        CodeNode.vref1("="),
                        CodeNode.vref1(regName_1),
                        argCopy_1,
                      ]);
            ...
            await operatorsOf.forEach_15(
              ...
              async (item, index) => {
                if (item.isFirstVref("e")) {
                  ...
                  if (
                    typeof opCnts[opName_1] != "undefined" &&
                    opCnts.hasOwnProperty(opName_1)
                  ) {
                    let regName_2 = "";
                    ...
                    if (
                      typeof regNames[opName_1] != "undefined" &&
                      regNames.hasOwnProperty(opName_1)
                    ) {
                      ...
                      if (realArg_1.register_name.length > 0) {
                        ...
                        const regExpr_2 = CodeNode.fromList([
                          CodeNode.vref1("def"),
                          CodeNode.vref1(regName_2),
                          argCopy_2,
                        ]);
                        await this.WalkNode(regExpr_2, ctx, wr);
                        const regArg_1 = regExpr_2.children[1];
                        const realRegName_2 =
                          regExpr_2.children[1].paramDesc.compiledName;
                        regArg_1.paramDesc.set_cnt = 1;
                        regArg_1.paramDesc.ref_cnt = 1;
                        const BlockOP_2 = ctx.getLastBlockOp();
        ...
        if (all_matched) {
          if (is_async) {
            ...
            if (
              ...
              activeFn.nameNode != null
            ) {
              activeFn.nameNode.setFlag("async");
            }
            while (
              typeof activeFn.insideFn !== "undefined" &&
              activeFn.insideFn != null
            ) {
          ...
          if (throws_exception) {
            if (false == ctx.isTryBlock()) {
              ...
              if (
                ...
                activeFn_1.nameNode != null &&
                activeFn_1.nameNode.hasFlag("throws")
              ) {
              } else {
                ctx.addError(
                  callArgs,
          ...
          for (let i_2 = 0; i_2 < walk_later.length; i_2++) {
            ...
            if (
              ca.is_block_node &&
              ca.isFirstVref("fn") == false &&
              ca.isFirstVref("fun") == false
            ) {
        ...
        if (codeDef.is_block_node && all_matched) {
          ...
          if (is_pure && pure_transform) {
            const argDefs = CodeNode.blockFromList(
              operatorsOf.map_45(args.children, (item, index) => {
          ...
          if (false == new_cl.hasStaticMethod(argsSig)) {
            const sMethod = await ctx.createStaticMethod(
              argsSig,
              new_cl,
              nameCopy,
              argsCopy,
        ...
        if (all_matched) {
          if (is_static_fn) {
            ...
            for (let i_7 = 0; i_7 < newArgs.children.length; i_7++) {
              ...
              if (ca_2.eval_type == 17) {
                if (
                  typeof ca_2.lambdaFnDesc !== "undefined" &&
                  ca_2.lambdaFnDesc != null
                ) {
                  if (
                    typeof staticMethod !== "undefined" &&
                    staticMethod != null
                  ) {
          ...
          if (nameNode.hasFlag("returns")) {
            ...
            if (
              activeFn_2.nameNode.type_name != "void" ||
              activeFn_2.nameNode.value_type == 17
            ) {
              if (callArgs.children.length < 2) {
                ...
                if (activeFn_2.nameNode.value_type == 17) {
                  ...
                  if (typeof fnExpr === "undefined") {
                    ctx.addError(
                      activeFn_2.nameNode,
                      "returned anonymous function should have a method signature"
                    );
                  } else {
                    if (
                      returnedValue.value_type != 17 &&
                      returnedValue.eval_type != 17
                    ) {
                      ctx.addError(
                        returnedValue,
                        "Function should return anonymous function!"
                      );
                    } else {
                      if (
                        returnedValue.hasParamDesc &&
                        typeof returnedValue.paramDesc.nameNode !==
                          "undefined" &&
                        returnedValue.paramDesc.nameNode != null
                      ) {
                        const rExpr =
                          returnedValue.paramDesc.nameNode.expression_value;
                ...
                if (validated_returnvalue == false) {
                  if (
                    match.doesMatch(activeFn_2.nameNode, returnedValue, ctx) ==
                    false
                  ) {
                    if (
                      activeFn_2.nameNode.ifNoTypeSetToEvalTypeOf(returnedValue)
                    ) {
                    } else {
                      ctx.addError(
                        returnedValue,
                        "invalid return value type!!! " +
                          returnedValue.getCode()
                      );
                      ctx.addError(
                        returnedValue,
                        "^ code: " + returnedValue.getCode()
                      );
                      ...
                      ctx.addError(
                        activeFn_2.nameNode,
                        "^ value type = " + returnedValue.eval_type
                      );
                    }
                  }
                }
                ...
                if (returnedValue.hasFlag("optional")) {
                  if (false == argNode.hasFlag("optional")) {
                    ctx.addError(
                      callArgs,
                      "function return value optionality does not match, expected non-optional return value, optional given at " +
                        argNode.getCode()
                    );
                  }
                }
                if (argNode.hasFlag("optional")) {
                  if (false == returnedValue.hasFlag("optional")) {
                    ctx.addError(
                      callArgs,
                      "function return value optionality does not match, expected optional return value " +
                        argNode.getCode()
                    );
                  }
                }
            ...
            callArgs.parent.didReturnAtIndex =
              callArgs.parent.children.indexOf(callArgs);
          }
          if (nameNode.hasFlag("returns") == false) {
            match.setRvBasedOn(nameNode, callArgs);
            callArgs.evalTypeClass = TFactory.new_def_signature(
              nameNode,
              ctx,
              wr
            );
          ...
          for (
            let arg_index = 0;
            arg_index < args.children.length;
            arg_index++
          ) {
    ...
    if (require_all_match == true && some_matched == false) {
      ctx.addError(
        callArgs,
        "Could not match argument types for " + callFnName.vref
      );
    }
    if (expects_error) {
      const cnt_now = ctx.getErrorCount();
...
TFactory.new_def_signature = function (node, ctx, wr) {
  ...
  if (typeof tc === "undefined") {
    ...
    if (node.value_type == 6) {
      newTC.arrayType = TFactory.new_def_signature_from_simple_string(
        node.array_type,
        ctx,
        wr
      );
    ...
    if (node.value_type == 7) {
      newTC.keyType = TFactory.new_def_signature_from_simple_string(
        node.key_type,
        ctx,
        wr
      );
...
class RangerGenericClassWriter {
  ...
  async addSystemImport(cl, ctx, wr) {
    if (cl.is_system) {
      const langName = operatorsOf_21.getTargetLang_22(ctx);
      if (
        typeof cl.systemNodes[langName] != "undefined" &&
        cl.systemNodes.hasOwnProperty(langName)
      ) {
  ...
  EncodeString(node, ctx, wr) {
    ...
    while (ii < str_length) {
      ...
      switch (cc) {
        case 8:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(98);
          break;
        case 9:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(116);
          break;
        case 10:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(110);
          break;
        case 12:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(102);
          break;
        case 13:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(114);
          break;
        case 34:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(34);
          break;
        case 92:
          encoded_str_2 =
            encoded_str_2 + String.fromCharCode(92) + String.fromCharCode(92);
          break;
        default:
  ...
  async WalkNode(node, ctx, wr) {
    await operatorsOf.forEach_15(node.children, (item, index) => {
      if (typeof item.evalCtx !== "undefined" && item.evalCtx != null) {
        if (
          operatorsOf_21.getTargetLang_22(item.evalCtx) !=
          operatorsOf_21.getTargetLang_22(ctx)
        ) {
    ...
    if (node.hasNewOper) {
      ...
      if (typeof constr !== "undefined" && constr != null) {
        for (let i = 0; i < constr.params.length; i++) {
          ...
          if (
            true ||
            (typeof arg.nameNode !== "undefined" && arg.nameNode != null)
          ) {
            await this.WalkNode(n, ctx, wr);
          }
        }
...
class AndroidPageWriter {
  ...
  async CreatePage(parser, node, ctx, orig_wr) {
    ...
    wr.indent(1);
    wr.out(
      "final View view = inflater.inflate(R.layout.activity_" +
        pageName +
        ", container, false);",
      true
    );
    ...
    if (pageName != "notme") {
      await operatorsOf.forEach_15(fnBody.children, (item, index) => {
        ...
        if (item.isFirstVref("ui")) {
          ...
          const uiNode = CodeNode.op2(
            "task.call",
            CodeNode.blockFromList([
              CodeNode.op3("def", [
                CodeNode.vref1("uictx"),
                CodeNode.op2(
                  "unwrap",
                  CodeNode.op3("get", [
                    CodeNode.vref1("ctx.anyValues"),
                    CodeNode.newStr("uicontext"),
                  ])
                ),
              ]),
              CodeNode.op2(
                "print",
                CodeNode.newStr("after this should be ui_thread")
              ),
              CodeNode.op3("case", [
                CodeNode.vref1("uictx"),
                CodeNode.vref2("c", "UIContextHandle"),
                CodeNode.blockFromList([
                  CodeNode.op3("ui_thread", [CodeNode.vref1("c"), codeToRun]),
                ]),
              ]),
            ])
          );
...
class RangerJava7ClassWriter extends RangerGenericClassWriter {
    ...
    if (node.hasFlag("optional")) {
      switch (v_type) {
        case 17:
          ...
          if (
            (typeof this.iface_created[iface_name] != "undefined" &&
              this.iface_created.hasOwnProperty(iface_name)) == false
          ) {
        ...
        case 7:
          wr.out(
            "HashMap<" +
              (await this.getObjectTypeString2(k_name, ctx, wr)) +
              "," +
              (await this.getObjectTypeString2(a_name, ctx, wr)) +
              ">",
            false
          );
      ...
      switch (v_type) {
        case 17:
          ...
          if (
            (typeof this.iface_created[iface_name_1] != "undefined" &&
              this.iface_created.hasOwnProperty(iface_name_1)) == false
          ) {
            ...
            const utilWr_1 = wr.getFileWriter(
              iface_dir_1,
              iface_name_1 + ".java"
            );
            if (this.isPackaged(ctx)) {
              ...
              if (package_name_3.length > 0) {
                utilWr_1.out(
                  "package " + package_name_3 + ".interfaces;",
                  true
                );
  ...
  async WriteVRef(node, ctx, wr) {
    ...
    if (node.nsp.length > 0) {
      for (let i = 0; i < node.nsp.length; i++) {
        var p = node.nsp[i];
        if (i == 0) {
          let p_captured_mutable =
            p.set_cnt > 0 && p.is_captured && p.is_class_variable == false;
    ...
    if (node.hasParamDesc) {
      ...
      let p_captured_mutable_1 =
        p_1.set_cnt > 0 && p_1.is_captured && p_1.is_class_variable == false;
  ...
  async writeVarDef(node, ctx, wr) {
    if (node.hasParamDesc) {
      ...
      if (
        p.is_captured &&
        p.is_class_variable == false &&
        (nn.value_type == 7 || nn.value_type == 6)
      ) {
        wr.out("final ", false);
      } else {
        if (
          p_captured_mutable == false &&
          (p.set_cnt > 0 || p.is_class_variable)
        ) {
          wr.out("", false);
        } else {
          wr.out("final ", false);
  ...
  async CreateLambdaCall(node, ctx, wr) {
    ...
    let args;
    if (
      typeof fName.expression_value !== "undefined" &&
      fName.expression_value != null
    ) {
  ...
  async writeArrayLiteral(node, ctx, wr) {
    ...
    wr.out(
      await this.getObjectTypeString2(node.eval_array_type, ctx, wr),
      false
    );
...
class RangerSwift3ClassWriter extends RangerGenericClassWriter {
    ...
    if (ctx.isDefinedClass(type_string)) {
      ...
      if (cc.is_system) {
        ...
        if (typeof sysName !== "undefined" && sysName != null) {
          ...
          ctx.addError(
            node,
            "No system class " + type_string + "defined for Swift "
          );
        }
      }
    }
  ...
  async writeTypeDef(node, ctx, wr) {
    ...
    switch (v_type) {
      ...
      case 7:
        wr.out(
          "[" +
            this.getObjectTypeString(k_name, ctx) +
            ":" +
            this.getObjectTypeString(a_name, ctx) +
            "]",
          false
        );
        break;
        ...
        if (ctx.isDefinedClass(t_name)) {
          ...
          if (cc.is_system) {
            ...
            if (typeof sysName !== "undefined" && sysName != null) {
              ...
              ctx.addError(
                node,
                "No system class " + t_name + "defined for Swift "
              );
            }
            if (node.hasFlag("optional")) {
              wr.out("?", false);
  ...
  async writeArgsDefWithLocals(fnDesc, localFnDesc, ctx, wr) {
    if (fnDesc.params.length != localFnDesc.params.length) {
      ctx.addError(
        localFnDesc.node,
        "Parameter count does not match with the function prototype"
      );
      return;
    }
    for (let i = 0; i < fnDesc.params.length; i++) {
  ...
  async writeClass(node, ctx, wr) {
    ...
    for (let i_7 = 0; i_7 < cl.static_methods.length; i_7++) {
      ...
      if (
        typeof declaredStaticFunction[variant_2.name] != "undefined" &&
        declaredStaticFunction.hasOwnProperty(variant_2.name)
      ) {
        wr.out("override ", false);
      }
    ...
    for (let i_8 = 0; i_8 < cl.defined_variants.length; i_8++) {
      ...
      for (let i_9 = 0; i_9 < mVs_1.variants.length; i_9++) {
        ...
        if (
          typeof dblDeclaredFunction[variant_3.name] != "undefined" &&
          dblDeclaredFunction.hasOwnProperty(variant_3.name)
        ) {
          continue;
        }
        if (
          typeof declaredFunction[variant_3.name] != "undefined" &&
          declaredFunction.hasOwnProperty(variant_3.name)
        ) {
          wr.out("override ", false);
        }
        ...
        if (
          typeof parentFunction[variant_3.name] != "undefined" &&
          parentFunction.hasOwnProperty(variant_3.name)
        ) {
          await this.writeArgsDefWithLocals(
            parentFunction[variant_3.name],
            variant_3,
            ctx,
            wr
          );
    ...
    for (let i_10 = 0; i_10 < cl.static_methods.length; i_10++) {
      ...
      if (
        variant_4.nameNode.hasFlag("main") &&
        variant_4.nameNode.code.filename == ctx.getRootFile()
      ) {
    ...
    if (ctx.isDefinedClass(type_string)) {
      ...
      if (cc.is_system) {
        ...
        if (typeof sysName !== "undefined" && sysName != null) {
          ...
          ctx.addError(
            node,
            "No system class " + type_string + " defined for Swift6 "
          );
        }
      }
    }
        ...
        if (ctx.isDefinedClass(t_name)) {
          ...
          if (cc.is_system) {
            ...
            if (typeof sysName !== "undefined" && sysName != null) {
              ...
              ctx.addError(
                node,
                "No system class " + t_name + " defined for Swift6 "
              );
            }
            if (node.hasFlag("optional")) {
              wr.out("?", false);
...
class RangerCppClassWriter extends RangerGenericClassWriter {
  ...
  async writeTypeDef(node, ctx, wr) {
    ...
    switch (v_type) {
      ...
      case 6:
        wr.out(
          "std::vector<" + this.getObjectTypeString(a_name, ctx) + ">",
          false
        );
        wr.addImport("<vector>");
        break;
    ...
    if (node.vref == "this") {
      ...
      if (typeof currC !== "undefined" && currC != null) {
        ...
        if (cc.extends_classes.length > 0) {
          wr.out(
            "std::dynamic_pointer_cast<" + cc.name + ">(shared_from_this())",
            false
          );
          return;
        }
  ...
  async writeClassHeader(node, ctx, wr) {
    ...
    for (let i_2 = 0; i_2 < cl.variables.length; i_2++) {
      var pvar_1 = cl.variables[i_2];
      if (
        (typeof inheritedVars[pvar_1.name] != "undefined" &&
          inheritedVars.hasOwnProperty(pvar_1.name)) == false
      ) {
        ...
        if (item.is_union) {
          ...
          ctx.addPluginNode(
            ...
            CodeNode.fromList([
              CodeNode.fromList([
                CodeNode.vref1("dep"),
                CodeNode.newStr("variant.hpp"),
                CodeNode.newStr(
                  "https://github.com/mpark/variant/releases/download/v1.2.2/variant.hpp"
                ),
              ]),
            ])
          );
  ...
  async writeClass(node, ctx, orig_wr) {
      ...
      if (dd.is_class_variable == false) {
        if (dd.set_cnt > 0) {
          if (ctx.hasCompilerFlag("dont-allow-mutate")) {
            ctx.addError(
              dd.nameNode,
              "Mutating captured variable is not allowed"
            );
            return;
          }
        }
    ...
    for (let i_7 = 0; i_7 < cl.static_methods.length; i_7++) {
      var variant_2 = cl.static_methods[i_7];
      if (
        variant_2.nameNode.hasFlag("main") &&
        variant_2.nameNode.code.filename == ctx.getRootFile()
      ) {
        ctx.setCompilerSetting("mainclass", cl.name);
...
class RangerRustClassWriter extends RangerGenericClassWriter {
  ...
  async writeTypeDef(node, ctx, wr) {
    ...
    switch (v_type) {
      ...
      case 7:
        wr.out(
          "HashMap<" +
            this.getObjectTypeString(node.key_type, ctx) +
            "," +
            this.getObjectTypeString(node.array_type, ctx) +
            ">",
          false
        );
      ...
      case 6:
        wr.out(
          "Vec<" + this.getObjectTypeString(node.array_type, ctx) + ">",
          false
        );
        break;
      default:
  ...
  async writeClass(node, ctx, orig_wr) {
    ...
    for (let i_4 = 0; i_4 < cl.defined_variants.length; i_4++) {
      ...
      for (let i_5 = 0; i_5 < mVs.variants.length; i_5++) {
        ...
        if (typeof subCtx_2 !== "undefined" && subCtx_2 != null) {
          ...
          await this.WalkNode(fnB_2, sCtx_2, wr);
        }
        wr.newline();
        wr.indent(-1);
        wr.out("}", true);
    ...
    for (let i_6 = 0; i_6 < cl.static_methods.length; i_6++) {
      ...
      const nn_1 = variant_2.nameNode;
      if (nn_1.hasFlag("main")) {
        wr.out("fn main() {", true);
        wr.indent(1);
        wr.newline();
        const subCtx_3 = variant_2.fnCtx;
        if (typeof subCtx_3 !== "undefined" && subCtx_3 != null) {
          ...
          await this.WalkNode(fnB_3, sCtx_3, wr);
        }
        wr.newline();
        wr.indent(-1);
        wr.out("}", true);
...
class RangerKotlinClassWriter extends RangerGenericClassWriter {
  ...
  async writeTypeDef(node, ctx, wr) {
    ...
    switch (v_type) {
      ...
      case 6:
        wr.out(
          "MutableList<" + this.getObjectTypeString(node.array_type, ctx) + ">",
          false
        );
        break;
      default:
    ...
    if (ctx.isDefinedClass(type_string)) {
      ...
      if (cc.is_system) {
        ...
        if (typeof sysName !== "undefined" && sysName != null) {
          ...
          ctx.addError(
            node,
            "No system class " + type_string + "defined for C# "
          );
        }
      }
    }
        ...
        if (ctx.isDefinedClass(t_name)) {
          ...
          if (cc.is_system) {
            ...
            if (typeof sysName !== "undefined" && sysName != null) {
              ...
              ctx.addError(
                node,
                "No system class " + t_name + "defined for C# "
              );
            }
            return;
          }
...
class RangerScalaClassWriter extends RangerGenericClassWriter {
  ...
  async writeVarDef(node, ctx, wr) {
    if (node.hasParamDesc) {
      ...
      if (
        false == ti_ok ||
        (false == p.nameNode.hasFlag("optional") && node.children.length == 2)
      ) {
        wr.out(": ", false);
        await this.writeTypeDef(p.nameNode, ctx, wr);
        wr.out(" ", false);
  ...
  async CustomOperator(node, ctx, wr) {
    ...
    if (cmd == "for") {
      ...
      if (continue_cnt > 0) {
        ctx.addError(
          node,
          "oops, sorry. Currently Scala output can not handle for-loops with continue :/"
        );
        return;
      }
      if (break_cnt > 0) {
  ...
  async writeClass(node, ctx, orig_wr) {
    ...
    const b_class_has_content =
      cl.has_constructor ||
      cl.variables.length > 0 ||
      cl.defined_variants.length > 0 ||
      cl.extends_classes.length > 0;
    if (b_class_has_content) {
      ...
      for (let i_6 = 0; i_6 < cl.defined_variants.length; i_6++) {
        ...
        for (let i_7 = 0; i_7 < mVs_1.variants.length; i_7++) {
          ...
          if (
            typeof declaredFunction[variant_1.name] != "undefined" &&
            declaredFunction.hasOwnProperty(variant_1.name)
          ) {
            wr.out("override ", false);
          }
          wr.out("def ", false);
    ...
    if (b_has_non_main_static) {
      wr.out("", true);
      wr.out(
        "// companion object for static methods of " +
          cl.name +
          " static cnt == " +
          cl.static_methods.length,
        true
      );
...
class RangerGolangClassWriter extends RangerGenericClassWriter {
  ...
  writeArrayTypeDef(node, ctx, wr) {
    ...
    switch (v_type) {
      ...
      case 6:
        ...
        if (
          this.write_raw_type == false &&
          ctx.isPrimitiveType(a_name) == false
        ) {
          wr.out("*", false);
        }
        wr.out(this.getObjectTypeString(a_name, ctx) + "", false);
        ...
        if (ctx.isDefinedClass(t_name)) {
          ...
          if (cc_2.is_system) {
            ...
            if (typeof sysName !== "undefined" && sysName != null) {
              ...
              ctx.addError(
                node,
                "No system class " + t_name + "defined for Go "
              );
            }
            return;
          }
  ...
  async WriteVRef(node, ctx, wr) {
    ...
    if (node.nsp.length > 0) {
      ...
      for (let i = 0; i < node.nsp.length; i++) {
        ...
        if (
          typeof p.nameNode !== "undefined" &&
          p.nameNode != null &&
          ctx.isDefinedClass(p.nameNode.type_name)
        ) {
    ...
    if (node.hasParamDesc) {
      ...
      if (
        part_1 != this.thisName &&
        typeof cc_1 !== "undefined" &&
        cc_1 != null &&
        false == ctx.isInStatic()
      ) {
        const currC_1 = cc_1;
        ...
        if (
          typeof up_1 !== "undefined" &&
          up_1 != null &&
          lvDef_1.is_class_variable
        ) {
    ...
    for (let i_1 = 0; i_1 < node.ns.length; i_1++) {
      ...
      if (i_1 == 0) {
        ...
        if (
          ...
          if (
            typeof up_2 !== "undefined" &&
            up_2 != null &&
            lvDef_2.is_class_variable
          ) {
  ...
  async goExtractAssign(value, p, ctx, wr) {
    ...
    for (let i = 0; i < left.ns.length; i++) {
      ...
      if (i == 0) {
        ...
        if (
          typeof partDef.nameNode !== "undefined" &&
          partDef.nameNode != null
        ) {
  ...
  async writeVarDef(node, ctx, wr) {
    if (node.hasParamDesc) {
      ...
      if (nn.hasFlag("optional")) {
        wr.out(
          "var " + p.compiledName + " *GoNullable = new(GoNullable); ",
          true
        );
        if (node.children.length > 2) {
  ...
  async CustomOperator(node, ctx, wr) {
    ...
    if (cmd == "try") {
      ...
      const ex3 = operatorsOf_21.createc95var_49(
        ctx,
        "ex_result",
        currFn.nameNode
      );
      if (currFn.nameNode.type_name == "void") {
        wr.out(
          ex2.compiledName +
            ", _ := (func () ( __ex_returned bool,  __exReturn interface{}) {",
          true
        );
      } else {
        wr.out(
          ex2.compiledName +
            ", " +
            ex3.compiledName +
            " := (func () ( __ex_returned bool,  __exReturn interface{}) {",
          true
        );
      }
      wr.indent(1);
            ...
            if (pp.nameNode.hasFlag("optional")) {
              if (left.nsp.length > i + 1) {
                ...
                if (right.hasFlag("optional") == false) {
                  wr.out(
                    " /* right is not optional, should set the has_value -> true */",
                    false
                  );
                }
              }
  ...
  async writeClass(node, ctx, orig_wr) {
    ...
    if (cl.doesInherit() || cl.extends_classes.length > 0) {
      ...
      for (let i_4 = 0; i_4 < cl.defined_variants.length; i_4++) {
        ...
        for (let i_5 = 0; i_5 < mVs.variants.length; i_5++) {
          ...
          if (
            typeof declaredIfFunction[variant.name] != "undefined" &&
            declaredIfFunction.hasOwnProperty(variant.name)
          ) {
            continue;
          }
    ...
    for (let i_12 = 0; i_12 < cl.static_methods.length; i_12++) {
      ...
      wr.newline();
      wr.out(
        "func " + cl.name + "_static_" + variant_1.compiledName + "(",
        false
      );
      await this.writeArgsDef(variant_1, ctx, wr);
      wr.out(") ", false);
    ...
    for (let i_13 = 0; i_13 < cl.defined_variants.length; i_13++) {
      ...
      for (let i_14 = 0; i_14 < mVs_1.variants.length; i_14++) {
        ...
        if (
          typeof declaredFunction[variant_2.name] != "undefined" &&
          declaredFunction.hasOwnProperty(variant_2.name)
        ) {
          continue;
        }
        ...
        wr.out(
          "func (this *" + cl.name + ") " + variant_2.compiledName + " (",
          false
        );
        await this.writeArgsDef(variant_2, ctx, wr);
        wr.out(") ", false);
      ...
      for (let i_15 = 0; i_15 < cl.extends_classes.length; i_15++) {
        ...
        for (let i_16 = 0; i_16 < pC_2.defined_variants.length; i_16++) {
          ...
          for (let i_17 = 0; i_17 < mVs_2.variants.length; i_17++) {
            ...
            if (
              typeof declaredFn[variant_3.name] != "undefined" &&
              declaredFn.hasOwnProperty(variant_3.name)
            ) {
              continue;
            }
            wr.out(
              "func (this *" + cl.name + ") " + variant_3.compiledName + " (",
              false
            );
            await this.writeArgsDef(variant_3, ctx, wr);
            wr.out(") ", false);
    ...
    if (cl.doesInherit() || cl.extends_classes.length > 0) {
      ...
      if (cl.extends_classes.length > 0) {
        for (let i_19 = 0; i_19 < cl.extends_classes.length; i_19++) {
          ...
          wr.out(
            "// inherited getters and setters from the parent class " + pName_3,
            true
          );
          for (let i_20 = 0; i_20 < pC_3.variables.length; i_20++) {
            var p_2 = pC_3.variables[i_20];
            if (
              typeof declaredGetter[p_2.name] != "undefined" &&
              declaredGetter.hasOwnProperty(p_2.name)
            ) {
              continue;
            }
            wr.newline();
    ...
    for (let i_1 = 0; i_1 < lambdaCtx.captured_variables.length; i_1++) {
      ...
      if (pp.set_cnt >= 0) {
        ...
        if (pp.varType == 4) {
          ctx.addError(
            node,
            "Mutating captured function parameter is not allowed"
          );
        }
      }
    }
...
class RangerPythonClassWriter extends RangerGenericClassWriter {
  constructor() {
    super();
    this.thisName = "self";
    this.wrote_header = false;
  ...
  EncodeString(node, ctx, wr) {
    ...
    while (ii < str_length) {
      ...
      switch (cc) {
        ...
        case 34:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(34);
          break;
        case 92:
          encoded_str =
            encoded_str + String.fromCharCode(92) + String.fromCharCode(92);
  ...
  async writeClass(node, ctx, orig_wr) {
    ...
    for (let i_3 = 0; i_3 < cl.defined_variants.length; i_3++) {
      ...
      for (let i_4 = 0; i_4 < mVs.variants.length; i_4++) {
        ...
        declaredFunction[variant_1.name] = true;
        wr.out("def " + variant_1.compiledName + "(self", false);
        if (variant_1.params.length > 0) {
          wr.out(", ", false);
          this.writeArgsDef(variant_1, ctx, wr);
        }
        wr.out("):", true);
...
class RangerJavaScriptClassWriter extends RangerGenericClassWriter {
  ...
  async writeFnCall(node, ctx, wr) {
    if (node.hasFnCall) {
      const fc = node.getFirst();
      if (
        typeof node.fnDesc !== "undefined" &&
        node.fnDesc != null &&
        typeof node.fnDesc.nameNode !== "undefined" &&
        node.fnDesc.nameNode != null
      ) {
        const fnName = node.fnDesc.nameNode;
  ...
  async writeClass(node, ctx, orig_wr) {
    ...
    if (
      ctx.hasCompilerFlag("dead4main") ||
      ctx.hasCompilerSetting("dceclass")
    ) {
    ...
    if (this.wrote_header == false) {
      ...
      if (
        ctx.hasCompilerFlag("nodemodule") &&
        this.target_typescript == false
      ) {
        const root = ctx.getRoot();
        await operatorsOf_13.forEach_14(root.definedClasses, (item, index) => {
          ...
          if (item.isNormalClass()) {
            const theEnd = wr.getTag("file_end");
            theEnd.out(
              "module.exports." + item.name + " = " + item.name + ";",
              true
            );
          }
        });
    ...
    if (this.target_typescript) {
      for (let i_5 = 0; i_5 < cl.static_methods.length; i_5++) {
        ...
        if (variant_1.nameNode.hasFlag("test")) {
          console.log(
            "Found a test function, but not writing it: " +
              variant_1.nameNode.vref
          );
          continue;
        }
        wr.out("static ", false);
    ...
    if (this.target_typescript == false) {
      for (let i_6 = 0; i_6 < cl.static_methods.length; i_6++) {
        ...
        if (variant_2.nameNode.hasFlag("main")) {
          ...
          if (variant_2.nameNode.hasFlag("test")) {
            const testFile = wr.getFileWriter("test/", "testfile.js");
    ...
    if (ctx.hasCompilerFlag("nodemodule") == false) {
      for (let i_7 = 0; i_7 < cl.static_methods.length; i_7++) {
        ...
        ctx.disableCurrentClass();
        if (
          variant_3.nameNode.hasFlag("main") &&
          variant_3.nameNode.code.filename == ctx.getRootFile()
        ) {
          let asyncKeyword_1 = "";
  ...
  async CreateServices(parser, ctx, orig_wr) {
    if (ctx.hasCompilerFlag("client")) {
      ctx.addError(
        CodeNode.blockNode(),
        "client service writing for target JavaScript is not implemented"
      );
      return;
    }
    const root = ctx.getRoot();
    ...
    await operatorsOf_13.forEach_25(root.appServices, (item, index) => {
      try {
        ...
        wr.out(
          "def obj (" +
            param.type_name +
            ".fromDictionary( (from_string (get_post_data req ))) )",
          true
        );
    ...
    const serviceClassDef = CodeNode.op3("class", [
      CodeNode.vref1("appServices"),
      serviceBlock,
    ]);
  ...
  async writeNpmPackage(node, ctx, orig_wr) {
    ...
    await operatorsOf.forEach_12(opts, (item, index) => {
      if (ctx.hasCompilerSetting(item) == false) {
        ...
        wr.out(
          '"' + item + '" : "' + ctx.getCompilerSetting(item) + '",',
          true
        );
      }
    });
...
class RangerActiveOperators {
  ...
  async initializeOpCache() {
    ...
    for (let i = 0; i < this.stdCommands.children.length; i++) {
      ...
      const fc = lch.getFirst();
      if (
        typeof this.opHash[fc.vref] != "undefined" &&
        this.opHash.hasOwnProperty(fc.vref)
      ) {
...
class LiveCompiler {
  ...
  initWriter(ctx) {
    ...
    switch (langName) {
      ...
      case "php":
        ...
        break;
      case "python":
        this.langWriter = new RangerPythonClassWriter();
        break;
      case "rust":
        this.langWriter = new RangerRustClassWriter();
        break;
      case "cpp":
  ...
  createPolyfill(code, ctx, wr) {
    ...
    if (
      (typeof p_write.compiledTags[code] != "undefined" &&
        p_write.compiledTags.hasOwnProperty(code)) == false
    ) {
  ...
  async installFile(filename, ctx, wr) {
    if (
      typeof this.installedFile[filename] != "undefined" &&
      this.installedFile.hasOwnProperty(filename)
    ) {
      return;
    }
    ...
    if (
      operatorsOf_8.filec95exists_9(
        env,
        operatorsOf_8.installc95directory_51(env) + "/",
        filename
      )
    ) {
      const fileData = await new Promise((resolve) => {
        require("fs").readFile(
          operatorsOf_8.installc95directory_51(env) + "/" + "/" + filename,
          "utf8",
          (err, data) => {
            resolve(data);
          }
      ...
      for (let i = 0; i < details.children.length; i++) {
        ...
        if (det.children.length > 0) {
          ...
          if (fc.vref == "code") {
            ...
            const stdFnName = appCtx.createSignature(
              fnName.vref,
              fnName.vref + theCode.getCode()
            );
            ...
            if (
              false ==
              (typeof stdClass.defined_static_methods[stdFnName] !=
                "undefined" &&
                stdClass.defined_static_methods.hasOwnProperty(stdFnName))
            ) {
              runCtx.setInMethod();
              const m = new RangerAppFunctionDesc();
              m.name = stdFnName;
    ...
    if (node.register_name.length > 0) {
      if (ctx.expressionLevel() > 0) {
        if (node.reg_compiled_name.length > 0) {
          ...
          console.log(
            "Could not find compiled name for " +
              node.register_name +
              " at " +
              node.getCode()
          );
      ...
      switch (cmdE.vref) {
        ...
        case "required_option":
          ...
          if (node.children.length > idx_5) {
            ...
            if (ctx.hasCompilerSetting(arg_5.string_value)) {
              ...
              ctx.addError(
                node,
                "This source code requires compiler option -" +
                  arg_5.string_value +
                  "=<> to be set "
              );
            }
        ...
        case "ptrsrc":
          ...
          if (node.children.length > idx_12) {
            ...
            if (
              arg_12.isPrimitiveType() == false &&
              arg_12.isPrimitive() == false
            ) {
              wr.out("&", false);
            }
          }
          ...
          if (node.children.length >= idx_16) {
            ...
            while (i_2 < node.children.length) {
              if (i_2 >= idx_16) {
                for (
                  let ii_1 = 0;
                  ii_1 < cmdToRepeat_1.children.length;
                  ii_1++
                ) {
        ...
        case "r_ktype":
          ...
          if (node.children.length > idx_19) {
            ...
            if (arg_17.hasParamDesc) {
              const ss = this.langWriter.getObjectTypeString(
                arg_17.paramDesc.nameNode.key_type,
                ctx
              );
              wr.out(ss, false);
            } else {
              const ss_1 = this.langWriter.getObjectTypeString(
                arg_17.key_type,
                ctx
              );
              wr.out(ss_1, false);
        ...
        case "r_atype":
          ...
          if (node.children.length > idx_20) {
            ...
            if (arg_18.hasParamDesc) {
              const ss_2 = this.langWriter.getObjectTypeString(
                arg_18.paramDesc.nameNode.array_type,
                ctx
              );
              wr.out(ss_2, false);
            } else {
              const ss_3 = this.langWriter.getObjectTypeString(
                arg_18.array_type,
                ctx
              );
              wr.out(ss_3, false);
        ...
        case "r_atype_fname":
          ...
          if (node.children.length > idx_21) {
            ...
            if (arg_19.hasParamDesc) {
              let ss_4 = this.langWriter.getObjectTypeString(
                arg_19.paramDesc.nameNode.array_type,
                ctx
              );
              if (ss_4 == "interface{}") {
                ss_4 = "interface";
              ...
              let ss_5 = this.langWriter.getObjectTypeString(
                arg_19.array_type,
                ctx
              );
              if (ss_5 == "interface{}") {
        ...
        case "java_class":
          try {
            ...
            const p_write = wr.getTag("utilities");
            if (
              (typeof p_write.compiledTags[fName] != "undefined" &&
                p_write.compiledTags.hasOwnProperty(fName)) == false
            ) {
        ...
        case "rawtype":
          ...
          if (node.children.length > idx_23) {
            ...
            if (arg_21.hasParamDesc) {
              await this.langWriter.writeRawTypeDef(
                arg_21.paramDesc.nameNode,
                ctx,
                wr
              );
            } else {
        ...
        case "macro":
          ...
          if (
            (typeof p_write_1.compiledTags[p_str] != "undefined" &&
              p_write_1.compiledTags.hasOwnProperty(p_str)) == false
          ) {
  ...
  findParamDesc(obj, ctx, wr) {
    ...
    if (obj.vref != "this") {
      ...
      if (typeof varDesc.nameNode !== "undefined" && varDesc.nameNode != null) {
        ...
        ctx.addError(
          obj,
          "Error, no description for called object: " + obj.vref
        );
      }
      return varDesc;
    }
...
class RangerDocGenerator {
  ...
  async createOperatorDoc(node, ctx, orig_wr) {
    if (ctx.hasCompilerSetting("operatordoc")) {
      const wr = orig_wr.getFileWriter(
        ".",
        ctx.getCompilerSetting("operatordoc")
      );
      ...
      let statements = operatorsOf.filter_52(allOps, (item, index) => {
        ...
        if (typeof item.firstArg != "undefined") {
          is_map_array =
            item.firstArg.value_type == 6 || item.firstArg.value_type == 7;
        }
      ...
      const nList = operatorsOf.groupBy_53(operator_list, (item) => {
        ...
        if (typeof fc != "undefined") {
          key =
            key +
            (":" + fc.type_name + ":" + fc.key_type + ":" + fc.array_type);
        }
        return key;
      });
      wr.out("## Statements", true);
      await this.writeTypeDoc(
        statements,
        (item) => {
          return true;
        },
      ...
      await this.writeTypeDoc(
        ...
        (item) => {
          if (typeof item.firstArg != "undefined") {
            return (
              (item.firstArg.type_name == "int" ||
                item.firstArg.type_name == "double") &&
              (item.nameNode.type_name == "int" ||
                item.nameNode.type_name == "double")
            );
          }
          return false;
        },
        ...
        (item) => {
          if (typeof item.firstArg != "undefined") {
            return (
              ...
              item.nameNode.type_name != "int" &&
              item.nameNode.type_name != "double" &&
              item.nameNode.type_name != "boolean"
            );
          }
          return false;
        },
...
class VirtualCompiler {
  ...
  async run(env) {
    ...
    const valid_options = [
      "l",
      "Selected language, one of " + allowed_languages.join(", "),
      "d",
      'output directory, default directory is "bin/"',
      "o",
      'output file, default is "output.<language>"',
      "classdoc",
      "write class documentation .md file",
      "operatordoc",
      "write operator documention into .md file",
    ];
    const valid_flags = [
      "deadcode",
      "Eliminate functions which are not called by any other functions",
      "dead4main",
      "Eliminate functions and classes which are unreachable from the main function",
      "forever",
      "Leave the main program into eternal loop (Go, Swift)",
      "allowti",
      "Allow type inference at target lang (creates slightly smaller code)",
      "plugins-only",
      "ignore built-in language output and use only plugins",
      "plugins",
      '(node compiler only) run specified npm plugins -plugins="plugin1,plugin2"',
      "strict",
      "Strict mode. Do not allow automatic unwrapping of optionals outside of try blocks.",
      "typescript",
      "Writes JavaScript code with TypeScript annotations",
      "npm",
      "Write the package.json to the output directory",
      "nodecli",
      "Insert node.js command line header #!/usr/bin/env node to the beginning of the JavaScript file",
      "nodemodule",
      "Export the classes as node.js modules (this option will disable the static main function)",
      "client",
      "the code is ment to be run in the client environment",
      "scalafiddle",
      "scalafiddle.io compatible output",
      "compiler",
      "recompile the compiler",
      "copysrc",
      "copy all the source codes into the target directory",
    ];
    const parser_pragmas = [
      "@noinfix(true)",
      "disable operator infix parsing and automatic type definition checking ",
    ];
    if (
      typeof params.flags["compiler"] != "undefined" &&
      params.flags.hasOwnProperty("compiler")
    ) {
      console.log("---------------------------------------------");
      ...
      if (params.values.length < 1) {
        ...
        console.log(
          "Installed at: " + operatorsOf_8.installc95directory_51(env)
        );
        ...
        while (optCnt_1 < valid_flags.length) {
          ...
          console.log(
            "  -" +
              option_1 +
              " " +
              this.fillStr(13 - option_1.length) +
              optionDesc_1
          );
          optCnt_1 = optCnt_1 + 2;
        }
        ...
        while (optCnt_2 < parser_pragmas.length) {
          ...
          console.log(
            "   " +
              option_2 +
              " " +
              this.fillStr(16 - option_2.length) +
              optionDesc_2
          );
          optCnt_2 = optCnt_2 + 2;
        }
    ...
    const root_dir = require("path").normalize(
      operatorsOf_8.currentc95directory_51(env) +
        "/" +
    ...
    langLibEnv =
      root_dir +
      ";" +
      require("path").normalize(idir + "/../compiler/") +
      ";" +
      require("path").normalize(idir + "/../lib/") +
      ";" +
      langLibEnv;
    env.setEnv("RANGER_LIB", langLibEnv);
    console.log("ENV: " + operatorsOf_8.envc95var_54(env, "RANGER_LIB"));
    const theFilePaths = this.possiblePaths(
      operatorsOf_8.envc95var_54(env, "RANGER_LIB")
    );
    ...
    if (
      operatorsOf_8.filec95exists_9(env, langFilePath, the_lang_file) == false
    ) {
      console.log(
        "language file " +
          the_lang_file +
          " not found! Check the library directory or RANGER_LIB enviroment variable"
      );
    ...
    const parser = new RangerLispParser(code);
    if (
      typeof params.flags["no-op-transform"] != "undefined" &&
      params.flags.hasOwnProperty("no-op-transform")
    ) {
                  ...
                  case "Import":
                    inserted_nodes.push(
                      CodeNode.fromList([
                        ...
                        CodeNode.newStr(sc.string_value),
                      ])
                    );
                    break;
                  default:
    ...
    if (typeof dirParam !== "undefined" && dirParam != null) {
      the_target_dir =
        operatorsOf_8.currentc95directory_51(env) + "/" + dirParam;
    }
    ...
    try {
      ...
      const lang_str = await operatorsOf_8.readc95file_9(
        env,
        langFilePath,
        the_lang_file
      );
      ...
      switch (appCtx.targetLangName) {
        case "java7":
          if (
            typeof comp_attrs["android_res_dir"] != "undefined" &&
            comp_attrs.hasOwnProperty("android_res_dir")
          ) {
            ...
            await operatorsOf_13.forEach_25(
              appCtx.viewClassBody,
              async (item, index) => {
        ...
        case "es6":
          if (
            typeof comp_attrs["web_res_dir"] != "undefined" &&
            comp_attrs.hasOwnProperty("web_res_dir")
          ) {
      ...
      for (let i_4 = 0; i_4 < appCtx.definedClassList.length; i_4++) {
        ...
        if (
          typeof handledClasses[cName] != "undefined" &&
          handledClasses.hasOwnProperty(cName)
        ) {
          continue;
        }
        ...
        if (cl.extends_classes.length > 0) {
          for (let i_5 = 0; i_5 < cl.extends_classes.length; i_5++) {
            ...
            if (
              typeof handledClasses[eClassName] != "undefined" &&
              handledClasses.hasOwnProperty(eClassName)
            ) {
              continue;
            }
      ...
      for (let i_7 = 0; i_7 < appCtx.definedClassList.length; i_7++) {
        ...
        if (
          typeof handledClasses[cName_1] != "undefined" &&
          handledClasses.hasOwnProperty(cName_1)
        ) {
          continue;
        }
      ...
      for (let i_9 = 0; i_9 < import_list.length; i_9++) {
        ...
        if (
          typeof added_import[codeStr] != "undefined" &&
          added_import.hasOwnProperty(codeStr)
        ) {
          continue;
        }
        ...
        switch (appCtx.targetLangName) {
          ...
          case "go":
            if (codeStr.charCodeAt(0) == "_".charCodeAt(0)) {
              importFork.out(
                ' _ "' + codeStr.substring(1, codeStr.length) + '"',
                true
              );
            } else {
...
VirtualCompiler.create_env = async function () {
  ...
  require("fs").writeFileSync(
    "." + "/" + "compileEnv.js",
    "window._Ranger_compiler_environment_ = " +
      JSON.stringify(env.toDictionary())
  );
};
...
operatorsOf.groupBy_53 = function (__self, cb) {
  ...
  for (let i_29 = 0; i_29 < __self.length; i_29++) {
    ...
    const key = cb(it_20);
    if (
      false == (typeof mapper[key] != "undefined" && mapper.hasOwnProperty(key))
    ) {
      res_14.push(it_20);
      mapper[key] = true;
    }
...
operatorsOfInputEnv_8.readc95file_9 = async function (env, path, name) {
  if (env.use_real) {
    return await new Promise((resolve) => {
      require("fs").readFile(path + "/" + name, "utf8", (err, data) => {
        resolve(data);
      });
    });
  }
...
operatorsOf_8.findc95file_9 = function (env, path, name) {
  let res_4;
  if (path == "/") {
    const files_2 = operatorsOf.filter_6(
      env.filesystem.files,
      (item, index) => {
        return item.name == name;
      }
    );
...
operatorsOf_8.envc95var_54 = function (env, name) {
  if (env.use_real) {
    if (
      typeof env.envVars[name] != "undefined" &&
      env.envVars.hasOwnProperty(name)
    ) {
  ...
  return typeof env.envVars[name] !== "undefined" && env.envVars[name] != null
    ? env.envVars[name]
    : "";
};
...
operatorsOfRangerFlowParser_26.EnterVarDef_27 = async function (
  __self,
  node,
  ctx,
  wr
  ...
  if (ctx.isInMethod()) {
    ...
    if (node.children.length > 2) {
      ...
      if (defaultArg.hasParamDesc) {
        ...
        if (
          typeof paramDesc.propertyClass !== "undefined" &&
          paramDesc.propertyClass != null
        ) {
      ...
      if (cn.value_type == 14) {
        if (defaultArg.eval_type != 3 && defaultArg.eval_type != 14) {
          ctx.addError(
            defaultArg,
            "Char should be assigned char or integer value --> " +
              defaultArg.getCode()
          );
        } else {
    ...
    if (p.value_type == 0) {
      if (
        0 == cn.type_name.length &&
        typeof defaultArg !== "undefined" &&
        defaultArg != null
      ) {
    ...
    if (node.children.length > 2) {
      if (defaultArg.register_name.length > 0) {
        ...
        if (typeof rr.nameNode !== "undefined" && rr.nameNode != null) {
          if (
            typeof rr.nameNode.expression_value !== "undefined" &&
            rr.nameNode.expression_value != null
          ) {
      ...
      if (defaultArg.eval_type == 17) {
        if (
          typeof defaultArg.expression_value !== "undefined" &&
          defaultArg.expression_value != null
        ) {
          cn.expression_value = defaultArg.expression_value.copy();
        } else {
          if (defaultArg.hasParamDesc) {
            if (
              typeof defaultArg.paramDesc.nameNode !== "undefined" &&
              defaultArg.paramDesc.nameNode != null &&
              typeof defaultArg.paramDesc.nameNode.expression_value !==
                "undefined" &&
              defaultArg.paramDesc.nameNode.expression_value != null
            ) {
              cn.eval_type = 17;
              cn.expression_value =
                defaultArg.paramDesc.nameNode.expression_value.copy();
            }
          }
        }
      }
      if (typeof defaultArg !== "undefined" && defaultArg != null) {
        ...
        if (
          typeof defaultArg.evalTypeClass !== "undefined" &&
          defaultArg.evalTypeClass != null
        ) {
      ...
      if (cn.eval_type != defaultArg.eval_type) {
        ...
        if (false == (b1 || b2)) {
          ctx.addError(
            node,
            "Variable was assigned an incompatible type. Types were " +
              cn.eval_type +
              " vs " +
              defaultArg.eval_type
          );
        }
      }
    } else {
  ...
  if (ctx.isInMethod()) {
    ...
    if (node.children.length > 2) {
      ...
      if (defaultArg_1.hasParamDesc) {
        ...
        if (
          typeof paramDesc_1.propertyClass !== "undefined" &&
          paramDesc_1.propertyClass != null
        ) {
    ...
    if (p_1.value_type == 0) {
      if (
        0 == cn_2.type_name.length &&
        typeof defaultArg_1 !== "undefined" &&
        defaultArg_1 != null
      ) {
    ...
    if (node.children.length > 2) {
      if (defaultArg_1.register_name.length > 0) {
        ...
        if (typeof rr_1.nameNode !== "undefined" && rr_1.nameNode != null) {
          if (
            typeof rr_1.nameNode.expression_value !== "undefined" &&
            rr_1.nameNode.expression_value != null
          ) {
      ...
      if (defaultArg_1.eval_type == 17) {
        if (
          typeof defaultArg_1.expression_value !== "undefined" &&
          defaultArg_1.expression_value != null
        ) {
          cn_2.expression_value = defaultArg_1.expression_value.copy();
        } else {
          if (defaultArg_1.hasParamDesc) {
            if (
              typeof defaultArg_1.paramDesc.nameNode !== "undefined" &&
              defaultArg_1.paramDesc.nameNode != null &&
              typeof defaultArg_1.paramDesc.nameNode.expression_value !==
                "undefined" &&
              defaultArg_1.paramDesc.nameNode.expression_value != null
            ) {
              cn_2.eval_type = 17;
              cn_2.expression_value =
                defaultArg_1.paramDesc.nameNode.expression_value.copy();
            }
          }
        }
      }
      if (typeof defaultArg_1 !== "undefined" && defaultArg_1 != null) {
        ...
        if (
          typeof defaultArg_1.evalTypeClass !== "undefined" &&
          defaultArg_1.evalTypeClass != null
        ) {
...
module.exports.CmdParams = CmdParams;
module.exports.test_cmdparams = test_cmdparams;
module.exports.InputFSFolder = InputFSFolder;
module.exports.InputFSFile = InputFSFile;
module.exports.InputEnv = InputEnv;
module.exports.test_input_filesystem = test_input_filesystem;
module.exports.RangerAppTodo = RangerAppTodo;
module.exports.RangerCompilerMessage = RangerCompilerMessage;
module.exports.RangerParamEventHandler = RangerParamEventHandler;
module.exports.RangerParamEventList = RangerParamEventList;
module.exports.RangerParamEventMap = RangerParamEventMap;
module.exports.RangerAppArrayValue = RangerAppArrayValue;
module.exports.RangerAppHashValue = RangerAppHashValue;
module.exports.RangerAppValue = RangerAppValue;
module.exports.RangerRefForce = RangerRefForce;
module.exports.RangerAppParamDesc = RangerAppParamDesc;
module.exports.RangerAppFunctionDesc = RangerAppFunctionDesc;
module.exports.RangerAppMethodVariants = RangerAppMethodVariants;
module.exports.RangerAppInterfaceImpl = RangerAppInterfaceImpl;
module.exports.RangerTraitParams = RangerTraitParams;
module.exports.RangerAppClassDesc = RangerAppClassDesc;
module.exports.RangerTypeClass = RangerTypeClass;
module.exports.SourceCode = SourceCode;
module.exports.CodeNodeLiteral = CodeNodeLiteral;
module.exports.CodeNode = CodeNode;
module.exports.TypeCounts = TypeCounts;
module.exports.RangerNodeValue = RangerNodeValue;
module.exports.RangerBackReference = RangerBackReference;
module.exports.RangerAppEnum = RangerAppEnum;
module.exports.OpFindResult = OpFindResult;
module.exports.RangerOperatorList = RangerOperatorList;
module.exports.RangerNodeList = RangerNodeList;
module.exports.ContextTransaction = ContextTransaction;
module.exports.ContextTransactionMutation = ContextTransactionMutation;
module.exports.RangerRegisteredPlugin = RangerRegisteredPlugin;
module.exports.RangerAppWriterContext = RangerAppWriterContext;
module.exports.CodeFile = CodeFile;
module.exports.CodeFileSystem = CodeFileSystem;
module.exports.CodeSlice = CodeSlice;
module.exports.CodeWriter = CodeWriter;
module.exports.RangerLispParser = RangerLispParser;
module.exports.RangerArgMatch = RangerArgMatch;
module.exports.DictNode = DictNode;
module.exports.RangerSerializeClass = RangerSerializeClass;
module.exports.RangerImmutableExtension = RangerImmutableExtension;
module.exports.RangerServiceBuilder = RangerServiceBuilder;
module.exports.RangerAppOperatorDesc = RangerAppOperatorDesc;
module.exports.TFiles = TFiles;
module.exports.TTypes = TTypes;
module.exports.ClassJoinPoint = ClassJoinPoint;
module.exports.WalkLater = WalkLater;
module.exports.RangerFlowParser = RangerFlowParser;
module.exports.TFactory = TFactory;
module.exports.CallChain = CallChain;
module.exports.NodeEvalState = NodeEvalState;
module.exports.RangerGenericClassWriter = RangerGenericClassWriter;
module.exports.AndroidPageWriter = AndroidPageWriter;
module.exports.RangerJava7ClassWriter = RangerJava7ClassWriter;
module.exports.RangerSwift3ClassWriter = RangerSwift3ClassWriter;
module.exports.RangerSwift6ClassWriter = RangerSwift6ClassWriter;
module.exports.RangerCppClassWriter = RangerCppClassWriter;
module.exports.RangerRustClassWriter = RangerRustClassWriter;
module.exports.RangerKotlinClassWriter = RangerKotlinClassWriter;
module.exports.RangerCSharpClassWriter = RangerCSharpClassWriter;
module.exports.RangerScalaClassWriter = RangerScalaClassWriter;
module.exports.RangerGolangClassWriter = RangerGolangClassWriter;
module.exports.RangerPHPClassWriter = RangerPHPClassWriter;
module.exports.RangerPythonClassWriter = RangerPythonClassWriter;
module.exports.WebPageWriter = WebPageWriter;
module.exports.RangerJavaScriptClassWriter = RangerJavaScriptClassWriter;
module.exports.RangerRangerClassWriter = RangerRangerClassWriter;
module.exports.OpList = OpList;
module.exports.RangerActiveOperators = RangerActiveOperators;
module.exports.LiveCompiler = LiveCompiler;
module.exports.ColorConsole = ColorConsole;
module.exports.RangerDocGenerator = RangerDocGenerator;
module.exports.viewbuilder_Android = viewbuilder_Android;
module.exports.viewbuilder_Web = viewbuilder_Web;
module.exports.CompilerResults = CompilerResults;
module.exports.VirtualCompiler = VirtualCompiler;
